	...
	public partial class PersonnalizeUniverse : TNS.AdExpress.Web.UI.PrivateWebPage{
		...
		protected void Page_Load(object sender, System.EventArgs e){			
			...
			try{
				...
				TNS.AdExpress.Web.UI.MyAdExpress.MySessionsUI myAdexpress=new TNS.AdExpress.Web.UI.MyAdExpress.MySessionsUI(_webSession,TNS.AdExpress.Web.UI.MyAdExpress.MySessionsUI.type.universe,WebApplicationParameters.CustomStyles.MySessionsWidth);
                ...
                deleteImageButtonRollOverWebControl.Attributes.Add("onclick", "javascript: return confirm('" + GestionWeb.GetWebWord(2855, _webSession.SiteLanguage) + "');");
                deleteUniversImageButtonRollOverWebControl.Attributes.Add("onclick", "javascript: return confirm('" + GestionWeb.GetWebWord(2856, _webSession.SiteLanguage) + "');");						
				#endregion
