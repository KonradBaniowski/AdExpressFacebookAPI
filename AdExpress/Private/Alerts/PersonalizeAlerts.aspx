...
<%@ Page language="c#" Inherits="AdExpress.Private.Alerts.PersonalizeAlerts" CodeFile="PersonalizeAlerts.aspx.cs" %>
...
<HTML>
	<HEAD runat="server">
		...
		<!--
            ...
            function onValideDeleteAlerte() {
                return confirm(document.getElementById('confirmDeleteAlerteLabel').innerHTML);
            }
							...
							<table id="tableMenu" cellSpacing="0" cellPadding="0" width="10" border="0">
								...
								<tr>
									<td class="txtGris10 whiteBackGround" height="5">
									    <cc3:imagebuttonrolloverwebcontrol id="Imagebuttonrolloverwebcontrol3" runat="server" onclick="alertOpenImageButtonRollOver_Click" SkinID="ouvrirButton"></cc3:imagebuttonrolloverwebcontrol>
									</td>
								</tr>	
								<tr>
									<td class="whiteBackGround" height="5"></td>
								...
								<tr>
									<td class="txtGris10 whiteBackGround" height="5"><asp:Image ID="Image65" runat="server" SkinID="personnaliser" /></td>
								</tr>							
								<!-- test!!!!--></table>
									...
									<td>
										<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="727" border="0">
											<TR class="violetBackGround" height="14">
													<td colSpan="1"><asp:Image ID="Image45" runat="server" SkinID="fleche_1" /></td>
													<TD class="txtBlanc11Bold bandeauTitreBackGround" colSpan="2">&nbsp;<cc1:adexpresstext language="33" id="AdExpressText5" runat="server" Code="2611"></cc1:adexpresstext>
													</TD>
												</TR>
												<TR>
													<TD></TD>
												...
												<TR>
													...
													<TD class="txtViolet11 whiteBackGround" style="HEIGHT: 17px">&nbsp;<cc1:adexpresstext language="33" id="AdExpressText6" runat="server" Code="2612"></cc1:adexpresstext></TD>
													<TD style="HEIGHT: 17px" class="whiteBackGround"><asp:dropdownlist id="alertDropDownList" runat="server" Width="300px" CssClass="txtViolet11"></asp:dropdownlist></TD>
													<div style="display:none;"><asp:Label id="confirmDeleteAlerteLabel" runat="server"></asp:Label></div>
												</TR>
												<TR>
													<TD></TD>
												...
												<TR>
													<TD></TD>
													<TD></TD>
													<TD vAlign="top" height="40"><cc3:imagebuttonrolloverwebcontrol id="deleteAlertesImageButtonRollOverWebControl" runat="server" onclick="deleteAlerteImageButtonRollOverWebControl_Click" SkinID="validateButton"></cc3:imagebuttonrolloverwebcontrol></TD>
												</TR>
										</TABLE>
									</td>
								</tr>
...
<script language="javascript" type="text/javascript">
    ...
    if (document.getElementById('deleteAlertesImageButtonRollOverWebControl') != null) {
        if (document.getElementById('deleteAlertesImageButtonRollOverWebControl').addEventListener)
            document.getElementById('deleteAlertesImageButtonRollOverWebControl').addEventListener('click', onValideDeleteAlerte, false);
        else if (document.getElementById('deleteAlertesImageButtonRollOverWebControl').attachEvent)
            document.getElementById('deleteAlertesImageButtonRollOverWebControl').attachEvent('onclick', onValideDeleteAlerte);
