				...
				<tr>
					...
					<td vAlign="top" class="whiteBackGround">
						<table cellSpacing="0" cellPadding="0" border="0" width="10">
							...
							<tr>
								<td class="txtGris10" height="5"><asp:Image ID="Image20" runat="server" SkinID="personnaliser" /></td>
							</tr>
							<tr>
							    <td height="20"></td>
						    </tr>						
								...
								<td style="padding-left:5px;">
									<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="727" border="0">
										<TR class="violetBackGround" height="14">
											...
											<TD class="txtBlanc11Bold bandeauTitreBackGround" colSpan="2">&nbsp;<cc1:adexpresstext language="33" id="AdExpressText5" runat="server" Code="2611"></cc1:adexpresstext></TD>
										</TR>
										<TR>
											<TD></TD>
										...
										<TR>
											...
											<TD class="txtViolet11" style="HEIGHT: 17px">&nbsp;<cc1:adexpresstext language="33" id="AdExpressText6" runat="server" Code="2612"></cc1:adexpresstext></TD>
											<TD style="HEIGHT: 17px"><asp:dropdownlist id="alertDropDownList" runat="server" Width="300px" CssClass="txtViolet11"></asp:dropdownlist></TD>
