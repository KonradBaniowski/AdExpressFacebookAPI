    ...
    public partial class TendenciesResult : TNS.AdExpress.Web.UI.ResultWebPage
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (!this.Page.ClientScript.IsClientScriptBlockRegistered("SelectMonthPeriod")) this.Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "SelectMonthPeriod", WebFunctions.Script.SelectMonthPeriod("ResultsDateListWebControl1", "ResultsDashBoardOptionsWebControl1_dateWeekComparative", "ResultsDashBoardOptionsWebControl1_dateToDate"));
                if (!this.Page.ClientScript.IsClientScriptBlockRegistered("SelectWeekPeriod")) this.Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "SelectWeekPeriod", WebFunctions.Script.SelectWeekPeriod("ResultsDateListWebControl2", "ResultsDashBoardOptionsWebControl1_dateWeekComparative", "ResultsDashBoardOptionsWebControl1_dateToDate"));
                if (!this.Page.ClientScript.IsClientScriptBlockRegistered("EnableComparativeType")) this.Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "EnableComparativeType", WebFunctions.Script.EnableComparativeType("ResultsDashBoardOptionsWebControl1_dateWeekComparative", "ResultsDashBoardOptionsWebControl1_dateToDate"));
                if (!this.Page.ClientScript.IsClientScriptBlockRegistered("ComparativeTypeInit")) this.Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "ComparativeTypeInit", WebFunctions.Script.ComparativeTypeInit("ResultsDateListWebControl1", "ResultsDashBoardOptionsWebControl1_dateWeekComparative", "ResultsDashBoardOptionsWebControl1_dateToDate"));
                #endregion
