...
<%@ Page language="c#" Inherits="AdExpress.Private.Results.MarketShareResults" CodeFile="MarketShareResults.aspx.cs" %>
	...
	<body>
		<form id="Form2" method="post" runat="server">
			<table height="600" cellSpacing="0" cellPadding="0" width="800" border="0">
				...
				<tr vAlign="top">
					<TD vAlign="top"><cc2:resultsoptionswebcontrol id="ResultsOptionsWebControl1" runat="server" Percentage="True" AutoPostBackOption="False"
							ResultOption="True" InsertOption="True"></cc2:resultsoptionswebcontrol></TD>
				</tr>
				<!--Niveaux Produits-->
				...
				<tr vAlign="top">
					<td vAlign="top"><cc2:genericmedialeveldetailselectionwebcontrol id="_genericMediaLevelDetailSelectionWebControl" runat="server" Width="200px" GenericDetailLevelType="dynamicCompetitorPotential"
							...
							NbDetailLevelItemList="3"></cc2:genericmedialeveldetailselectionwebcontrol>
					</td>
				</tr>
				...
				<tr bgColor="#ffffff" height="5">
					<td>
						<cc2:InitializeProductWebControl id="InitializeProductWebControl1" runat="server" AutoPostBackOption="False" InitializeProduct="True"></cc2:InitializeProductWebControl></td>
				</tr>
				<tr bgColor="#ffffff">
								...
								<tr bgColor="#ffffff">
									...
									<td bgColor="#ffffff" style="HEIGHT: 37px">
										<cc5:ResultWebControl id="_resultWebControl" runat="server" CssL1="lv1" CssL2="lv2" CssL3="lv3" CssLHeader="h2"
											...
											CssDetailSelectionTitleGlobal="dsTitleGlobal" CssDetailSelectionTitleData="dsTitleData" CssDetailSelectionTitle="dsTitle"
											CssDetailSelectionL3="dsLv3" CssDetailSelectionL2="dsLv2" CssDetailSelectionL1="dsLv1" CssDetailSelectionBordelLevel="dsBorderLevel"></cc5:ResultWebControl>
									</td>
								</tr>
								<tr>
