	...
	<body>
		<form id="Form2" method="post" runat="server">
			<table height="600" cellSpacing="0" cellPadding="0" width="800" border="0">
				...
				<tr>
					<td style="HEIGHT: 12px" bgColor="#ffffff" height="15"><cc5:mediaagencyyearwebcontrol id="MediaAgencyYearWebControl1" runat="server"></cc5:mediaagencyyearwebcontrol></td>
				</tr>
				<tr bgColor="#ffffff">
					<td></td>
				</tr>
					...
					<tr>
						<td>
							<table cellSpacing="0" cellPadding="0" width="100%" border="0">
								<tr>
									<td style="HEIGHT: 19px" bgColor="#ffffff"></td>
								</tr>
								<tr bgColor="#ffffff">
									<!-- Tableau de Résultat -->
									<td bgColor="#ffffff" style="HEIGHT: 37px">
										<cc5:ResultWebControl id="_resultWebControl" runat="server" CssL1="lv1" CssL2="lv2" CssL3="lv3" CssLHeader="h2"
											...
											CssDetailSelectionTitleGlobal="dsTitleGlobal" AjaxProTimeOut="120" OutputType="html"></cc5:ResultWebControl>
									</td>
								</tr>
								<tr>
