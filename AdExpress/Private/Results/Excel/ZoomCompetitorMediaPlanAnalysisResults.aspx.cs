...
namespace AdExpress.Private.Results.Excel{
    /// <summary>
    /// Export Excel du zoom plan média concurentiel
    /// </summary>
    public partial class ZoomCompetitorMediaPlanAnalysisResults : System.Web.UI.Page{
...
//            #region Résultats
//            try{
//                result=CompetitorMediaPlanAlertUI.GetMediaPlanAlertExcelUI(CompetitorMediaPlanAlertRules.GetFormattedTable(_webSession, Page.Request.QueryString.Get("zoomDate")),_webSession,Page.Request.QueryString.Get("zoomDate"),Page.Request.QueryString.Get("zoomDate"));
//            }
