...
<%@ Page language="c#" Inherits="AdExpress.Private.Results.Excel.DynamicResults" CodeFile="DynamicResults.aspx.cs" %>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<cc2:ResultWebControl id="ResultWebControl1" runat="server" CssLTotal="exlv0" CssL3="exlv3" CssL2="exlv2"
				...
				CssDetailSelectionTitleGlobal="dsTitleGlobal" CssDetailSelectionBordelLevel="dsBorderLevel"></cc2:ResultWebControl>
		</form>
	</body>
</HTML>
