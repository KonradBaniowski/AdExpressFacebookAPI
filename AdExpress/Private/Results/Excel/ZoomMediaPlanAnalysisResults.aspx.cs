...
//		15/09/2005  D. V. Mussuma Intégration de WebPage
//		15/09/2005 D. V. Mussuma : obtention des résultats via une businness façade
#endregion
using System;
...
namespace AdExpress.Private.Results.Excel{
	...
	/// </summary>
	public partial class ZoomMediaPlanAnalysisResults :  TNS.AdExpress.Web.UI.ExcelWebPage{	
...
//		public int _siteLanguage;
		...
		protected void Page_Load(object sender, System.EventArgs e){
			...
			#region Résultats
			try{
				result = BusinessFacadeResults.MediaPlanSystem.GetExcelUI(this,this._webSession,this._dataSource,Page.Request.QueryString.Get("zoomDate"),Page.Request.Url.AbsolutePath,false);
			}
