...
<%@ Page language="c#" Inherits="AdExpress.Private.Results.Excel.ProofResults" CodeFile="ProofResults.aspx.cs" %>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<cc1:ResultWebControl id="ResultWebControl1" runat="server" CssLTotal="exlv0" CssL3="exlv3" CssL2="exlv2"
				...
				CssDetailSelectionTitleGlobal="dsTitleGlobal" CssDetailSelectionBordelLevel="dsBorderLevel" AjaxProTimeOut="120"></cc1:ResultWebControl>
		</form>
	</body>
</HTML>
