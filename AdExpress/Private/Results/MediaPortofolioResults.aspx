...
<HTML>
	...
	<body>
		<form id="Form2" method="post" runat="server">
			...
			<!-- droite-->
			<td tabIndex="4" vAlign="top" background="/images/Common/dupli_fond.gif">
				<table cellSpacing="0" cellPadding="0" border="0">
					<tr>
						<!-- Menu du haut-->
					...
					<tr>
						<td>
							<table cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<tr>
									<td align="center" bgColor="#ffffff" height="5"><cc5:resultwebcontrol id="_ResultWebControl" runat="server" JavascriptFilePath="/scripts/WebResult.js"
											CssDetailSelectionBordelLevel="dsBorderLevel" CssDetailSelectionL1="dsLv1" CssDetailSelectionL2="dsLv2" CssDetailSelectionL3="dsLv3" CssDetailSelectionTitle="dsTitle"
											CssDetailSelectionTitleData="dsTitleData" CssDetailSelectionTitleGlobal="dsTitleGlobal" CssLHeader="h2" BackgroudColorL1="#B1A3C1" CssL1="lv1"
											HighlightBackgroundColorL1="#FFFFFF" HighlightBackgroundColorL3="#FFFFFF" BackgroudColorL2="#D0C8DA" CssL2="lv2" CssL3="lv3" HighlightBackgroundColorL2="#FFFFFF"
											BackgroudColorL3="#E1E0DA" AllowPaging="True" ImgBtnCroiOverPath="/Images/Common/fl_tri_croi3_in.gif" ImgBtnCroiPath="/Images/Common/fl_tri_croi3.gif"
											ImgBtnDeCroiOverPath="/Images/Common/fl_tri_decroi3_in.gif" ImgBtnDeCroiPath="/Images/Common/fl_tri_decroi3.gif" CssLTotal="lv0"></cc5:resultwebcontrol>
										<%=result%>
									</td>
								</tr>
								<tr>
			...
			<TR height="5">
				<TD></TD>
				<TD background="/Images/Common/dupli_fond.gif" vAlign="top">
				...
				<TD></TD>
				<TD></TD>
				<TD id="dellCel" background="/Images/Common/dupli_fond.gif" vAlign="top">
