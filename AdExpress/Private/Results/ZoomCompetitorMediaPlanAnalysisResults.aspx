				...
				<tr>
					...
					<td vAlign="top" width="1%" background="/images/Common/dupli_fond.gif">
						<table id="tableMenu" cellSpacing="0" cellPadding="0" width="10" border="0">
							...
							<tr vAlign="top" bgColor="#ffffff">
								<td><A onmouseover="bouton.src='/Images/<%=_siteLanguage%>/button/back_down.gif';" onmouseout="bouton.src = '/Images/<%=_siteLanguage%>/button/back_up.gif';" href="/Private/Results/CompetitorMediaPlanResults.aspx?idSession=<%=idSession%>" ><IMG src="/Images/<%=_siteLanguage%>/button/back_up.gif" border=0 name=bouton ></A>
								</td>
							</tr>
							<tr bgColor="#ffffff" height="5">
								<td></td>
									...
									<table cellSpacing="0" cellPadding="0" border="0">
										<!--	<tr>
											<td class="txtGris11Bold" bgColor="#ffffff">
												<p style="PADDING-BOTTOM: 5px; PADDING-TOP: 5px"><cc3:adexpresstext language="33" id="mainDescAdexpresstext" runat="server" Code="902"></cc3:adexpresstext></p>
											</td>
										</tr>
										<tr>
