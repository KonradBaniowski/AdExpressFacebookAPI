...
namespace AdExpress.Private.Results{
	...
	/// </summary>
    public partial class DashBoardResults : TNS.AdExpress.Web.UI.ResultWebPage {
...
//				helpWebControl.Url=WebConstantes.Links.HELP_FILE_PATH+"DashBoardResultsHelp.aspx";
		...
		private void DashBoardOptionsWebControl(){
			...
			if(DBClassificationConstantes.Vehicles.names.press==vehicleType
                || DBClassificationConstantes.Vehicles.names.magazine == vehicleType
                || DBClassificationConstantes.Vehicles.names.newspaper == vehicleType)
            {
