...
<%@ Page language="c#" Inherits="AdExpress.Private.Results.MediaPlanAlertResults" CodeFile="MediaPlanAlertResults.aspx.cs" %>
					...
					<td vAlign="top" width="1%" background="/images/Common/dupli_fond.gif">
						<table id="tableMenu" cellSpacing="0" cellPadding="0" width="10" border="0">
							<TBODY>
								...
								<tr vAlign="top">
									<TD vAlign="top"><cc2:resultsoptionswebcontrol id="ResultsOptionsWebControl1" runat="server" PersonalizedSlogansOption="True" MediaDetailOption="False"
											ResultOption="False" AutoPostBackOption="False"></cc2:resultsoptionswebcontrol></TD>
								</tr>
								<tr vAlign="top">
									<td vAlign="top"><cc2:genericmedialeveldetailselectionwebcontrol id="GenericMediaLevelDetailSelectionWebControl1" runat="server" RemoveASPXFilePath="/Private/MyAdExpress/GenericDetailLevelRemove.aspx"
											SaveASPXFilePath="/Private/MyAdExpress/GenericDetailLevelSave.aspx" NbDetailLevelItemList="4" Width="200px"></cc2:genericmedialeveldetailselectionwebcontrol></td>
								</tr>
								<tr bgColor="#ffffff">
								...
								<tr vAlign="top">
									<td align="left"><cc1:imagebuttonrolloverwebcontrol id="okImageButton" runat="server" RollOverImageUrl="/Images/Common/Button/ok_down.gif"
							...
							<tr>
								<td>
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<!-- Tableau de Résultat -->
											<td style="HEIGHT: 19px" bgColor="#ffffff"><cc5:alertmediaplanresultwebcontrol id="AlertMediaPlanResultWebControl1" runat="server" AjaxProTimeOut="240" ShowVersion="True"></cc5:alertmediaplanresultwebcontrol></td>
										</tr>
										<tr>
											<td bgColor="#ffffff" height="5"></td>
										</tr>
