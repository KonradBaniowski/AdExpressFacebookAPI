<%@ Page language="c#" Inherits="Private.Results.RolexResults" CodeFile="RolexResults.aspx.cs" %>
...
<%@ Register TagPrefix="cc5" Namespace="TNS.AdExpress.Web.Controls.Results.Rolex" Assembly="TNS.AdExpress.Web.Controls" %>
	...
	<body class="bodyStyle" onload="javascript:activateActiveX();">
		<form id="Form1" method="post" runat="server">
			<table height="600" cellspacing="0" cellpadding="0" width="800" border="0">
				...
				<tr>
					<td valign="top">
						<table cellspacing="0" cellpadding="0" width="100%" border="0" class="rolexScheduleResults">
						    <tr>
                                <!-- Title -->
                            ...
                            <tr>
                                <td valign="top" align="center">
								    <cc5:RolexscheduleContainerWebControl ID="RolexScheduleContainerWebControl1" runat="server" SkinID="RolexScheduleContainerWebControl"/>
                                </td>
                            </tr>
						</table>
					</td>
