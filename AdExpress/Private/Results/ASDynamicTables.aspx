		...
		<form id="Form2" method="post" runat="server">
						...
						<table id="tableMenu" cellSpacing="0" cellPadding="0" width="10" border="0">
								...
								<tr vAlign="top">
									<TD vAlign="top"><cc2:resultsoptionswebcontrol id="ResultsOptionsWebControl1" runat="server" EvolutionOption="True" PdvOption="True"
											...
											AutoPostBackOption="False" BorderColor="#644883" ProductDetailOption="True" MediaDetailOption="True"
											UnitOption="False" PersonalizedElementsOption="True" InializeAdVertiserOption="True"></cc2:resultsoptionswebcontrol></TD><!--MediaOptionOption="True" --><!--2005MI-->
								</tr>
				<TR>
					<TD style="HEIGHT: 12px" vAlign="top" bgColor="#ffffff"><cc1:imagebuttonrolloverwebcontrol id="ValidateSelectionButton" runat="server" RollOverImageUrl="/Images/Common/Button/ok_down.gif"
							ImageUrl="/Images/Common/Button/ok_up.gif" onclick="ValidateSelectionButton_Click"></cc1:imagebuttonrolloverwebcontrol></TD>
				<tr vAlign="top" bgColor="#ffffff">
					<td><IMG height="10" src="/images/Common/pixel.gif" width="1"></td>
				</tr>
				<tr vAlign="top">
			...
			<td vAlign="top" background="/images/Common/dupli_fond.gif">
				<table cellSpacing="0" cellPadding="0" border="0">
					...
					<tr width="100%">
						<!-- Tableau de Résultat -->
						<td style="HEIGHT: 19px" align="center" bgColor="#ffffff">
							<%=result%>
						</td>
					</tr>
					<tr>
