						...
						<td>
							<table cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<tr bgColor="#ffffff">
									...
									<td bgColor="#ffffff" style="HEIGHT: 37px"><br>
										<cc5:resultwebcontrol id="resultwebcontrol1" runat="server" CssL1="lv1" CssL2="lv2" CssL3="lv3" CssLHeader="h2"
											...
											CssDetailSelectionTitleData="dsTitleData" CssDetailSelectionTitleGlobal="dsTitleGlobal" CssDetailSelectionBordelLevel="dsBorderLevel"></cc5:resultwebcontrol></td>
								</tr>
								<tr>
