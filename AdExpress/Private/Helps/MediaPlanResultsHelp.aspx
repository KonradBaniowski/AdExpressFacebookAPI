...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.MediaPlanResultsHelp" CodeFile="MediaPlanResultsHelp.aspx.cs" %>
			...
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" bgColor="#ffffff" border="0">
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/Help/legendePresent.gif"></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/Help/legendePeriodicite.gif"></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/Help/legendeNonPresent.gif"></td>
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="1955"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/mediaPlanUnit.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/mediaPlanLevelDetail.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/mediaPlanPersonnalizeLevel1.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="1956"></cc1:adexpresstext>&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="1957"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/valider_up.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/mediaPlanPersonnalizeLevel2.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="1958"></cc1:adexpresstext>&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext6" runat="server" Code="1957"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/valider_up.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/mediaPlanPersonnalizeLevel3.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/button/save_up.gif"></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="text2AdExpressText" runat="server" Code="1035"></cc1:adexpresstext><br>
									<cc1:adexpresstext language="33" id="text3AdExpressText" runat="server" Code="1036"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/button/excel_unit_up.gif"></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="1884"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/button/mpOpen.gif"></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="text8AdExpressText" runat="server" Code="1042"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/button/mpClose.gif"></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="text9AdExpressText" runat="server" Code="1043"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text10AdExpressText" runat="server" Code="1044"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<TR>
					<td class="txtViolet12Bold" bgColor="#ded8e5" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="titre4Adexpresstext" runat="server" Code="1045"></cc1:adexpresstext></td>
				</TR>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text11AdExpressText" runat="server" Code="1046"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<tr>
					<td align="right" bgColor="#ffffff" colSpan="2"><A onmouseover="bouton.src='/Images/<%=_siteLanguage%>/button/fermer_down.gif';" onmouseout="bouton.src = '/Images/<%=_siteLanguage%>/button/fermer_up.gif';" href="javascript:window.close();" ><IMG src="/Images/<%=_siteLanguage%>/button/fermer_up.gif" border=0 name=bouton ></A>&nbsp;&nbsp;
					</td>
				</tr>
			</table>
		</form>
