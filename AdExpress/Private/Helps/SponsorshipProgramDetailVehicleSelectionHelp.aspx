<%@ Page language="c#" Inherits="AdExpress.Private.Helps.SponsorshipProgramDetailVehicleSelectionHelp" CodeFile="SponsorshipProgramDetailVehicleSelectionHelp.aspx.cs" %>
	...
	<body class="darkBackGround whiteBackGround" bottomMargin="25" leftMargin="0" topMargin="25" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="whiteBackGround" border="0">
				<TR>
					<td colspan="2">
						<table class="violetBackGround" cellpadding="0" border="0" width="100%">
							<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="1605"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="2148"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="introAdExpressText" runat="server" Code="1368"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Titre1AdExpressText" runat="server" Code="1369"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext7" runat="server" Code="1464"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/choixSupportNomParrainageProgramme1.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="1370"></cc1:adexpresstext>
						<cc1:adexpresstext language="33" id="text2AdExpressText" runat="server" Code="997"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image153" runat="server" SkinID="valider" />&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="1371"></cc1:adexpresstext>
					</td>
				</tr>
				<!-- Icones annuler-->
				<tr>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image62" runat="server" SkinID="initialize" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image63" runat="server" SkinID="initialize_all" /></td>
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="Adexpresstext2" runat="server" Code="979"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text10Adexpresstext" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image64" runat="server" SkinID="enregistrer_univers" />&nbsp;
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext14" runat="server" Code="2448"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext15" runat="server" Code="2449"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext16" runat="server" Code="2450"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text12Adexpresstext" runat="server" Code="1008"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image65" runat="server" SkinID="charger" />&nbsp;
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="997"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image66" runat="server" SkinID="valider" />&nbsp;
				...
				<!-- Texte Choix support tv-->
				<tr>
					<td colSpan="2"><asp:Image ID="Image59" runat="server" SkinID="pixel" height="30" width="100%" /></td>
				</tr>
				<tr>
					<td width="10"><asp:Image ID="Image39" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext11" runat="server" Code="2149"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/choixSupportNomParrainageProgramme2.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="2150"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11Bold"><u><cc1:adexpresstext language="33" id="text5AdExpressText" runat="server" Code="2151"></cc1:adexpresstext></u></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/typeEmissions.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11Bold"><u><cc1:adexpresstext language="33" id="Adexpresstext13" runat="server" Code="2152"></cc1:adexpresstext></u></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/formesParrainage.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image67" runat="server" SkinID="product" /></td>
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="Adexpresstext5" runat="server" Code="1013"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image68" runat="server" SkinID="media" /></td>
								<td class="txtViolet11">
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image55" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image69" runat="server" SkinID="calendar" /></td>
								<td class="txtViolet11">
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image56" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image70" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image57" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image71" runat="server" SkinID="sponsorship" /></td>
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="Adexpresstext6" runat="server" Code="2143"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image58" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image72" runat="server" SkinID="program" /></td>
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="Adexpresstext8" runat="server" Code="2144"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
