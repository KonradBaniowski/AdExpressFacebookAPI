<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProofAlertDateSelectionHelp.aspx.cs" Inherits="Private_Helps_ProofAlertDateSelectionHelp" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="1030"></cc1:adexpresstext>&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="2226"></cc1:adexpresstext><br></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="text5AdExpressText" runat="server" Code="2227"></cc1:adexpresstext><br>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						&nbsp;<asp:Image ID="Image31" runat="server" SkinID="valider" />&nbsp;
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image32" runat="server" SkinID="product" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image33" runat="server" SkinID="media" /></td>
								<td class="txtViolet11">
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image28" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image34" runat="server" SkinID="calendar" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image35" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
