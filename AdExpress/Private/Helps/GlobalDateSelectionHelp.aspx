<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GlobalDateSelectionHelp.aspx.cs" Inherits="Private_Helps_GlobalDateSelectionHelp" %>
    ...
    <div>
            <table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="introAdExpressText" runat="server" Code="1020"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Titre1AdExpressText" runat="server" Code="1021"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="2373"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/GlobalDate.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="2374"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/GlobalDateHistoricYears.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="2375"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/GlobalDateSelection.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="2376"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="997"></cc1:adexpresstext>
					&nbsp;<asp:Image ID="Image153" runat="server" SkinID="initialize" />&nbsp;
					<cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="2377"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext6" runat="server" Code="997"></cc1:adexpresstext>
					&nbsp;<asp:Image ID="Image50" runat="server" SkinID="valider" />&nbsp;
					<cc1:adexpresstext language="33" id="Adexpresstext7" runat="server" Code="2378"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext8" runat="server" Code="1024"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="text4AdExpressText" runat="server" Code="2379"></cc1:adexpresstext><br>
					</td>
				<tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/GlobalDateRollingPeriod.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="997"></cc1:adexpresstext>
					&nbsp;<asp:Image ID="Image51" runat="server" SkinID="valider" />&nbsp;
					<cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="1029"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext11" runat="server" Code="2380"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="2381"></cc1:adexpresstext><br>
					</td>
				<tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/GlobalDateComparativeOption2.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext13" runat="server" Code="2382"></cc1:adexpresstext><br>
					</td>
				<tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/GlobalDateComparativeOption1.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext14" runat="server" Code="2383"></cc1:adexpresstext><br>
					</td>
				<tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/GlobalDateComparativeOption3.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image46" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image52" runat="server" SkinID="product" /></td>
								<td class="txtViolet11">
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image47" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image53" runat="server" SkinID="media" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image54" runat="server" SkinID="calendar" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image55" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
