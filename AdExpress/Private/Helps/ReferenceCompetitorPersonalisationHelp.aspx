				...
				<TBODY>
					...
					<tr>
						...
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="1345"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/suivant_up.gif">.
						</td>
					</tr>
					<!-- Exemple -->
					<tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/annRefSelectionRecap.gif" ></td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
					</tr>
					...
					<tr>
						<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="1341"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/suivant_up.gif">&nbsp;
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/annConcSelectionRecap.gif" ></td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
					</tr>
					...
					<tr>
						<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext6" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/back_up.gif">&nbsp;
