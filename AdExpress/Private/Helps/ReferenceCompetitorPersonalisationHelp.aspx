...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.ReferenceCompetitorPersonalisationHelp" CodeFile="ReferenceCompetitorPersonalisationHelp.aspx.cs" %>
				...
				<TBODY>
					...
					<TR>
						<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
							<cc1:adexpresstext language="33" id="Titre1AdExpressText" runat="server" Code="1122"></cc1:adexpresstext></td>
					</TR>
					<tr>
						<td colSpan="2"><asp:Image ID="Image2" runat="server" SkinID="pixel" height="15" width="100%" /></td>
					</tr>
					<!-- Texte Annonceurs de référence-->
					<tr>
						<td width="10"><asp:Image ID="Image7" runat="server" SkinID="pixel" width="10" /></td>
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="1345"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image153" runat="server" SkinID="suivant" />.
						</td>
					</tr>
					<!-- Exemple -->
					<tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annRefSelectionRecap.gif" ></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="1341"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image28" runat="server" SkinID="suivant" />&nbsp;
							<cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="1342"></cc1:adexpresstext>
						</td>
					</tr>
					<tr>
					...
					<TR>
						<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
							<cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="1123"></cc1:adexpresstext></td>
					</TR>
					<tr>
						<td colSpan="2"><asp:Image ID="Image4" runat="server" SkinID="pixel" height="15" width="100%" /></td>
					</tr>
					<!-- Texte Annonceurs concurrent-->
					<tr>
						<td width="10"><asp:Image ID="Image9" runat="server" SkinID="pixel" width="10" /></td>
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="1343"></cc1:adexpresstext>
						</td>
					</tr>
					<!-- Exemple -->
					<tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annConcSelectionRecap.gif" ></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext6" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image29" runat="server" SkinID="back" />&nbsp;
							<cc1:adexpresstext language="33" id="Adexpresstext7" runat="server" Code="1346"></cc1:adexpresstext>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colSpan="2"><asp:Image ID="Image21" runat="server" SkinID="pixel" height="12" width="100%" /></td>
					</tr>
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image30" runat="server" SkinID="product" /></td>
					...
					<tr>
						<td colSpan="2"><asp:Image ID="Image22" runat="server" SkinID="pixel" height="12" width="100%" /></td>
					</tr>
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image31" runat="server" SkinID="media" /></td>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image32" runat="server" SkinID="calendar" /></td>
					...
					<tr>
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="40" align="center"><asp:Image ID="Image33" runat="server" SkinID="result" /></td>
									<td class="txtViolet11">
