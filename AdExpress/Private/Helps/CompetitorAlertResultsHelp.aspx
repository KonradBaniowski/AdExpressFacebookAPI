<%@ Page language="c#" Inherits="AdExpress.Private.Helps.CompetitorAlertResultsHelp" CodeFile="CompetitorAlertResultsHelp.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext30" runat="server" Code="2384"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image1" runat="server" SkinID="pixel" height="15" width="100%" /></td>
				</tr>
				<!-- Titre 1 : Sélection des unités -->
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext32" runat="server" Code="2385"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext33" runat="server" Code="2386"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image80" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/PresentAbsentUnitSelection.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynPDM.gif" ></td>
								<td class="txtViolet11">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext34" runat="server" Code="1441"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<!-- Titre 2 : Sélection du type de résultats -->
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="2387"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="1443"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/PresentAbsentResultSelection.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext37" runat="server" Code="2441"></cc1:adexpresstext></td>
				</tr>
				<!-- Titre 3 : Sélection du niveau de détail colonne -->
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext35" runat="server" Code="2388"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext36" runat="server" Code="2389"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/ColumnDetails.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image85" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Titre : Sélection du niveau de détail ligne - Niveaux personnalisés -->
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext22" runat="server" Code="2424"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="2126"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image86" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						<cc1:adexpresstext language="33" id="Adexpresstext14" runat="server" Code="1957"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image153" runat="server" SkinID="valider" />
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image87" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						<cc1:adexpresstext language="33" id="Adexpresstext19" runat="server" Code="1957"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image117" runat="server" SkinID="valider" />
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image88" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image118" runat="server" SkinID="save" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext20" runat="server" Code="2129"></cc1:adexpresstext></td>
							</tr>
							<tr>
								<td align="center" width="40"><asp:Image ID="Image119" runat="server" SkinID="delete2" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image116" runat="server" SkinID="pixel" height="25" width="100%" /></td>
				</tr>
				...
				<!-- Titre 4 : Sélection des agences media -->
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext38" runat="server" Code="2390"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext39" runat="server" Code="2391"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image89" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="2392"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext7" runat="server" Code="1463"></cc1:adexpresstext>
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image90" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext8" runat="server" Code="2393"></cc1:adexpresstext>
					&nbsp;<asp:Image ID="Image120" runat="server" SkinID="fiche" /></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image91" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image92" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext31" runat="server" Code="2138"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext40" runat="server" Code="2133"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext41" runat="server" Code="2134"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image93" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Titre : Accès au plan media -->
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext42" runat="server" Code="2394"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext43" runat="server" Code="2395"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image94" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Titre : Accès aux créations présentées par versions -->
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext44" runat="server" Code="2428"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext45" runat="server" Code="2442"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td width="10"><asp:Image ID="Image59" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext46" runat="server" Code="2443"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image95" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/VersionsMonthNavigation.gif" ></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext47" runat="server" Code="2435"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext48" runat="server" Code="2444"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td width="10"><asp:Image ID="Image61" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext49" runat="server" Code="2445"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image96" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/VersionsMonthNavigation.gif" ></td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image121" runat="server" SkinID="print" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext50" runat="server" Code="2446"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext51" runat="server" Code="2396"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext52" runat="server" Code="2397"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image97" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image98" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><strong><u><cc1:adexpresstext language="33" id="Adexpresstext53" runat="server" Code="2398"></cc1:adexpresstext></u></strong></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image99" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td width="10"><asp:Image ID="Image65" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><u><cc1:adexpresstext language="33" id="Adexpresstext54" runat="server" Code="2399"></cc1:adexpresstext></u></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image100" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Pictos -->
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image124" runat="server" SkinID="media" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext55" runat="server" Code="1014"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image125" runat="server" SkinID="calendar" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext56" runat="server" Code="1015"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="AdExpressText57" runat="server" Code="1016"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td class="txtViolet11"><u><cc1:adexpresstext language="33" id="Adexpresstext58" runat="server" Code="2400"></cc1:adexpresstext></u></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image101" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Picto save -->
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image122" runat="server" SkinID="save" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="2451"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image102" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/PopUpSaveResult.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image103" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Texte -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><u><cc1:adexpresstext language="33" id="Adexpresstext60" runat="server" Code="2401"></cc1:adexpresstext></u></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image104" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Pictos excel -->
				<!-- Excel print -->
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image123" runat="server" SkinID="print" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext61" runat="server" Code="1662"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image105" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Excel export-->
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image127" runat="server" SkinID="excel" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext62" runat="server" Code="1663"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11"><u><cc1:adexpresstext language="33" id="Adexpresstext63" runat="server" Code="2402"></cc1:adexpresstext></u></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image106" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Pictos reminder -->
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image128" runat="server" SkinID="selected" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext64" runat="server" Code="2403"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image107" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/ExportDetailSelection.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image108" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image109" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>			
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image129" runat="server" SkinID="bt_detail" /></td>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image110" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
