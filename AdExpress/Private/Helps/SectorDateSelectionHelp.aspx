...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.SectorDateSelectionHelp" CodeFile="SectorDateSelectionHelp.aspx.cs" %>
			...
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				<TBODY>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="1318"></cc1:adexpresstext></td>
					</tr>
					<tr>
						<td width="10"><asp:Image ID="Image12" runat="server" SkinID="pixel" width="10" /></td>
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="1319"></cc1:adexpresstext></td>
					</tr>
					<tr>
						...
						<td class="txtViolet11">
							...
							&nbsp;<asp:Image ID="Image153" runat="server" SkinID="valider" />&nbsp;
					...
					<tr>
						<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/calendarMonthRecap.gif"></td>
					</tr>
					<tr>
					...
					<TR>
						<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
							<cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="1024"></cc1:adexpresstext></td>
					</TR>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="text4AdExpressText" runat="server" Code="1320"></cc1:adexpresstext><br>
						</td>
					</tr>
					<tr>
						<td width="10"><asp:Image ID="Image15" runat="server" SkinID="pixel" width="10" /></td>
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="text7AdExpressText" runat="server" Code="1028"></cc1:adexpresstext><br>
						</td>
					</tr>
					<tr>
						<td width="10"><asp:Image ID="Image16" runat="server" SkinID="pixel" width="10" /></td>
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="text5AdExpressText" runat="server" Code="1321"></cc1:adexpresstext><br>
						</td>
					</tr>
					<tr>
						<td width="10"><asp:Image ID="Image17" runat="server" SkinID="pixel" width="10" /></td>
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="1319"></cc1:adexpresstext><br>
						</td>
					</tr>
					<!-- Exemple Image -->
					<tr>
						<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/comparative.gif"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="1322"></cc1:adexpresstext><br>
						</td>
					</tr>
					<tr>
						...
						<td class="txtViolet11">
							...
							&nbsp;<asp:Image ID="Image33" runat="server" SkinID="valider" />&nbsp;
							<cc1:adexpresstext language="33" id="text8AdExpressText" runat="server" Code="1023"></cc1:adexpresstext>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colSpan="2"><asp:Image ID="Image29" runat="server" SkinID="pixel" height="12" width="100%" /></td>
					</tr>
					<tr>
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="40" align="center"><asp:Image ID="Image34" runat="server" SkinID="product" /></td>
									<td class="txtViolet11">
					...
					<tr>
						<td colSpan="2"><asp:Image ID="Image30" runat="server" SkinID="pixel" height="12" width="100%" /></td>
					</tr>
					<tr>
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="40" align="center"><asp:Image ID="Image35" runat="server" SkinID="media" /></td>
									<td class="txtViolet11">
					...
					<tr>
						<td colSpan="2"><asp:Image ID="Image31" runat="server" SkinID="pixel" height="12" width="100%" /></td>
					</tr>
					<tr>
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="40" align="center"><asp:Image ID="Image36" runat="server" SkinID="calendar" /></td>
									<td class="txtViolet11">
					...
					<tr>
						<td colSpan="2"><asp:Image ID="Image32" runat="server" SkinID="pixel" height="12" width="100%" /></td>
					</tr>
					<tr>
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="40" align="center"><asp:Image ID="Image37" runat="server" SkinID="result" /></td>
									<td class="txtViolet11">
