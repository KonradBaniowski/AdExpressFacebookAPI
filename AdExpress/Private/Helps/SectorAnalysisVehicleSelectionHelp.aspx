...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.SectorAnalysisVehicleSelectionHelp" CodeFile="SectorAnalysisVehicleSelectionHelp.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="introAdExpressText" runat="server" Code="1688"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynSelectMediaAllDisplay.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="1689"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Titre1AdExpressText" runat="server" Code="1690"></cc1:adexpresstext></td>
				</TR>
				<!-- texte-->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="1691"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynSelectMedia01.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="1692"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynSelectMedia02.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="1693"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynSelectMedia03.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image13" runat="server" SkinID="pixel" height="15" width="100%" /></td>
				</tr>
				<!-- texte sélectionner/déselectionner categorie-->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="1694"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynSelectMediaOptionCategory.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image15" runat="server" SkinID="pixel" height="15" width="100%" /></td>
				</tr>
				<!-- texte sélectionner/déselectionner support-->
				<tr>
					<td width="10"><asp:Image ID="Image29" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="1695"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynSelectMediaOptionSupport.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image16" runat="server" SkinID="pixel" height="15" width="100%" /></td>
				</tr>
				<!-- texte deployer/replier media-->
				<tr>
					<td width="10"><asp:Image ID="Image30" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext6" runat="server" Code="1696"></cc1:adexpresstext>&nbsp;<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynSelectMediaOptionOpenClose.gif" ></td>
				</tr>
				<!-- texte deployer/replier media-->
				<tr>
					<td width="10"><asp:Image ID="Image31" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext7" runat="server" Code="1697"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image43" runat="server" SkinID="bt_arrow_down" /><br>
						<cc1:adexpresstext language="33" id="Adexpresstext8" runat="server" Code="1698"></cc1:adexpresstext>
					</td>
				</tr>
				<!-- clic valider-->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="1699"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image153" runat="server" SkinID="ok" /></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="titre3Adexpresstext" runat="server" Code="1010"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image44" runat="server" SkinID="product" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image45" runat="server" SkinID="media" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image46" runat="server" SkinID="calendar" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image47" runat="server" SkinID="result" /></td>
