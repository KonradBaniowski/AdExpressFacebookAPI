	...
	<body style="BACKGROUND-ATTACHMENT: fixed; BACKGROUND-IMAGE: url(/Images/Common/dark_back.bmp); BACKGROUND-REPEAT: repeat-x"
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" bgColor="#ffffff" border="0">
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/APPMResultOptions.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><IMG src="/Images/<%=_siteLanguage%>/Help/mediaAgenciesOption.gif" >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="1804"></cc1:adexpresstext></td>
				</tr>
				<!-- option : produits-->
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><IMG src="/Images/<%=_siteLanguage%>/Help/productsOptions.gif" >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="1805"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext8" runat="server" Code="1809"></cc1:adexpresstext><br>
						...
						<cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="997"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/Help/lienCheminDeFer.gif" >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext11" runat="server" Code="1811"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/back_up.gif" >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext15" runat="server" Code="1812"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/button/chart_up.gif"></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/button/table_up.gif"></td>
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><IMG src="/Images/<%=_siteLanguage%>/Help/tabBordResultOptionUnite.gif" >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext35" runat="server" Code="1818"></cc1:adexpresstext></td>
				</tr>
				<!-- Validation OK -->
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext31" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<IMG src="/Images/Common/button/ok_up.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext32" runat="server" Code="1336"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/button/result2_up.gif"></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/<%=_siteLanguage%>/Help/alertPMbackCalendar.gif">&nbsp;</td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/<%=_siteLanguage%>/Help/APPMSynthesis.gif">&nbsp;</td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/Images/Common/button/txt_export_up.gif"></td>
