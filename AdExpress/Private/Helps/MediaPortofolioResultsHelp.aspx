	...
	<body class="darkBackGround whiteBackGround" bottomMargin="25" leftMargin="0" topMargin="25" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="whiteBackGround" border="0">
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/portfolioAnaResultOption.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/portAnaSynthesePubTVRadio.gif" >&nbsp;<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/portAnaSynthesePubPress.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/portAnaDetailColonne.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							...
							<tr>
								<td align="center" width="40"><asp:Image ID="Image94" runat="server" SkinID="delete" /></td>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext33" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image95" runat="server" SkinID="ok" />&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext34" runat="server" Code="1336"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image99" runat="server" SkinID="excelExport" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image100" runat="server" SkinID="product" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image87" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image90" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image104" runat="server" SkinID="product" /></td>
								<td class="txtViolet11">
