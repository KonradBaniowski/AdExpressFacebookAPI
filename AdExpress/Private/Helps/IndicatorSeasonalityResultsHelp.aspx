		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" bgColor="#ffffff" border="0">
				<TBODY>
					...
					<tr>
						<td colSpan="2" align="center"><IMG src="/Images/<%=_siteLanguage%>/Help/totalSelectionRecap.gif"></td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
					</tr>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><IMG src="/Images/Common/button/loupe_zoom_up.gif"></td>
					...
					<tr>
						<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext16" runat="server" Code="2036"></cc1:adexpresstext></td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
					</tr>
					<tr>
						...
						<td class="txtViolet11">
							<IMG src="/Images/<%=_siteLanguage%>/Help/annDynAnnulerPersoKO.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="1459"></cc1:adexpresstext>
						</td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="12" src="/Images/Common/pixel.gif" width="100%"></td>
					...
					<tr>
						<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
						<td class="txtViolet11">
							<IMG src="/Images/<%=_siteLanguage%>/Help/annDynAnnulerPersoOK.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="1460"></cc1:adexpresstext>
						</td>
					</tr>
					<!-- Texte -->
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							...
							<br>
							<cc1:adexpresstext language="33" id="Adexpresstext13" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/valider_up.gif" >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext14" runat="server" Code="1336"></cc1:adexpresstext>
						</td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				...
				<tr>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><IMG src="/Images/Common/button/export_jpeg_up.gif"></td>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><IMG src="/Images/Common/button/LogoPDF_up.gif"></td>
