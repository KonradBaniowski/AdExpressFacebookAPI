...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.IndicatorSeasonalityResultsHelp" CodeFile="IndicatorSeasonalityResultsHelp.aspx.cs" %>
			...
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				<TBODY>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="introAdExpressText" runat="server" Code="1347"></cc1:adexpresstext></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="1348"></cc1:adexpresstext></td>
					</tr>
					<!-- Exemple Image -->
					<tr>
					...
					<tr>
						<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/totalSelectionRecap.gif"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="1349"></cc1:adexpresstext></td>
					</tr>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="text14Adexpresstext" runat="server" Code="1350"></cc1:adexpresstext></td>
					</tr>
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image153" runat="server" SkinID="chart" /></td>
									<td class="txtViolet11"><cc1:adexpresstext language="33" id="text15Adexpresstext" runat="server" Code="1351"></cc1:adexpresstext></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td colSpan="2"><asp:Image ID="Image48" runat="server" SkinID="pixel" height="12" width="100%" /></td>
					</tr>
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image61" runat="server" SkinID="table" /></td>
									<td class="txtViolet11"><cc1:adexpresstext language="33" id="text16Adexpresstext" runat="server" Code="1352"></cc1:adexpresstext></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td colSpan="2"><asp:Image ID="Image49" runat="server" SkinID="pixel" height="12" width="100%" /></td>
					</tr>
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image62" runat="server" SkinID="loupe_zoom" /></td>
									<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="1353"></cc1:adexpresstext></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td colSpan="2"><asp:Image ID="Image50" runat="server" SkinID="pixel" height="12" width="100%" /></td>
					</tr>
					<tr>
						<td width="10"><asp:Image ID="Image24" runat="server" SkinID="pixel" width="10" /></td>
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext16" runat="server" Code="2458"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image123" runat="server" SkinID="product" />.</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynAnnulerPersoKO.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="1459"></cc1:adexpresstext>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynAnnulerPersoOK.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="1460"></cc1:adexpresstext>
						</td>
					</tr>
					<!-- Texte -->
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="1354"></cc1:adexpresstext><br>
							<br>
							<cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="1355"></cc1:adexpresstext><br>
							<br>
							<cc1:adexpresstext language="33" id="Adexpresstext13" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image63" runat="server" SkinID="valider" />&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext14" runat="server" Code="1336"></cc1:adexpresstext>
						</td>
					</tr>
					<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image64" runat="server" SkinID="save" /></td>
				...
				<tr>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image65" runat="server" SkinID="print" /></td>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image66" runat="server" SkinID="excel" /></td>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image68" runat="server" SkinID="jpegExport" /></td>
									<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="2029"></cc1:adexpresstext></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image67" runat="server" SkinID="pdfExport" /></td>
									<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext15" runat="server" Code="2030"></cc1:adexpresstext></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="2020"></cc1:adexpresstext></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image69" runat="server" SkinID="product" /></td>
									<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext7" runat="server" Code="1013"></cc1:adexpresstext></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image70" runat="server" SkinID="media" /></td>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image71" runat="server" SkinID="calendar" /></td>
					...
					<tr>
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="40" align="center"><asp:Image ID="Image72" runat="server" SkinID="result" /></td>
									<td class="txtViolet11">
					...
					<tr>
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="40" align="center"><asp:Image ID="Image73" runat="server" SkinID="product" /></td>
									<td class="txtViolet11">
