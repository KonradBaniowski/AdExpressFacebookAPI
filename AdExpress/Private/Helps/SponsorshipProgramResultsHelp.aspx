<%@ Page language="c#" Inherits="AdExpress.Private.Helps.SponsorshipProgramResultsHelp" CodeFile="SponsorshipProgramResultsHelp.aspx.cs" %>
	...
	<body class="darkBackGround backGroundWhite" bottomMargin="25" leftMargin="0" topMargin="25" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/parrainageProgramDetailLevel.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext7" runat="server" Code="2146"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/creationParrainageProgram.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image58" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/creationParrainageTV.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image59" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Texte Niveaux personnalisée spot à spot -->
				<tr>
					<td width="10"><asp:Image ID="Image22" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="2147"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/creationParrainageTVNiveauPerso1.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image61" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/creationParrainageTVNiveauPerso2.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/parrainageProgramDetailSelectionDiv.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						<cc1:adexpresstext language="33" id="Adexpresstext14" runat="server" Code="1957"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image85" runat="server" SkinID="valider" />
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						<cc1:adexpresstext language="33" id="Adexpresstext19" runat="server" Code="1957"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image86" runat="server" SkinID="valider" />
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image75" runat="server" SkinID="pixel" height="25" width="100%" /></td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;
						<asp:Image ID="Image89" runat="server" SkinID="ok" />&nbsp;
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image92" runat="server" SkinID="product" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="text16Adexpresstext" runat="server" Code="2145"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image93" runat="server" SkinID="media" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image94" runat="server" SkinID="calendar" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image95" runat="server" SkinID="result" /></td>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image96" runat="server" SkinID="sponsorship" /></td>
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="Adexpresstext4" runat="server" Code="2143"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image97" runat="server" SkinID="program" /></td>
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="Adexpresstext6" runat="server" Code="2144"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
