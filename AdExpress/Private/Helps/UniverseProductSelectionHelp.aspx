<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UniverseProductSelectionHelp.aspx.cs" Inherits="Private_Helps_UniverseProductSelectionHelp" %>
        ...
        <div>
               <table cellSpacing="0" cellPadding="0" width="98%" align="center" class="whiteBackGround" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="2404"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/UniverseProductBranchKeyword.gif"></td>
				</tr>
				<tr>
                ...
                <tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="2405"></cc1:adexpresstext></td>
				</tr>
				<!-- Boutons -->
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image56" runat="server" SkinID="bt_loupe" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext20" runat="server" Code="2406"></cc1:adexpresstext></td>
							</tr>
							<tr>
					            <td colSpan="2"><asp:Image ID="Image50" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				            </tr>
							<tr>
								<td align="center" width="40"><asp:Image ID="Image153" runat="server" SkinID="initialize" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext21" runat="server" Code="2407"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image55" runat="server" SkinID="pixel" height="25" width="100%" /></td>
				</tr>
				<!-- Texte -->
                <tr>
					<td width="10"><asp:Image ID="Image31" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="2408"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/UniverseProductResultKeyword.gif"></td>
				</tr>
				<tr>
                ...
                <tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="2409"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/UniverseProductExcludeItem.gif"></td>
				</tr>
				<tr>
                ...
                <tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="2410"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/UniverseProductIncludeItem.gif"></td>
				</tr>
				<tr>
                ...
                <tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="2411"></cc1:adexpresstext></td>
				</tr>
				<tr>
                ...
                <tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext6" runat="server" Code="2412"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/UniverseProductIntersectionItem.gif"></td>
				</tr>
				<tr>
                ...
                <tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext7" runat="server" Code="2413"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><asp:Image ID="Image57" runat="server" SkinID="bt_delete_item" />&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="2414"></cc1:adexpresstext></td>
				</tr>
				<!-- Boutons -->
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/UniverseProductDeleteItem.gif"></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="2415"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text10Adexpresstext" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image58" runat="server" SkinID="enregistrer_univers" />&nbsp;
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text12Adexpresstext" runat="server" Code="1008"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image59" runat="server" SkinID="charger" />&nbsp;
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image60" runat="server" SkinID="product" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image61" runat="server" SkinID="media" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image63" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
