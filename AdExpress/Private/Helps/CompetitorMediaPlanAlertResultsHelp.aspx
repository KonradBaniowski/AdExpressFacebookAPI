	...
	<body style="BACKGROUND-ATTACHMENT: fixed; BACKGROUND-IMAGE: url(/Images/Common/dark_back.bmp); BACKGROUND-REPEAT: repeat-x"
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" bgColor="#ffffff" border="0">
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text11AdExpressText" runat="server" Code="1048"></cc1:adexpresstext>&nbsp;<img src="/Images/Common/Help/picto.gif"><br>
						<cc1:adexpresstext language="33" id="text12AdExpressText" runat="server" Code="1049"></cc1:adexpresstext>:
					</td>
				</tr>
				<tr>
					<td colSpan="2" align="center"><IMG src="/Images/Common/button/print_up.gif"></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
