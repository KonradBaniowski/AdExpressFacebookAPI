<%@ Page language="c#" Inherits="AdExpress.Private.Helps.MediaPlanAlertResultsHelp" CodeFile="CompetitorMediaPlanAlertResultsHelp.aspx.cs" %>
			...
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="whiteBackGround" border="0">
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image53" runat="server" SkinID="print" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image54" runat="server" SkinID="excel" /></td>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text5AdExpressText" runat="server" Code="1080"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image55" runat="server" SkinID="mpOpen" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image56" runat="server" SkinID="mpClose" /></td>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text11AdExpressText" runat="server" Code="1048"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image57" runat="server" SkinID="picto_plus" /><br>
						<cc1:adexpresstext language="33" id="text12AdExpressText" runat="server" Code="1049"></cc1:adexpresstext>:
					</td>
				</tr>
				<tr>
					<td colSpan="2" align="center"><asp:Image ID="Image58" runat="server" SkinID="print" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image45" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
