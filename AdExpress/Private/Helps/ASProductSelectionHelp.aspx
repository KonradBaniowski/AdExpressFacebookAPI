	...
	<body class="darkBackGround backGroundWhite" bottomMargin="25" leftMargin="0" topMargin="25" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/ChoixNomenclature1.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/ChoixNomenclature2.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/ChoixNomenclature3.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text10Adexpresstext" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image119" runat="server" SkinID="enregistrer_univers" />&nbsp;
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text12Adexpresstext" runat="server" Code="1008"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image153" runat="server" SkinID="charger" />&nbsp;
