	...
	<body class="darkBackGround whiteBackGround" bottomMargin="25" leftMargin="0" topMargin="25" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="whiteBackGround" border="0">
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionCentreInteret.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionFamille.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionUnite.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionJourNomme.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionTrancheHoraire.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionFormat.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionPeriodeMensuelle.gif" >&nbsp;<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionPeriodeHebdo.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionMediaDetaille.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionPdmPdvEvol.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionTypeTableaux.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordResultOptionInsertion.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
					    <cc1:adexpresstext language="33" id="Adexpresstext19" runat="server" Code="1005"></cc1:adexpresstext>
					    &nbsp;<asp:Image ID="Image153" runat="server" SkinID="ok" />&nbsp;
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image63" runat="server" SkinID="save" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image64" runat="server" SkinID="print" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image65" runat="server" SkinID="printCol" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image59" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image60" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image61" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image126" runat="server" SkinID="result" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image62" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image66" runat="server" SkinID="product" /></td>
