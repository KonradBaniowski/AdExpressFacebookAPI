	...
	<body style="BACKGROUND-ATTACHMENT: fixed; BACKGROUND-IMAGE: url(/Images/Common/dark_back.bmp); BACKGROUND-REPEAT: repeat-x"
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" bgColor="#ffffff" border="0">
					...
					<td colspan="2">
						<table bgColor="#644883" cellpadding="0" border="0" width="100%">
							<tr>
								...
								<!--td align="right"><img src="/Images/Common/button/help_up.gif" border="0"></td>-->
							</tr>
						</table>
					</td>
				</TR>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/Images/<%=_siteLanguage%>/Help/annComptitorSelection.gif"></td>
				</tr>
				<!-- bouton suivant-->
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/Images/<%=_siteLanguage%>/Help/annSelection.gif"></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/Images/<%=_siteLanguage%>/Help/annProSelection.gif"></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/Images/<%=_siteLanguage%>/Help/proSelection.gif"></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
