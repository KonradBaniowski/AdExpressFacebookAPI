...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.AdvertiserCompetitorSelectionHelp" CodeFile="AdvertiserCompetitorSelectionHelp.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="whiteBackGround" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="introAdExpress0Text" runat="server" Code="1069"></cc1:adexpresstext><br>
						<br>
						<cc1:adexpresstext language="33" id="introAdExpressText" runat="server" Code="994"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="996"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td width="10"><asp:Image ID="Image28" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text20AdExpressText" runat="server" Code="1070"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annComptitorSelection.gif"></td>
				</tr>
				<!-- bouton suivant-->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
					    <table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image150" runat="server" SkinID="initialize" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="text4AdExpressText" runat="server" Code="2456"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image59" runat="server" SkinID="pixel" height="5" width="100%" /></td>
				</tr>
				<tr>
					...
					<td class="txtViolet11">
					    ...
					    <table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image58" runat="server" SkinID="initialize_all" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="text40AdExpressText" runat="server" Code="2457"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11Bold"><cc1:adexpresstext language="33" id="text5AdExpressText" runat="server" Code="1000"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text6AdExpressText" runat="server" Code="1001"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annSelection.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text7Adexpresstext" runat="server" Code="1002"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annProSelection.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text8Adexpresstext" runat="server" Code="1003"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/proSelection.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text9Adexpresstext" runat="server" Code="1074"></cc1:adexpresstext></td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text130Adexpresstext" runat="server" Code="1075"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image158" runat="server" SkinID="selected" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image159" runat="server" SkinID="product" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image161" runat="server" SkinID="media" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image162" runat="server" SkinID="calendar" /></td>
								<td class="txtViolet11">
