<%@ Page language="c#" Inherits="AdExpress.Private.Helps.RefineMediaUniverseSelectionHelp" CodeFile="RefineMediaUniverseSelectionHelp.aspx.cs" %>
			...
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image44" runat="server" SkinID="initialize" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image45" runat="server" SkinID="initialize_all" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text10Adexpresstext" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image46" runat="server" SkinID="enregistrer_univers" />&nbsp;
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annSave.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text12Adexpresstext" runat="server" Code="1008"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image47" runat="server" SkinID="charger" />&nbsp;
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="997"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image48" runat="server" SkinID="valider" />&nbsp;
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image43" runat="server" SkinID="pixel" height="30" width="100%" /></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/choixSupportNomParrainageProgramme3.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image49" runat="server" SkinID="product" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image50" runat="server" SkinID="calendar" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image51" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
