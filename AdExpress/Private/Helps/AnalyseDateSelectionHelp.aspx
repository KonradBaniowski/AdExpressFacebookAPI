...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.AnalyseDateSelectionHelp" CodeFile="AnalyseDateSelectionHelp.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="1022"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/calendarMonth.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="text4AdExpressText" runat="server" Code="1025"></cc1:adexpresstext><br>
					</td>
				<tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="text5AdExpressText" runat="server" Code="1027"></cc1:adexpresstext><br>
					</td>
				<tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						&nbsp;<asp:Image ID="Image30" runat="server" SkinID="valider" />&nbsp;
