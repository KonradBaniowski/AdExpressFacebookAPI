<%@ Page language="c#" Inherits="AdExpress.Private.Helps.ASDynamicTablesHelp" CodeFile="ASDynamicTablesHelp.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				<TBODY>
					...
					<!-- Texte Option d'analyse : Plurimedia-->
					<tr>
						<td width="10"><asp:Image ID="Image12" runat="server" SkinID="pixel" width="10" /></td>
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="1325"></cc1:adexpresstext><cc1:adexpresstext language="33" id="AdExpressText2" runat="server" Code="1327"></cc1:adexpresstext></td>
					</tr>
					<!-- Exemple -->
					<tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/plurimediaSelectionRecap.gif" ></td>
					</tr>
					<tr>
						<td colSpan="2"><asp:Image ID="Image38" runat="server" SkinID="pixel" height="10" width="100%" /></td>
					</tr>
					<!-- Texte Option d'analyse : Monomedia-->
					<tr>
						<td width="10"><asp:Image ID="Image13" runat="server" SkinID="pixel" width="10" /></td>
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext6" runat="server" Code="1330"></cc1:adexpresstext><cc1:adexpresstext language="33" id="Adexpresstext7" runat="server" Code="1329"></cc1:adexpresstext></td>
					</tr>
					<!-- Exemple -->
					<tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/monomediaSelectionRecap.gif" ></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="1328"></cc1:adexpresstext></td>
					</tr>
					<!-- Exemple -->
					<tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/productSelectionRecapList.gif" ></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11">
							<cc1:adexpresstext language="33" id="Adexpresstext8" runat="server" Code="1331"></cc1:adexpresstext></td>
					</tr>
					<!-- Exemple -->
					<tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/typeRecapList.gif" ></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="1332"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image119" runat="server" SkinID="valider" />.</td>
					</tr>
					<!-- Exemple -->
					<tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/optionsRecap.gif" ></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="2031"></cc1:adexpresstext><br>
							<br>
							<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/elemPersoDisabled.gif" align=absMiddle >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext11" runat="server" Code="1334"></cc1:adexpresstext><br>
							<br>
							<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/elemPerso.gif" align=absMiddle >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="1335"></cc1:adexpresstext><br>
							<br>
							<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynAnnulerPersoKO.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="1459"></cc1:adexpresstext><br>
							<br>
							<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynAnnulerPersoOK.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext20" runat="server" Code="1460"></cc1:adexpresstext><br>
							<br>
							<cc1:adexpresstext language="33" id="Adexpresstext13" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image56" runat="server" SkinID="valider" />&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext14" runat="server" Code="1336"></cc1:adexpresstext>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext19" runat="server" Code="1340"></cc1:adexpresstext></td>
					</tr>
					<tr>
				...
				<tr>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image57" runat="server" SkinID="excel" /></td>
									<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext21" runat="server" Code="1663"></cc1:adexpresstext></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<table cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td align="center" width="40"><asp:Image ID="Image123" runat="server" SkinID="product" /></td>
					...
					<tr>
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td width="40" align="center"><asp:Image ID="Image58" runat="server" SkinID="product" /></td>
									<td class="txtViolet11">
										<cc1:AdExpressText language="33" id="Adexpresstext3" runat="server" Code="1344"></cc1:AdExpressText>
									</td>
								</tr>
							</table>
						</td>
