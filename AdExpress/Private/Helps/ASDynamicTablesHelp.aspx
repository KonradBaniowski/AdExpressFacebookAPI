		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" bgColor="#ffffff" border="0">
				<TBODY>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/plurimediaSelectionRecap.gif" ></td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
					</tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/monomediaSelectionRecap.gif" ></td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
					</tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/productSelectionRecapList.gif" ></td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
					</tr>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/typeRecapList.gif" ></td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
					</tr>
					...
					<tr>
						<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="1332"></cc1:adexpresstext><IMG src="/Images/<%=_siteLanguage%>/button/valider_up.gif" >.</td>
					</tr>
					<!-- Exemple -->
					<tr>
						<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
					...
					<tr>
						<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/optionsRecap.gif" ></td>
					</tr>
					<tr>
						<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
					</tr>
					...
					<tr>
						...
						<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="2031"></cc1:adexpresstext><br>
							<br>
							<IMG src="/Images/<%=_siteLanguage%>/Help/elemPersoDisabled.gif" align=absMiddle >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext11" runat="server" Code="1334"></cc1:adexpresstext><br>
							<br>
							<IMG src="/Images/<%=_siteLanguage%>/Help/elemPerso.gif" align=absMiddle >&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="1335"></cc1:adexpresstext><br>
							<br>
							<IMG src="/Images/<%=_siteLanguage%>/Help/annDynAnnulerPersoKO.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="1459"></cc1:adexpresstext><br>
							<br>
							<IMG src="/Images/<%=_siteLanguage%>/Help/annDynAnnulerPersoOK.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext20" runat="server" Code="1460"></cc1:adexpresstext><br>
							<br>
