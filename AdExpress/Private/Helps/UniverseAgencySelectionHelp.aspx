<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UniverseAgencySelectionHelp.aspx.cs" Inherits="Private_Helps_UniverseProductSelectionHelp" %>
	...
	<body class="darkBackGround backGroundWhite" bottomMargin="25" leftMargin="0" topMargin="25" rightMargin="0">
        ...
        <div>
               <table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/UniverseAgencyBranchKeyword.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/UniverseAgencyResultKeyword.gif"></td>
				</tr>
				<tr>
                ...
                <tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="2826"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/UniverseAgencyIncludeItem.gif"></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="titre2Adexpresstext" runat="server" Code="2827"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image14" runat="server" SkinID="website" /></td>
								<td class="txtViolet11">
