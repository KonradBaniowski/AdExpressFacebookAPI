...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.SponsorshipProgramDateSelectionHelp" CodeFile="SponsorshipProgramDateSelectionHelp.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="1030"></cc1:adexpresstext><br>
					</td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="1024"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="text4AdExpressText" runat="server" Code="1031"></cc1:adexpresstext><br>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="text5AdExpressText" runat="server" Code="1032"></cc1:adexpresstext><br>
					</td>
				</tr>
				<tr>
					<td width="10"><asp:Image ID="Image16" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="text6AdExpressText" runat="server" Code="1026"></cc1:adexpresstext><br>
						<br>
					</td>
				</tr>
				<tr>
					...
					<td class="txtViolet11">
						...
						&nbsp;<asp:Image ID="Image35" runat="server" SkinID="valider" />&nbsp;
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image36" runat="server" SkinID="product" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image37" runat="server" SkinID="media" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image38" runat="server" SkinID="calendar" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image39" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image40" runat="server" SkinID="sponsorship" /></td>
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="Adexpresstext2" runat="server" Code="2143"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image41" runat="server" SkinID="program" /></td>
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="Adexpresstext3" runat="server" Code="2144"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
