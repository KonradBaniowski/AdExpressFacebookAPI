	...
	<body style="BACKGROUND-ATTACHMENT: fixed; BACKGROUND-IMAGE: url(/Images/Common/dark_back.bmp); BACKGROUND-REPEAT: repeat-x"
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" bgColor="#ffffff" border="0">
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/Images/<%=_siteLanguage%>/Help/monthExample.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="10" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text7AdExpressText" runat="server" Code="1048"></cc1:adexpresstext>&nbsp;<img src="/Images/Common/Help/picto.gif"><br>
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text9AdExpressText" runat="server" Code="1050"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/back_up.gif">&nbsp;<cc1:adexpresstext language="33" id="text10AdExpressText" runat="server" Code="1051" />
					</td>
				</tr>
				<!-- Bouton de fermeture -->
				<tr>
