<%@ Page language="c#" Inherits="AdExpress.Private.Helps.DetailVehicleSelectionHelp" CodeFile="DetailVehicleSelectionHelp.aspx.cs" %>
			...
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image1" runat="server" SkinID="initialize" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image2" runat="server" SkinID="initialize_all" /></td>
								<td class="txtViolet11">
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text10Adexpresstext" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image3" runat="server" SkinID="enregistrer_univers" />&nbsp;
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text12Adexpresstext" runat="server" Code="1008"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image4" runat="server" SkinID="charger" />&nbsp;
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="997"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image5" runat="server" SkinID="valider" />&nbsp;
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image6" runat="server" SkinID="product" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image7" runat="server" SkinID="media" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image8" runat="server" SkinID="calendar" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image9" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
