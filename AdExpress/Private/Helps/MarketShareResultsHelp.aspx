<%@ Page language="c#" Inherits="AdExpress.Private.Helps.MarketShareResultsHelp" CodeFile="MarketShareResultsHelp.aspx.cs" %>
	...
	<body class="darkBackGround backGroundWhite" bottomMargin="25" leftMargin="0" topMargin="25" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annPotentielResultOption.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image62" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Textes : Force et Potentiels-->
				<tr>
					<td width="10"><asp:Image ID="Image28" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="1476"></cc1:adexpresstext></td>
				</tr>
				<tr>
					<td width="10"><asp:Image ID="Image29" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext4" runat="server" Code="1477"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image66" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image67" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext5" runat="server" Code="2126"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext18" runat="server" Code="2127"></cc1:adexpresstext><br>
						<cc1:adexpresstext language="33" id="Adexpresstext19" runat="server" Code="1957"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image85" runat="server" SkinID="valider" />
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext20" runat="server" Code="2128"></cc1:adexpresstext><br>
						<cc1:adexpresstext language="33" id="Adexpresstext21" runat="server" Code="1957"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image86" runat="server" SkinID="valider" />
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image87" runat="server" SkinID="save" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext30" runat="server" Code="2129"></cc1:adexpresstext></td>
							</tr>
							<tr>
								<td align="center" width="40"><asp:Image ID="Image88" runat="server" SkinID="delete2" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext32" runat="server" Code="2130"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image77" runat="server" SkinID="pixel" height="25" width="100%" /></td>
				</tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image84" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image78" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<!-- Bouton fermer explication -->
				<tr>
					<td width="10"><asp:Image ID="Image41" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext13" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image89" runat="server" SkinID="ok" />&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext14" runat="server" Code="1336"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image90" runat="server" SkinID="save" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext17" runat="server" Code="2451"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image91" runat="server" SkinID="print" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image92" runat="server" SkinID="excel" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image93" runat="server" SkinID="excelExport" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="2026"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								...
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext6" runat="server" Code="1012"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image79" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image94" runat="server" SkinID="product" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image80" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image95" runat="server" SkinID="media" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image81" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image96" runat="server" SkinID="calendar" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image82" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image97" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image83" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image98" runat="server" SkinID="product" /></td>
								<td class="txtViolet11">
									<cc1:AdExpressText language="33" id="Adexpresstext8" runat="server" Code="1344"></cc1:AdExpressText>
								</td>
							</tr>
						</table>
					</td>
