...
namespace AdExpress.Private.Helps{
	/// <summary>
	/// Page d'aide de MediaInsertionsCreationsResultsHelp.aspx
	/// </summary>
	public partial class MediaInsertionsCreationsResultsHelp : System.Web.UI.Page{
		...
		/// Intialisation
		/// </summary>
		/// <param name="e">Evenement arguments</param>
