...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.DynamicResultsHelp" CodeFile="DynamicResultsHelp.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext8" runat="server" Code="2384"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Titre1AdExpressText" runat="server" Code="2385"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext1" runat="server" Code="2386"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image68" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynUnit.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image69" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Option : pdm -->
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								...
								<td class="txtViolet11">&nbsp;<cc1:adexpresstext language="33" id="text15Adexpresstext" runat="server" Code="1441"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext30" runat="server" Code="2387"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image70" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynResultOption.gif" ></td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image71" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Titre 3 : Sélection du niveau de détail colonne -->
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext2" runat="server" Code="2388"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext32" runat="server" Code="2389"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						<cc1:adexpresstext language="33" id="Adexpresstext19" runat="server" Code="1957"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image105" runat="server" SkinID="valider" />
					</td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image106" runat="server" SkinID="save" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext20" runat="server" Code="2129"></cc1:adexpresstext></td>
							</tr>
							<tr>
					            <td colSpan="2"><asp:Image ID="Image97" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				            </tr>
							<tr>
								<td align="center" width="40"><asp:Image ID="Image107" runat="server" SkinID="delete2" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image104" runat="server" SkinID="pixel" height="25" width="100%" /></td>
				</tr>
				<!-- Annuler sélection produit -->
				<tr>
					<td width="10"><asp:Image ID="Image41" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11">
						<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynSelectProductKO.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="1461"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image98" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					<td width="10"><asp:Image ID="Image42" runat="server" SkinID="pixel" width="10" /></td>
					<td class="txtViolet11">
						<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/annDynSelectProductOK.gif">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="1462"></cc1:adexpresstext>
					</td>
				</tr>
				<tr>
					<td colSpan="2"><asp:Image ID="Image99" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<!-- Titre 4 : Sélection des agences media -->
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext33" runat="server" Code="2390"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext34" runat="server" Code="2391"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple -->
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext35" runat="server" Code="2392"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext36" runat="server" Code="2393"></cc1:adexpresstext>
					&nbsp;<asp:Image ID="Image108" runat="server" SkinID="fiche" /></td>
				</tr>
				<tr>
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2"><asp:Image ID="Image79" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext37" runat="server" Code="2394"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext38" runat="server" Code="2395"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image100" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image109" runat="server" SkinID="calendar" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image101" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image110" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td class="txtViolet11"><u><cc1:adexpresstext language="33" id="Adexpresstext43" runat="server" Code="2400"></cc1:adexpresstext></u></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image111" runat="server" SkinID="save" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image112" runat="server" SkinID="print" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image113" runat="server" SkinID="excel" /></td>
				...
				<tr>
					...
					<td class="txtViolet11"><u><cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="2402"></cc1:adexpresstext></u></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image114" runat="server" SkinID="selected" /></td>
								<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext15" runat="server" Code="2403"></cc1:adexpresstext></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image115" runat="server" SkinID="bt_detail" /></td>
