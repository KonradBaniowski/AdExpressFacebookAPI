<%@ Page language="c#" Inherits="AdExpress.Private.Helps.PortofolioDetailVehicleSelectionHelp" CodeFile="PortofolioDetailVehicleSelectionHelp.aspx.cs" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="introAdExpressText" runat="server" Code="1501"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image12" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				<!-- Bouton annuler-->
				<tr>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image13" runat="server" SkinID="pixel" height="10" width="100%" /></td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image28" runat="server" SkinID="selected" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image29" runat="server" SkinID="product" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image19" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image30" runat="server" SkinID="media" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image31" runat="server" SkinID="calendar" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image32" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
