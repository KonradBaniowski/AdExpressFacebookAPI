	...
	<body class="darkBackGround backGroundWhite" bottomMargin="25" leftMargin="0" topMargin="25" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="backGroundWhite" border="0">
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordSelectMedia01.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordSelectMedia02.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordSelectMedia03.gif" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext6" runat="server" Code="1705"></cc1:adexpresstext>&nbsp;<IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordSelectMediaOptionOpenClose.gif" ></td>
				</tr>
				...
				<!-- Exemple Image -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordSelectMediaOptionCentreInteret.gif" ></td>
				</tr>
				<tr>
				...
				<!-- Exemple Image -->
				<tr>
					<td align="center" colSpan="2"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/tabBordSelectMediaOptionSupport.gif" ></td>
				</tr>
				<tr>
