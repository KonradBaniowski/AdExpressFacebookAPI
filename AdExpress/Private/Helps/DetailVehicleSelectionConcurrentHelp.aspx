...
<%@ Page language="c#" Inherits="AdExpress.Private.Helps.DetailVehicleSelectionConcurrentHelp" CodeFile="DetailVehicleSelectionConcurrentHelp.aspx.cs" %>
	...
	<body class="darkBackGround whiteBackGround" bottomMargin="25" leftMargin="0" topMargin="25" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="whiteBackGround" border="0">
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%= this.Theme %>/Images/Culture/Help/choixSupportNom.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						<cc1:adexpresstext language="33" id="Adexpresstext8" runat="server" Code="997"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image153" runat="server" SkinID="suivant" />&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="1465"></cc1:adexpresstext>&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="1466"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image45" runat="server" SkinID="suivant" />.&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext11" runat="server" Code="1467"></cc1:adexpresstext><br>
						<br>
						<cc1:adexpresstext language="33" id="text2AdExpressText" runat="server" Code="997"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image46" runat="server" SkinID="valider" />&nbsp;
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="1468"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image47" runat="server" SkinID="valider" />.
					</td>
				</tr>
				<!-- Icones annuler-->
				<tr>
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image48" runat="server" SkinID="initialize" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td>
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td width="40" align="center"><asp:Image ID="Image49" runat="server" SkinID="initialize_all" /></td>
								<td class="txtViolet11">
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text10Adexpresstext" runat="server" Code="1005"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image50" runat="server" SkinID="enregistrer_univers" />&nbsp;
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext13" runat="server" Code="2448"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext14" runat="server" Code="2449"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="Adexpresstext15" runat="server" Code="2450"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="titre2Adexpresstext" runat="server" Code="1498"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text12Adexpresstext" runat="server" Code="1008"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image51" runat="server" SkinID="charger" />&nbsp;
				...
				<tr>
					...
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext3" runat="server" Code="997"></cc1:adexpresstext>&nbsp;<asp:Image ID="Image52" runat="server" SkinID="valider" />&nbsp;
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image53" runat="server" SkinID="product" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image42" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image54" runat="server" SkinID="media" /></td>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image55" runat="server" SkinID="calendar" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image44" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image56" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
