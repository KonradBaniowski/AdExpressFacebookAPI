	...
	<body style="BACKGROUND-ATTACHMENT: fixed; BACKGROUND-IMAGE: url(/Images/Common/dark_back.bmp); BACKGROUND-REPEAT: repeat-x"
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" bgColor="#ffffff" border="0">
				...
				<!-- Exemple -->
				<tr>
					<td colSpan="2" align="center"><IMG src="/Images/<%=_siteLanguage%>/Help/choixSupportNom.gif"></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						<cc1:adexpresstext language="33" id="Adexpresstext8" runat="server" Code="997"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/suivant_up.gif">&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext9" runat="server" Code="1465"></cc1:adexpresstext>&nbsp;
						<cc1:adexpresstext language="33" id="Adexpresstext10" runat="server" Code="1466"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/suivant_up.gif">.&nbsp;
				...
				<tr>
					<td width="10"><IMG src="/Images/Common/pixel.gif" width="10"></td>
					<td class="txtViolet11">
						<cc1:adexpresstext language="33" id="Adexpresstext12" runat="server" Code="1468"></cc1:adexpresstext>&nbsp;<IMG src="/Images/<%=_siteLanguage%>/button/valider_up.gif">.
					</td>
				</tr>
				<!-- Icones annuler-->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/Images/<%=_siteLanguage%>/Help/PopUpSaveUniverse.gif"></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
				...
				<!-- Exemple Image -->
				<tr>
					<td colSpan="2" align="center"><IMG src="/Images/<%=_siteLanguage%>/Help/PopUpSaveUniverseNewName.gif">&nbsp;&nbsp;<IMG src="/Images/<%=_siteLanguage%>/Help/PopUpSaveUniverseFolderSelection.gif"></td>
				</tr>
				<tr>
					<td colSpan="2"><IMG height="15" src="/Images/Common/pixel.gif" width="100%"></td>
				</tr>
