<%@ Page language="c#" Inherits="AdExpress.Private.Helps.AEPMTargetSelectionHelp" CodeFile="AEPMTargetSelectionHelp.aspx.cs" %>
			...
			<table cellSpacing="0" cellPadding="0" width="98%" align="center" class="whiteBackGround" border="0">
				...
				<TR>
					<td class="txtViolet12Bold paleVioletBackGround" colSpan="2">&nbsp;
						<cc1:adexpresstext language="33" id="Titre1AdExpressText" runat="server" Code="1800"></cc1:adexpresstext></td>
				</TR>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11"><cc1:adexpresstext language="33" id="text1AdExpressText" runat="server" Code="1802"></cc1:adexpresstext></td>
				</tr>
				<!-- Exemple Image -->
				<tr>
				...
				<tr>
					<td colSpan="2" align="center"><IMG src="/App_Themes/<%=_themeName%>/Images/Culture/Help/APPMCibleSelection.gif"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="txtViolet11">
						...
						<cc1:adexpresstext language="33" id="text3AdExpressText" runat="server" Code="1801"></cc1:adexpresstext></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image34" runat="server" SkinID="selected" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image15" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image35" runat="server" SkinID="product" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image16" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image36" runat="server" SkinID="media" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image17" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image37" runat="server" SkinID="calendar" /></td>
				...
				<tr>
					<td colSpan="2"><asp:Image ID="Image18" runat="server" SkinID="pixel" height="12" width="100%" /></td>
				</tr>
				<tr>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<td align="center" width="40"><asp:Image ID="Image38" runat="server" SkinID="result" /></td>
								<td class="txtViolet11">
