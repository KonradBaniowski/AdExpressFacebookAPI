<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UniverseMediaSelection.aspx.cs" Inherits="Private_Selection_UniverseMediaSelection" %>
...
<html>
	<head runat="server">
		...
		<!--
			...
			function ouvre_popup_univers(sessionId) {
                window.open("/Private/Universe/RegisterUniverse.aspx?idSession="+sessionId+"&brancheType=1&idUniverseClientDescription=16","nom_popup","menubar=no, status=no, scrollbars=no, menubar=no, width=450px, height=300px");
            }
		</script>
    ...
    <body onload="initjsDOMenu();<%=saveScript%>javascript:activateActiveX();" class="bodyStyle">
        <form id="Form2" action="UniverseMediaSelection.aspx" method="post" runat="server">
				...
				<tr>	
					...
					<td style="WIDTH: 731px" valign="top" class="imageBackGround">
						<table cellspacing="0" cellpadding="0" border="0">
							...
							<tr>
								<td style="WIDTH: 772px" class="whiteBackGround"><asp:Image ID="Image13" runat="server" height="5" width="1" SkinID="pixel" /></td>
							</tr>														
							<tr>
								<td class="whiteBackGround"><!--<img height="15" src="/Images/Common/pixel.gif" width="1"> -->
									<cc4:SelectItemsInClassificationWebControl id="SelectItemsInClassificationWebControl1" runat="server" DefaultBranchId="7" NbMaxIncludeTree="2" Dimension_="media"></cc4:SelectItemsInClassificationWebControl>
									</td>
							</tr>
							<tr>
				...
				<TR height="5">
					...
					<td valign="top" class="imageBackGround">
						<table id="Table7" cellspacing="0" cellpadding="0" width="100%" border="0">
							<TR>
								<td valign="bottom"><asp:Image ID="Image14" runat="server" height="5" width="5" SkinID="croix" />&nbsp;</td>
								<td></td>
								<td valign="bottom" align="right"><asp:Image ID="Image15" runat="server" height="5" width="5" SkinID="croix" /></td>
							</TR>
						</table>
					</td>
					<td></td>
					...
					<td id="dellCel" style="WIDTH: 732px" valign="top" class="imageBackGround">
						<table id="Table8" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr>
								<td valign="bottom"><asp:Image ID="Image16" runat="server" height="5" width="5" SkinID="croix" /></td>
								<td>&nbsp;</td>
								<td valign="bottom" align="right"><asp:Image ID="Image17" runat="server" height="5" width="5" SkinID="croix" /></td>
							</TR>
						</table>
					</td>
				</TR>
