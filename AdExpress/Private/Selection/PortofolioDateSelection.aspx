											...
											<TR>
												<TD>
													<TABLE id="Table9" cellSpacing="0" cellPadding="3" width="100%" border="0">
														...
														<TR height="10">
															<TD background="/Images/Common/dupli_fond.gif" colspan="3"></TD>
														</TR>
														<TR>
															<td></td>
															<td></td>
													...
													<TABLE id="Table13" cellSpacing="0" cellPadding="3" width="100%" border="0">
														...
														<TR>
															...
															<TD style="HEIGHT: 23px">
																<p class="txtNoir11" onclick="javascript:selectedItem(1)"><cc3:datelistwebcontrol id="monthDateList" runat="server" CssClass="txtNoir11" ListTypeDisplay="month">
														...
														<TR>
															...
															<TD width="15"></TD>
															<TD>
																<p class="txtNoir11" onclick="javascript:selectedItem(2)"><cc3:datelistwebcontrol id="weekDateList" runat="server" CssClass="txtNoir11" ListTypeDisplay="week">
																		<asp:ListItem Value="0">----</asp:ListItem>
																		<asp:ListItem Value="1">1</asp:ListItem>
																		<asp:ListItem Value="2">2</asp:ListItem>
																		<asp:ListItem Value="3">3</asp:ListItem>
