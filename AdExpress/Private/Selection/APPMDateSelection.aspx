...
<HTML>
	...
	<body onload="javascript:selectedItem(7);" bottomMargin="0" leftMargin="0" topMargin="0">
				...
				<TR>
					...
					<TD id="sertARien" vAlign="top">
						<TABLE id="Table10" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									<!--debut elements-->
									<td id="debutelement" background="/Images/Common/dupli_fond.gif">
										<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
												...
												<TD bgcolor="#ffffff">
													<TABLE id="Table9" cellSpacing="0" cellPadding="3" width="100%" border="0">
														...
														<TR>
															...
															<TD width="15"></TD>
															<TD>
																<table border="0" cellpadding="0" bgcolor="#ffffff" width="100%">
																	<tr>
																		<td><p id="dateBegin" onclick="javascript:selectedItem(6)"><cc3:lastmonthweekcalendarwebcontrol language="33" id="lastMonthWeekCalendarBeginWebControl" runat="server" CalendarType="dateBegin"></cc3:lastmonthweekcalendarwebcontrol></p>
																		</td>
																		<td><p id="dateEnd" onclick="javascript:selectedItem(7)"><cc3:lastmonthweekcalendarwebcontrol language="33" id="lastMonthWeekCalendarEndWebControl" runat="server" CalendarType="dateEnd"></cc3:lastmonthweekcalendarwebcontrol></p>
																		</td>
																	</tr>
																</table>
															</TD>
											...
											<TR>
												<TD background="/Images/Common/dupli_fond.gif" vAlign="top" height="35">
													<TABLE background="/Images/Common/dupli_fond.gif" id="Table12" cellSpacing="0" cellPadding="0"
														width="100%" border="0">
														<TR>
															<TD width="150" background="/Images/Common/dupli_fond.gif"></TD>
															<TD background="/Images/Common/dupli_fond.gif"><cc4:imagebuttonrolloverwebcontrol id="validateButton2" runat="server" onclick="validateButton2_Click"></cc4:imagebuttonrolloverwebcontrol></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
