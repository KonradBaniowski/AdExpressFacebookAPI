<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RefineAdvertisementType.aspx.cs" Inherits="Private_Selection_RefineAdvertisementType" %>
...
<html>
	<head id="Head1" runat="server">
		...
		<!--
		    ...
		    function ouvre_popup_univers(sessionId, brancheType) {
		        window.open("/Private/Universe/RegisterUniverse.aspx?idSession=" + sessionId + "&brancheType=" + brancheType + "&idUniverseClientDescription=16", "nom_popup", "menubar=no, status=no, scrollbars=no, menubar=no, width=450px, height=300px");
		    }
		</script>
								    ...
								    <table border="0" cellpadding="0" cellspacing="0">
								        ...
								        <tr>
								            <td style="padding-left:188px;">
								                &nbsp;<a style="cursor:hand;" onmouseover="getElementById('saveButton').src='/App_Themes/<%= this.Theme %>/Images/Culture/button/enregistrer_univers_down.gif';" onmouseout="getElementById('saveButton').src = '/App_Themes/<%= this.Theme %>/Images/Culture/button/enregistrer_univers_up.gif';" onclick="ouvre_popup_univers('<%=sessionId%>','<%=brancheType%>');" >
