...
<%@ Page language="c#" Inherits="AdExpress.Private.Selection.AnalyseDateSelection" CodeFile="AnalyseDateSelection.aspx.cs" %>
				...
				switch(i){
					...
					case 1:
						if(Form2.monthDateList.selectedIndex!=0){
							Form2.yearDateList.options[0].selected=true;
							if(Form2.weekDateList!=null)Form2.weekDateList.options[0].selected=true;
							ok=true;
						}
						break;
														...
														<TR>
															...
															<TD>
																<table border="0" cellpadding="0" bgcolor="#ffffff" width="100%">
																	<tr>
																		<td><p id="dateBegin" onclick="javascript:selectedItem(6)"><cc3:monthweekcalendarwebcontrol language="33" id="monthWeekCalendarBeginWebControl" runat="server" CalendarType="dateBegin"></cc3:monthweekcalendarwebcontrol></p>
																		</td>
																		<td><p id="dateEnd" onclick="javascript:selectedItem(7)"><cc3:monthweekcalendarwebcontrol language="33" id="monthWeekCalendarEndWebControl" runat="server" CalendarType="dateEnd"></cc3:monthweekcalendarwebcontrol></p>
																		</td>
																	</tr>
																</table>
															</TD>
												...
												<TD>
													<TABLE id="Table13" cellSpacing="0" cellPadding="3" width="100%" border="0">
														...
														<TR>
															...
															<TD class="txtGris11Bold" colSpan="2" style="HEIGHT: 28px"><cc1:adexpresstext language="33" id="comment2AdExpressText" runat="server" Code="785"></cc1:adexpresstext></TD>
														</TR>
														<TR>
															<td></td>
															<TD width="15"></TD>
