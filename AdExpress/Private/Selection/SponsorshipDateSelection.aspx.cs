...
namespace AdExpress.Private.Selection
{
	...
	/// Cette Page est utilisée pour le parrainage TV
	/// </summary>
	public partial class SponsorshipDateSelection : TNS.AdExpress.Web.UI.SelectionWebPage{
		...
		/// Constructeur
		/// </summary>
		public SponsorshipDateSelection():base(){
		}
		#endregion
