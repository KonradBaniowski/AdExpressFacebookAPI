...
<%@ Page language="c#" Inherits="AdExpress.Private.Selection.Russia.ReferenceCompetitorPersonalisation" CodeFile="ReferenceCompetitorPersonalisation.aspx.cs" %>
					...
					<td vAlign="top">
						<table cellSpacing="0" cellPadding="0" border="0">
						  <!-- Menu haut -->
							...
							<!--Debut Recherche annonceurs-->
							<tr>
								<td style="WIDTH: 773px" class="backGroundWhite">
										        ...
										        <table cellspacing="0" cellpadding="0" width="400px" border="0">
										            <tr>
											            ...
											            <td valign="middle" align="left"><asp:textbox id="keyWordTextBox" runat="server"></asp:textbox>&nbsp;
												            <cc4:imagebuttonrolloverwebcontrol id="OkImageButtonRollOverWebControl" runat="server" SkinID="okLoupeButton" onclick="OkImageButtonRollOverWebControl_Click"></cc4:imagebuttonrolloverwebcontrol>											           
											                <cc4:imagebuttonrolloverwebcontrol id="initializeButton" runat="server" SkinID="initializeButton"></cc4:imagebuttonrolloverwebcontrol></td>
													    </tr>
											    </table>
											</td>
										</tr>
