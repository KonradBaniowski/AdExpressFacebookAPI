...
<%@ Register TagPrefix="cc6" Namespace="TNS.AdExpress.Web.Controls.Headers.Russia" Assembly="TNS.AdExpress.Web.Controls" %>
							...
							<tr>
								<td class="txtBlanc11Bold" width="185" height="9">
									...
									<table id="Table6" cellspacing="0" cellpadding="0" width="185" border="0">
										...
										<tr >
											<td><cc6:GenericMediaDetailSelectionWebControl id="_genericMediaDetailSelectionWebControl" runat="server" NbDetailLevelItemList="3"							            
							            GenericDetailLevelComponentProfile="media" GenericDetailLevelType="dynamicCompetitorPotential" BackGroundColor="" CssDefaultListLabel="txtBlanc11Bold" Width="194px" SkinID="genericMediaDetailSelectionWebControl"></cc6:genericmediadetailselectionwebcontrol>
											</td>
										</tr>
									...
									<table cellspacing="0" cellpadding="0" width="100%" border="0">
										...
										<tr>
											<td colspan="5" style="padding-left:5px;">
												<cc5:loadableuniverswebcontrol id="LoadableUniversWebControl1" runat="server"></cc5:loadableuniverswebcontrol>
											</td>
										</tr>
										<tr style="HEIGHT: 5px">
											<td colspan="6"></td>
										    ...
										    <td colspan="6">
										        <table cellspacing="0" cellpadding="0" border="0">
										            <tr>
										                ...
										                <td style="width:200px;" valign="bottom" >&nbsp;<cc4:imagebuttonrolloverwebcontrol id="OkImageButtonRollOverWebControl" runat="server" SkinID="okLoupeButton" onclick="OkImageButtonRollOverWebControl_Click"></cc4:imagebuttonrolloverwebcontrol>&nbsp;
<cc4:imagebuttonrolloverwebcontrol id="initializeButton" runat="server" SkinID="initializeButton"></cc4:imagebuttonrolloverwebcontrol>&nbsp;
<cc4:imagebuttonrolloverwebcontrol id="initializeAllButton" runat="server" SkinID="initializeAllButton"></cc4:imagebuttonrolloverwebcontrol></td>
												    </tr>
											    </table>
											</td>
										</tr>
