...
<%@ Page language="c#" Inherits="AdExpress.Private.Selection.CompetitorAdvertiserSelection" CodeFile="CompetitorAdvertiserSelection.aspx.cs" %>
				...
				<tr>	
					...
					<td vAlign="top" background="/images/Common/dupli_fond.gif">
						<table cellSpacing="0" cellPadding="0" width="10" border="0">
							...
							<tr>
								<td>
									<cc1:InformationWebControl id="InformationWebControl1" runat="server"></cc1:InformationWebControl></td>
							</tr>
						</table>
					</td>
					<!-- Séparateur -->
					...
					<td style="WIDTH: 731px" vAlign="top" background="/images/Common/dupli_fond.gif">
						<table cellSpacing="0" cellPadding="0" border="0">
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td colSpan="5">
												...
												</div>--><cc4:loadableuniverswebcontrol id="LoadableUniversWebControl1" runat="server"></cc4:loadableuniverswebcontrol></td>
										</tr>
										<tr style="HEIGHT: 5px">
											<td colSpan="6"></td>
										</tr>
										...
										<tr>
											...
											<td style="WIDTH: 630px" vAlign="middle"><cc2:imagebuttonrolloverwebcontrol id="initializeImageButtonRollOverWebControl1" runat="server" ImageUrl="/Images/Common/button/initialize_up.gif"
												...
												<cc2:imagebuttonrolloverwebcontrol id="initializeAllImageButtonRollOverWebControl" runat="server" ImageUrl="/Images/Common/button/initialize_all_up.gif"
													RollOverImageUrl="/Images/Common/button/initialize_all_down.gif" onclick="initializeAllImageButtonRollOverWebControl_Click"></cc2:imagebuttonrolloverwebcontrol></td>
											<td colSpan="3">&nbsp;</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td style="WIDTH: 630px" width="630"><asp:radiobutton id="radioButtonHoldingCompany" runat="server" GroupName="ChoiceAdvertiser"></asp:radiobutton></td>
											<td colSpan="3">&nbsp;</td>
										</tr>
										<tr>
											<td width="10%"></td>
											<td class="txtViolet11" width="25%"><cc3:adexpresstext language="33" id="AdExpressText1" runat="server" Code="802"></cc3:adexpresstext></td>
											<td style="WIDTH: 630px" width="630"><asp:radiobutton id="radiobuttonAdvertiser" runat="server" GroupName="ChoiceAdvertiser" Checked="True"></asp:radiobutton></td>
											<td colSpan="3">&nbsp;</td>
										</tr>
										<tr>
											<td width="10%"></td>
											<td class="<%=cssBrand%>" width="25%"><cc3:adexpresstext language="33" id="AdexpressBrandText" runat="server" Code="1584"></cc3:adexpresstext></td>
											<td style="WIDTH: 630px" width="630"><asp:radiobutton id="RadiobuttonBrand" runat="server" GroupName="ChoiceAdvertiser"></asp:radiobutton></td>
											<td colSpan="3">&nbsp;</td>
										</tr>
										<tr>
											<td width="10%"></td>
											<td class="txtViolet11" width="25%"><cc3:adexpresstext language="33" id="AdExpressText2" runat="server" Code="803"></cc3:adexpresstext></td>
											<td style="WIDTH: 630px" width="630"><asp:radiobutton id="radiobuttonProduct" runat="server" GroupName="ChoiceAdvertiser"></asp:radiobutton></td>
											<td colSpan="3">&nbsp;</td>
										</tr>
										<!--	<tr>
							...
							<tr>
								<td style="WIDTH: 772px">&nbsp;&nbsp; <A id="A1" onmouseover="MM_swapImage('ok','','/images/Common/button/ok_down.gif',1)"
							...
							<tr>
								<td style="WIDTH: 772px">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td>&nbsp;</td>
											<td align="right"><cc2:imagebuttonrolloverwebcontrol id="saveUniverseImageButtonRollOverWebControl" runat="server" onclick="saveUniverseImageButtonRollOverWebControl_Click"></cc2:imagebuttonrolloverwebcontrol>&nbsp;<cc2:imagebuttonrolloverwebcontrol id="NextImageButtonRollOverWebControl" runat="server" onclick="NextImageButtonRollOverWebControl_Click"></cc2:imagebuttonrolloverwebcontrol>
												&nbsp;<cc2:imagebuttonrolloverwebcontrol id="validateButton" runat="server" onclick="validateButton_Click"></cc2:imagebuttonrolloverwebcontrol>
											</td>
										</tr>
									</table>
								</td>
					...
					<TD id="dellCel" style="WIDTH: 732px" vAlign="top" background="/Images/Common/dupli_fond.gif">
						<TABLE id="Table8" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD vAlign="bottom"><IMG height="5" src="/Images/Common/croix.gif" width="5"></TD>
								<TD>
									<cc1:MenuWebControl id="MenuWebControl2" runat="server"></cc1:MenuWebControl></TD>
								<TD vAlign="bottom" align="right"><IMG height="5" src="/Images/Common/croix.gif" width="5"></TD>
							</TR>
						</TABLE>
					</TD>
