<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UniverseAgencySelection.aspx.cs" Inherits="Private_Selection_UniverseAgencySelection" %>
	...
	<head runat="server">
		...
		<!--
			...
			function ouvre_popup_univers(sessionId) {
                window.open("/Private/Universe/RegisterUniverse.aspx?idSession="+sessionId+"&brancheType=29&idUniverseClientDescription=16","nom_popup","menubar=no, status=no, scrollbars=no, menubar=no, width=450px, height=280px");
            }
		</script>
							...
							<tr>
								<td>
								    <table border="0" cellpadding="0" cellspacing="0">
								        <tr>
								            <td><cc4:SelectItemsInClassificationWebControl id="SelectItemsInClassificationWebControl1" runat="server" DefaultBranchId="3" NbMaxIncludeTree="2"></cc4:SelectItemsInClassificationWebControl></td>
								        </tr>
								        <tr>
