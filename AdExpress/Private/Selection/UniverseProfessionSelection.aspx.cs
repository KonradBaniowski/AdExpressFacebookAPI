...
/// <summary>
/// Class used to select profession universe
/// </summary>
public partial class Private_Selection_UniverseProfessionSelection : TNS.AdExpress.Web.UI.SelectionWebPage {
    ...
    /// Constructeur
    /// </summary>
    public Private_Selection_UniverseProfessionSelection() : base() { }
    #endregion
    ...
    protected void validateButton_Click(object sender, EventArgs e) {
        try {
            ...
            TNS.AdExpress.Classification.AdExpressUniverse universe = SelectItemsInClassificationWebControl1.GetSelection(_webSession, this.Page, TNS.Classification.Universe.Dimension.profession, TNS.Classification.Universe.Security.full);
    ...
    private void ComponentsInitOptions() {
        ...
        SelectItemsInClassificationWebControl1.Dimension_ = TNS.Classification.Universe.Dimension.profession;
