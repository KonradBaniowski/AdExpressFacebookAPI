...
<HTML>
	...
	<body onload="<%=saveScript%>">
		<form id="Form2" action="ProgramTypeSelection.aspx" method="post" runat="server">
				...
				<tr>
					...
					<td vAlign="top" background="/images/Common/dupli_fond.gif">
						<table cellSpacing="0" cellPadding="0" width="10" border="0">
							...
							<tr vAlign="top">
								<td id="pageTitle"><cc1:moduletitlewebcontrol id="ModuleTitleWebControl1" runat="server" CodeDescription="2058"></cc1:moduletitlewebcontrol></td>
							</tr>
							<!-- Info bt droit -->
							<tr>
								<td><IMG height="5" src="/images/Common/pixel.gif" width="1"></td>
					...
					<td style="WIDTH: 731px" vAlign="top" background="/images/Common/dupli_fond.gif">
						<table cellSpacing="0" cellPadding="0" border="0">
							<tr>
								<!-- Menu du haut-->
								<td style="WIDTH: 100%"><cc1:headerwebcontrol language="33" id="HeaderWebControl1" runat="server" Type_de_page="generic"></cc1:headerwebcontrol></td>
							</tr>
							<tr>
								<!-- ligne du haut a droite -->
								<TD id="lineAVIrer" style="WIDTH: 100%" vAlign="top" background="/Images/Common/dupli_fond.gif"
									height="1%">
								...
								<td style="WIDTH: 100%" bgColor="#ffffff">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr style="HEIGHT: 10px">
											<td style="WIDTH: 478px" background="/images/Common/dupli_fond.gif" colSpan="6"></td>
										</tr>
										<tr style="HEIGHT: 5px">
											<td colSpan="6"></td>
										</tr>
							...
							<tr>
								<td style="WIDTH: 772px"><IMG height="15" src="images/pixel.gif" width="1"> <input id="idHoldingCompanyAccess" type="hidden" name="nameHoldingAccess_">
									...
									<cc4:ProgramTypeWebControl id="AdvertiserSelectionWebControl1" runat="server"></cc4:ProgramTypeWebControl></td>
							</tr>
							<tr>
								<td style="WIDTH: 100%">
									<table cellSpacing="0" cellPadding="0" border="0" style="WIDTH: 100%">
										<tr>
											<td align="right" width="100%">&nbsp;
												<cc2:imagebuttonrolloverwebcontrol id="saveUniverseImageButtonRollOverWebControl" runat="server" onclick="saveUniverseImageButtonRollOverWebControl_Click"></cc2:imagebuttonrolloverwebcontrol>&nbsp;<cc2:imagebuttonrolloverwebcontrol id="formSponsoringshipImageButtonRollOverWebControl" runat="server" onclick="formSponsoringshipImageButtonRollOverWebControl_Click"></cc2:imagebuttonrolloverwebcontrol>&nbsp;<cc2:imagebuttonrolloverwebcontrol id="validateButton" runat="server" onclick="validateButton_Click"></cc2:imagebuttonrolloverwebcontrol>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
											<td width="1%"></td>
										</tr>
									</table>
								</td>
					...
					<TD vAlign="top" background="/Images/Common/dupli_fond.gif">
						<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								...
								<TD></TD>
								<TD width="100%" vAlign="bottom" align="right"><IMG height="5" src="/Images/Common/croix.gif" width="5"></TD>
							</TR>
						</TABLE>
					</TD>
					<TD></TD>
