					...
					<td style="WIDTH: 731px" valign="top" class="imageBackGround">
						<table cellspacing="0" cellpadding="0" border="0">
							...
							<tr>
								...
								<td id="lineAVIrer" style="WIDTH: 100%" valign="top" class="imageBackGround"
									height="1%">
							...
							<!-- Centre -->
							<tr>
								<td style="WIDTH: 100%" class="whiteBackGround">
									<table cellspacing="0" cellpadding="0" width="100%" border="0">
										...
										<tr>
											...
											<td style="WIDTH: 630px" valign="middle"><cc2:imagebuttonrolloverwebcontrol id="initializeImageButtonRollOverWebControl1" runat="server" SkinID="initializeButton" onclick="initializeImageButtonRollOverWebControl1_Click"></cc2:imagebuttonrolloverwebcontrol>
											</td>
											<td colspan="3">&nbsp;</td>
										</tr>
								</table>
					...
					<td valign="top" class="imageBackGround">
						<table id="Table7" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr>
								...
								<td></td>
								<td width="100%" valign="bottom" align="right"><asp:Image runat="server" height="5" SkinID="croix" width="5"/></td>
							</tr>
						</table>
					</td>
					<td></td>
