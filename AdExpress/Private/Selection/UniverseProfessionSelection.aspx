	...
	<head runat="server">
		...
		<!--
			...
			function ouvre_popup_univers(sessionId) {
                window.open("/Private/Universe/RegisterUniverse.aspx?idSession="+sessionId+"&brancheType=32&idUniverseClientDescription=16","nom_popup","menubar=no, status=no, scrollbars=no, menubar=no, width=450px, height=300px");
            }
		</script>
