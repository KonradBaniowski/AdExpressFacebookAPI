							...
							<TR vAlign="top">
								<TD align="center">
									<TABLE id="data" height="100%" cellSpacing="0" cellPadding="3" width="100%" border="0">
										...
										<tr valign="top" height="1%" bgcolor="#ffffff">
											<td>&nbsp;</td>
										</tr>
										<tr height="100%" valign="top">
											<td background="/Images/Common/dupli_fond.gif" align="right">
												<cc4:imagebuttonrolloverwebcontrol id="validateButton" runat="server" onclick="validateButton_Click"></cc4:imagebuttonrolloverwebcontrol>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
										</tr>
									</TABLE>
								</TD>
