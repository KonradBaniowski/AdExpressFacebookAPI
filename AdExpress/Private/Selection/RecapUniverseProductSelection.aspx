<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecapUniverseProductSelection.aspx.cs" Inherits="Private_Selection_RecapUniverseProductSelection" %>
								...
								<td style="WIDTH: 773px" class="whiteBackGround">
									<table cellspacing="0" cellpadding="0" width="100%" border="0">
										...
										<tr style="HEIGHT: 10px">
											<td style="WIDTH: 478px; height: 10px;" width="478" class="imageBackGround" colspan="6"></td>
										</tr>
										<tr style="HEIGHT: 5px">
											<td colspan="6"></td>
										</tr>																				
