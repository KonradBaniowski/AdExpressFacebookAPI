<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PortofolioGlobalDateSelection.aspx.cs" Inherits="Private_Selection_PortofolioGlobalDateSelection" %>
										...
										<tr>
											<td>
												<table id="Table13" cellspacing="0" cellpadding="3" width="100%" border="0">
												    <tr>
												        <td>
												            <table id="Table14" cellspacing="0" cellpadding="5" border="0">
													            <tr style="height:30px;">
															        <td width="15">&nbsp;</td>
														            <td class="txtGris11Bold" colspan="5" style="HEIGHT: 18px"><cc1:adexpresstext language="33" id="comment2AdExpressText" runat="server" Code="785"></cc1:adexpresstext></td>
														            <%if (!isDynamicModule) { %>
														            <td colspan="2">&nbsp;</td>
														            <%} %>
													            </tr>
													...
													<tr>
													    <td>
													        <table id="Table15" cellspacing="0" cellpadding="5" border="0">
													            <tr style="height:30px;">
															        <td width="15">&nbsp;</td>
