...
public partial class Private_Selection_RecapUniverseProductSelection : TNS.AdExpress.Web.UI.SelectionWebPage {
	...
	#region Constructor
		...
		/// Constructeur
		/// </summary>
	public Private_Selection_RecapUniverseProductSelection()
		: base() {
		}
		#endregion
	...
	protected override System.Collections.Specialized.NameValueCollection DeterminePostBackMode() {
		...
		//Empty references and competitor advertisers universe
	...
	private void ComponentsInitOptions() {
		...
		SelectItemsInClassificationWebControl1.DefaultBranchId = GetDefaultBranchId();//Branche famille par défaut
