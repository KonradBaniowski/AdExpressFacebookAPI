				...
				<tr>
					...
					<td vAlign="top" class="whiteBackGround">
						<table cellSpacing="0" cellPadding="0" border="0" width="10">
							...
							<tr>
								<td class="txtBlanc11Bold" width="185" height="9">
									<table id="Table6" cellspacing="0" cellpadding="0" width="10" border="0">
										<tr>
											<td><asp:Image ID="Image56" runat="server" height="5" SkinID="plus_sous_logo" /></td>
										</tr>
										<tr>
											<td><asp:Image ID="Image57" runat="server" height="10" width="1" SkinID="pixel" /></td>
										</tr>
									</table>
								</td>
							</tr>
							...
							<tr>
								<td>
								    <table cellSpacing="0" cellPadding="0" border="0" width="185">
										<tr>
											<td vAlign="top"><asp:Image ID="Image7" runat="server" SkinID="block_fleche" height="12" width="12" /></td>
											<td class="blockdupliBackGround"><asp:Image ID="Image8" runat="server" SkinID="pixel" height="1" width="13" /></td>
							...
							<tr>
								<td height="5"><asp:Image ID="Image14" runat="server" SkinID="ouvrir_gris" /></td>
							</tr>
							<tr>
								<td height="5"></td>
							</tr>
							...
							<tr>
								<td><asp:Image ID="Image15" runat="server" SkinID="pixel" height="5" width="1" /></td>
							</tr>
							...
							<tr>
								<td>
									<table cellSpacing="0" cellPadding="0" border="0" width="185">
										<tr>
											<td vAlign="top"><asp:Image ID="Image20" runat="server" SkinID="block_fleche" height="12" width="12" /></td>
											<td class="blockdupliBackGround"><asp:Image ID="Image21" runat="server" SkinID="pixel" height="1" width="13" /></td>
											<td class="txtNoir11Bold backGroundModuleTitle" width="100%">
							...
							<tr>
								<td>
									<table cellSpacing="0" cellPadding="0" border="0" width="185">
										<tr>
											<td vAlign="top"><asp:Image ID="Image32" runat="server" SkinID="block_fleche" height="12" width="12" /></td>
						    ...
						    <tr>
							    <td><asp:Image ID="Image39" runat="server" SkinID="pixel" height="5" width="1" /></td>
						    </tr>								
						    <tr runat="server" id="blockAlerts">
							    <td>
								    <table cellSpacing="0" cellPadding="0" border="0" width="185">
									    <tr>
										    <td vAlign="top"><asp:Image ID="Image44" runat="server" SkinID="block_fleche" height="12" width="12" /></td>
										    <td class="blockdupliBackGround"><asp:Image ID="Image45" runat="server" SkinID="pixel" height="1" width="13" /></td>
										    <td class="txtNoir11Bold backGroundModuleTitle" width="100%">
										    ...
										    <td><asp:Image ID="Image46" runat="server" SkinID="pixel" height="1" width="1" /></td>
									    </tr>
								    </table>
							    </td>
						    </tr>
						    ...
						    <tr>
							    <td class="txtGris10" height="5"><cc3:imagebuttonrolloverwebcontrol id="Imagebuttonrolloverwebcontrol1" runat="server" onclick="alertOpenImageButtonRollOver_Click" SkinID="ouvrirButton"></cc3:imagebuttonrolloverwebcontrol></td>
						    </tr>	
						    <tr>
							    <td height="5"></td>
						    </tr>
					...
					<!-- New separator -->
					<td vAlign="top" class="whiteBackGround"><asp:Image ID="Image51" runat="server" height="100" width="5" SkinID="logo_cote_droit" /></td>
					<td class="lineVerticalBackGround2px"><asp:Image ID="Image52" runat="server" height="1" width="2" SkinID="pixel" /></td>
					<td class="lineVerticalBackGround1px"><asp:Image ID="Image53" runat="server" height="1" width="2" SkinID="pixel" /></td>
					<td class="lineVerticalBackGround"><asp:Image ID="Image54" runat="server" height="1" width="2" SkinID="pixel" /></td>
								...
								<td style="padding-left:5px;">
									<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="727" border="0">
										<TR class="violetBackGround" height="14">
											<TD width="14"><asp:Image ID="Image55" runat="server" SkinID="fleche_1" /></TD>
