...
{
	/// <summary>
	/// Description résumée de APPMTextFileSavePopUp.
	/// </summary>
	public partial class APPMTextFileSavePopUp : TNS.AdExpress.Web.UI.PrivateWebPage{
		...
		/// </summary>
		public APPMTextFileSavePopUp():base()
	{			
	}
		#endregion
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			}else cbxRegisterMail.Visible = false; 
		...
		protected void validateRollOverWebControl_Click(object sender, System.EventArgs e) 
		{
			...
			if(fileName==null || mail==null || fileName.Length==0 || mail.Length==0) {
				...
				Int64 idStaticNavSession=TNS.AdExpress.Anubis.BusinessFacade.Result.ParameterSystem.Save(_webSession,TNS.AdExpress.Anubis.Constantes.Result.type.appmInsertionDetail);
