						...
						<table cellSpacing="0" cellPadding="0" border="0" width="10">
							...
							<tr>
								<td class="whiteBackGround">
									<table cellSpacing="0" cellPadding="0" border="0" width="185">
										<tr>
											<td vAlign="top"><asp:Image ID="Image6" runat="server" SkinID="block_fleche" height="12" width="12" /></td>
						    ...
						    <tr runat="server" id="blockAlerts">
							    <td>
								    <table cellSpacing="0" cellPadding="0" border="0" width="185">
									    <tr>
										    <td vAlign="top"><asp:Image ID="Image19" runat="server" SkinID="block_fleche" height="12" width="12" /></td>
