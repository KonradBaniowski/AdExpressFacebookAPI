					...
					<tr>
						...
						<td vAlign="top" class="imageBackGround">
							<table id="tableMenu" cellSpacing="0" cellPadding="0" width="10" border="0">
								...
								<tr>
									<td><asp:Image ID="Image4" runat="server" SkinID="plus_sous_logo" height="5" width="185" /></td>
								</tr>
								<tr>
									<td style="HEIGHT: 10px"><asp:Image ID="Image5" runat="server" SkinID="pixel" height="10" width="1" /></td>
								</tr>
								<tr>
									<td class="whiteBackGround"><asp:Image ID="Image6" runat="server" SkinID="pixel" height="5" width="1" /></td>
								</tr>
								<!--Mon Adexpress-->
								<tr>
									<td class="whiteBackGround">
										<table cellSpacing="0" cellPadding="0" border="0">
											<tr class="violetBackGround">
												...
												<td><asp:Image ID="Image10" runat="server" SkinID="pixel" height="1" width="159" /></td>
											...
											<tr>
												...
												<td class="blockdupliBackGround"><asp:Image ID="Image16" runat="server" SkinID="pixel" height="1" width="13" /></td>
								...
								<tr>
									<td class="whiteBackGround"><asp:Image ID="Image18" runat="server" SkinID="pixel" height="5" width="1" /></td>
								</tr>
								<!--Mes Univers-->
								<tr>
									<td class="whiteBackGround">
										<table cellSpacing="0" cellPadding="0" border="0">
											<tr class="violetBackGround">
												...
												<td><asp:Image ID="Image21" runat="server" SkinID="pixel" height="1" width="159" /></td>
												<td><asp:Image ID="Image22" runat="server" SkinID="pixel" height="1" width="1" /></td>
											</tr>
											<tr>
												<td vAlign="top"><asp:Image ID="Image24" runat="server" SkinID="block_fleche" height="12" width="12" /></td>
												<td class="blockdupliBackGround"><asp:Image ID="Image23" runat="server" SkinID="pixel" height="1" width="13" /></td>
												<td class="txtNoir11Bold">
								...
								<tr>
									<td class="whiteBackGround"><asp:Image ID="Image30" runat="server" SkinID="pixel" height="5" width="1" /></td>
								</tr>
								<!--Mes PDF-->
								<tr>
									<td class="whiteBackGround">
										<table cellSpacing="0" cellPadding="0" border="0">
											<tr class="violetBackGround">
												<td><asp:Image ID="Image31" runat="server" SkinID="pixel" height="1" width="1" /></td>
												<td><asp:Image ID="Image32" runat="server" SkinID="pixel" height="1" width="1" /></td>
											...
											<tr>
												<td vAlign="top"><asp:Image ID="Image40" runat="server" SkinID="block_fleche" height="12" width="12" /></td>
												<td class="blockdupliBackGround"><asp:Image ID="Image35" runat="server" SkinID="pixel" height="1" width="13" /></td>
												<td class="txtNoir11Bold">
												...
												<td class="violetBackGround"><asp:Image ID="Image36" runat="server" SkinID="pixel" height="1" width="1" /></td>
											</tr>
											<tr>
												<td><asp:Image ID="Image41" runat="server" SkinID="pixel" height="1" width="1" /></td>
												<td class="violetBackGround"><asp:Image ID="Image37" runat="server" SkinID="pixel" height="1" width="1" /></td>
												<td class="violetBackGround"><asp:Image ID="Image38" runat="server" SkinID="pixel" height="1" width="1" /></td>
								...
								<tr>
									<td class="txtGris10 whiteBackGround" height="5"><asp:Image ID="Image153" runat="server" SkinID="ouvrir_gris" /></td>
								</tr>
								...
								<% if (IsAlertsActivated) { %>
									    ...
									    <td class="whiteBackGround">
										    <table cellSpacing="0" cellPadding="0" border="0">
											    <tr class="violetBackGround">
												    ...
												    <td><asp:Image ID="Image62" runat="server" SkinID="pixel" height="1" width="159" /></td>
												    <td><asp:Image ID="Image63" runat="server" SkinID="pixel" height="1" width="1" /></td>
											    </tr>
											    <tr>
												    <td vAlign="top"><asp:Image ID="Image71" runat="server" SkinID="block_fleche" height="12" width="12" /></td>
												    <td class="blockdupliBackGround"><asp:Image ID="Image65" runat="server" SkinID="pixel" height="1" width="13" /></td>
												    <td class="txtNoir11Bold">
												    ...
												    <td class="violetBackGround"><asp:Image ID="Image70" runat="server" SkinID="pixel" height="1" width="1" /></td>
											    </tr>
											    <tr>
												    <td><asp:Image ID="Image66" runat="server" SkinID="pixel" height="1" width="1" /></td>
								    ...
								    <tr>
									    <td class="txtGris11Bold whiteBackGround"><cc1:adexpresstext language="33" id="Adexpresstext25" runat="server" Code="2586"></cc1:adexpresstext></td>
								    </tr>
								    <tr>
									    <td height="5"></td>
								    </tr>
						...
						<td vAlign="top">
							<table id="Table5" cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td><asp:Image ID="Image42" runat="server" SkinID="logo_cote_droit" height="100" width="5" /></td>
								</tr>
								<tr>
									<td class="whiteBackGround"><asp:Image ID="Image43" runat="server" SkinID="pixel" height="1" width="1" /></td>
								</tr>
							</table>
						</td>
						<td class="violetBackGround"><asp:Image ID="Image44" runat="server" SkinID="pixel" height="1" width="1" /></td>
								...
								<tr>
									...
									<td>
										<table id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td vAlign="top" align="left"><asp:Image ID="Image49" runat="server" SkinID="croix" height="5" width="5" /></td>
												<td><asp:Image ID="Image47" runat="server" SkinID="pixel" height="17" width="1" /></td>
									...
									<td>
										<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="727" border="0">
											<TR class="violetBackGround" height="14">
												<TD width="14"><asp:Image ID="Image48" runat="server" SkinID="fleche_1" /></TD>
					...
					<TR height="5">
						...
						<TD id="dellCel" vAlign="top" class="imageBackGround">
							<TABLE id="Table8" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD vAlign="top"><asp:Image ID="Image45" runat="server" SkinID="croix" height="5" width="5" /></TD>
									<TD></TD>
									<TD vAlign="top" align="right"><asp:Image ID="Image46" runat="server" SkinID="croix" height="5" width="5" /></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
