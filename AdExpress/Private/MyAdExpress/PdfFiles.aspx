							...
							<table id="tableMenu" cellSpacing="0" cellPadding="0" width="10" border="0">
								...
								<tr>
									<td bgColor="#ffffff" height="5">
										<cc3:imagebuttonrolloverwebcontrol id="ImageButtonRollOverWebControl1" runat="server" onclick="ImageButtonRollOverWebControl1_Click"></cc3:imagebuttonrolloverwebcontrol></td>
								</tr>
								<tr>
									<td bgColor="#ffffff" height="5"></td>
								</tr>
								...
								<tr>
									<td class="txtGris10" bgColor="#ffffff" height="5"><IMG src="/Images/<%=_siteLanguage%>/button/ouvrir_gris.gif"></td>
								</tr>
								<!-- test!!!!--></table>
