	...
	<body class="popUpbody" onload="javascript:activateActiveX();">
		<form id="Form1" method="post" runat="server">
		        ...
		        <div class="popUpHead popUpHeaderBackground popUpTextHeader">
			        &nbsp;<cc1:adexpresstext language="33" id="saveTitle" runat="server" Code="1912"></cc1:adexpresstext>
		        </div>
		        <!-- Content -->
		        ...
		        <div class="popUpFoot popUpFooterBackground">
                    <div style="padding-top:12px">
			            <cc2:imagebuttonrolloverwebcontrol id="validateRollOverWebControl" SkinID="validateButton" runat="server" onclick="validateRollOverWebControl_Click"></cc2:imagebuttonrolloverwebcontrol>&nbsp;<cc2:imagebuttonrolloverwebcontrol id="closeRollOverWebControl" SkinID="fermerButton" runat="server" onclick="closeRollOverWebControl_Click"></cc2:imagebuttonrolloverwebcontrol>&nbsp;&nbsp;
		            </div>
				</div>
		</form>
	</body>
