				...
				<tr>
					...
					<td vAlign="top" class="whiteBackGround">
						<table cellSpacing="0" cellPadding="0" border="0" width="10">
							...
							<tr>
								<td height="5"><cc3:imagebuttonrolloverwebcontrol id="ImageButtonRollOverWebControl1" runat="server" onclick="ImageButtonRollOverWebControl1_Click" SkinID="ouvrirButton" ></cc3:imagebuttonrolloverwebcontrol></td>
							</tr>
							<tr>
								<td height="5"></td>
							</tr>
							<tr>
								<td height="5"><asp:Image ID="Image8" runat="server" SkinID="personnaliser" /></td>
							</tr>
							<tr>
								<td height="10"></td>
							</tr>
							...
							<tr>
								<td class="txtGris11Bold"><cc1:adexpresstext language="33" id="Adexpresstext16" runat="server" Code="1753"></cc1:adexpresstext></td>
							</tr>
							<tr>
								<td height="5"></td>
							</tr>
						    ...
						    <tr>
							    <td class="whiteBackGround"><asp:Image ID="Image17" runat="server" SkinID="pixel" height="5" width="1" /></td>
						    </tr>								
						    ...
						    <tr>
							    <td class="txtGris11Bold"><cc1:adexpresstext language="33" id="Adexpresstext21" runat="server" Code="2586"></cc1:adexpresstext></td>
						    </tr>
						    <tr>
							    <td height="5"></td>
						    </tr>
								...
								<td style="padding-left:5px;">
									<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="727" border="0">
										...
										<TR>
											...
											<TD><asp:textbox id="createRepertoryTextBox" runat="server" CssClass="txtViolet11" Width="300px"></asp:textbox></TD>
										</TR>
										<TR>
											<TD></TD>
										...
										<TR>
											...
											<TD style="HEIGHT: 17px"><asp:dropdownlist id="directoryDropDownList" runat="server" CssClass="txtViolet11" Width="300px"></asp:dropdownlist></TD>
										</TR>
										<TR>
											<TD></TD>
											<TD colSpan="2" height="10"></TD>
										...
										<TR>
											...
											<TD style="HEIGHT: 15px" ><asp:dropdownlist id="renameDirectoryDropDownList" runat="server" CssClass="txtViolet11" Width="300px"></asp:dropdownlist></TD>
										</TR>
										<TR>
											<TD></TD>
											<TD colSpan="2" height="10"></TD>
										...
										<TR>
											<TD></TD>
											<TD class="txtViolet11">&nbsp;<cc1:adexpresstext language="33" id="AdExpressText11" runat="server" Code="703"></cc1:adexpresstext></TD>
											<TD ><asp:textbox id="renameDirectoryTextBox" runat="server" CssClass="txtViolet11" Width="300px"></asp:textbox></TD>
										</TR>
										<TR>
											<TD></TD>
											<TD colSpan="2" height="10"></TD>
										...
										<TR>
											<TD></TD>
											<TD class="txtViolet11" colSpan="2">&nbsp;<cc1:adexpresstext language="33" id="AdExpressText13" runat="server" Code="910"></cc1:adexpresstext></TD>
										</TR>
										<TR>
											<TD></TD>
											<TD colSpan="2" height="5"></TD>
										...
										<TR>
											...
											<TD class="txtViolet11" style="HEIGHT: 13px">&nbsp;<cc1:adexpresstext language="33" id="AdExpressText14" runat="server" Code="911"></cc1:adexpresstext></TD>
											<TD style="HEIGHT: 13px" ><asp:dropdownlist id="moveDirectoryDropDownList" runat="server" CssClass="txtViolet11" Width="300px"></asp:dropdownlist></TD>
										</TR>
										<TR>
											<TD></TD>
											<TD colSpan="2" height="10"></TD>
                                        ...
                                        <TR>
                                            <TD></TD>
                                            <TD class="txtViolet11" colSpan="2">&nbsp;<cc1:adexpresstext language="33" id="Adexpresstext18" runat="server" Code="2258"></cc1:adexpresstext></TD>
                                        </TR>
                                        <TR>
                                            <TD></TD>
                                            <TD colSpan="2" height="5"></TD>
