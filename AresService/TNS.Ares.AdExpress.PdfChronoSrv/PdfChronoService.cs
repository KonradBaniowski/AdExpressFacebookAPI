...
namespace TNS.Ares.AdExpress.PdfChronoSrv {
    public partial class PdfChronoService : ServiceBase {
       ...
       #region Constante
        ...
        /// Current Shell.
        /// </summary>
        private AppmShell _currentShell;
        #endregion
        ...
        public void Run()
        {
            try {
                ...
                _currentShell = new AppmShell(lsClientConfiguration.ProductName, lsClientConfiguration.FamilyId, lsClientConfiguration.ModuleDescriptionList, lsClientConfiguration.DirectoryName);
