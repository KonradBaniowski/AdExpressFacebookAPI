...
namespace TNS.AdExpress.Ares.PdfSectorielle
{
    public class HotepShell : Shell
    {
        ...
        public HotepShell(string productName, int familyId, IDataSource source, string confFile)
        ...
        public override List<ModuleDescription> KnownModules()
        {
            ...
            {
                new ModuleDescription("Hotep request treatment", 6)
            };
        }
