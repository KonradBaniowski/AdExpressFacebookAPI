...
using TNS.AdExpress.Anubis.Appm;
using TNS.Ares;
using TNS.FrameWork.DB.Common;
using TNS.FrameWorks.LSConnectivity;
using TNS.AdExpress.Domain.Web;
using TNS.Ares.AdExpress.PdfChrono.Exceptions;
...
namespace TNS.Ares.AdExpress.PdfChrono
{
    public class AppmShell : Shell
    {
        #region Variables
        /// <summary>
        /// DataSource
        ...
        public AppmShell(string productName, int familyId, List<ModuleDescription> moduleDescriptionList, string directoryName) :
