...
using TNS.AdExpress.Ares.PdfSectorielle.Exceptions;
...
{
    public class MiysisShell : Shell
    {
        #region Variables
        /// <summary>
        /// DataSource
        ...
        public MiysisShell(string productName, int familyId, List<ModuleDescription> moduleDescriptionList, string directoryName) :
