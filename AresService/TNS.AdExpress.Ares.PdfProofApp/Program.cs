...
namespace TNS.AdExpress.Ares.PdfProofApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ShouShell shou = new ShouShell(lsClientConfiguration.ProductName, lsClientConfiguration.FamilyId, confFilePath, source);
            shou.StartMonitorServer(lsClientConfiguration.MonitorPort);
            Console.WriteLine("Shou Service");
            Console.ReadLine();
            shou.Dispose();
        }
    }
