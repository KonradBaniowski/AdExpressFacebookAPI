...
namespace TNS.Ares.AdExpress.PdfCadrage
{
    public class AtonShell : Shell
    {
        ...
        public AtonShell(string productName, int familyId, IDataSource source, string confFile)
        ...
        public override List<ModuleDescription> KnownModules()
        {
            ...
            {
                new ModuleDescription("Aton request treatment", 11)
            };
        }
