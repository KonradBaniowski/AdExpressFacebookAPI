...
namespace TNS.Ares.AdExpress.CsvChronoApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SobekShell sobek = new SobekShell(lsClientConfiguration.ProductName, lsClientConfiguration.FamilyId, confFilePath, source);
            sobek.StartMonitorServer(lsClientConfiguration.MonitorPort);
            Console.WriteLine("Sobek request treatment");
            Console.ReadLine();
            sobek.Dispose();
        }
    }
