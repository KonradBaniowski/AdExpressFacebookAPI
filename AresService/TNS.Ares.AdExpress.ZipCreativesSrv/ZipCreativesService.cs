...
{
    public partial class ZipCreativesService : ServiceBase
    {
       #region Constante
        /// <summary>
        ...
        /// Current Shell.
        /// </summary>
        private DedoumShell _currentShell;
        #endregion
        ...
        public void Run()
        {
            try {
                ...
                _currentShell = new DedoumShell(lsClientConfiguration, lsClientConfiguration.DirectoryName);
