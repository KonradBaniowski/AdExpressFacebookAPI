...
{
    public partial class RequesterEasyMusicSrvHandler : ServiceBase
    {
        ...
        /// Ls Client Name
        /// </summary>
        private LsClientName _lsClientName = LsClientName.EasyMusic;
        #endregion
        ...
        /// Constructor
        /// </summary>
        public RequesterEasyMusicSrvHandler() {
            InitializeComponent();
        }
        /// <summary>
        /// Constructor
        /// </summary>
        public RequesterEasyMusicSrvHandler(RequesterSrvMain requesterSrvMain)
            : this() {
