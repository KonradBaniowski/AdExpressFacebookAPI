...
using System.Linq;
using System.Text;
using TNS.AdExpress.Anubis.Dedoum;
using TNS.Ares.AdExpress.Exceptions;
using TNS.Ares.Domain.LS;
using TNS.LinkSystem.LinkKernel;

namespace TNS.Ares.AdExpress.ZipCreatives
{
    public class DedoumShell
   : AdExpressShell
    {
        ...
        public DedoumShell(LsClientConfiguration lsClientConfiguration, string directoryName) :
