 ...
 public   class DataAccessDALBadPictureNameException : BaseException
    {
       ...
       #region Variables
        ...
        /// </summary>
        public DataAccessDALBadPictureNameException(CellExcel cellExcel)
            : base() {
     ...
     public DataAccessDALBadPictureNameException(CellExcel cellExcel, string message)
            : base(message) {
                _cellExcel = cellExcel;
        }
     ...
     public DataAccessDALBadPictureNameException(CellExcel cellExcel, string message, System.Exception innerException)
