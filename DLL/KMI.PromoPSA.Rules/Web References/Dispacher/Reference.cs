...
namespace KMI.PromoPSA.Rules.Dispacher {
    ...
    public partial class Dispacher : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public AdvertStatus[] GetAdvertStatus(long userId, int nbAdvert) {
        ...
        /// <remarks/>
        public void GetAdvertStatusAsync(long userId, int nbAdvert) {
            this.GetAdvertStatusAsync(userId, nbAdvert, null);
        }
        
        /// <remarks/>
        public void GetAdvertStatusAsync(long userId, int nbAdvert, object userState) {
        ...
        public void ReleaseAdvertStatus(long userId) {
            this.Invoke("ReleaseAdvertStatus", new object[] {
                        userId});
        }
        
        /// <remarks/>
        public void ReleaseAdvertStatusAsync(long userId) {
            this.ReleaseAdvertStatusAsync(userId, null);
        }
        
        /// <remarks/>
        public void ReleaseAdvertStatusAsync(long userId, object userState) {
            ...
            this.InvokeAsync("ReleaseAdvertStatus", new object[] {
                        userId}, this.ReleaseAdvertStatusOperationCompleted, userState);
        }
        ...
        public void LockAdvertStatus(long userId, long idForm) {
        ...
        /// <remarks/>
        public void LockAdvertStatusAsync(long userId, long idForm) {
            this.LockAdvertStatusAsync(userId, idForm, null);
        }
        
        /// <remarks/>
        public void LockAdvertStatusAsync(long userId, long idForm, object userState) {
        ...
        public void ReleaseOneAdvertStatus(long userId, long idForm) {
        ...
        /// <remarks/>
        public void ReleaseOneAdvertStatusAsync(long userId, long idForm) {
            this.ReleaseOneAdvertStatusAsync(userId, idForm, null);
        }
        
        /// <remarks/>
        public void ReleaseOneAdvertStatusAsync(long userId, long idForm, object userState) {
        ...
        public AdvertStatus GetOneAdvertStatus(long userId, long idForm) {
        ...
        /// <remarks/>
        public void GetOneAdvertStatusAsync(long userId, long idForm) {
            this.GetOneAdvertStatusAsync(userId, idForm, null);
        }
        
        /// <remarks/>
        public void GetOneAdvertStatusAsync(long userId, long idForm, object userState) {
    ...
    public partial class AdvertStatus {
        ...
        private System.Nullable<long> idFormField;
