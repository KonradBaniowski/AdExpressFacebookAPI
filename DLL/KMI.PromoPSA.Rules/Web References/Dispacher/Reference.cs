...
namespace KMI.PromoPSA.Rules.Dispacher {
    ...
    public partial class Dispacher : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetAvailablePromotionId", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public long GetAvailablePromotionId(long loginId) {
            object[] results = this.Invoke("GetAvailablePromotionId", new object[] {
                        loginId});
            return ((long)(results[0]));
        }
        
        /// <remarks/>
        public void GetAvailablePromotionIdAsync(long loginId) {
            this.GetAvailablePromotionIdAsync(loginId, null);
        }
        
        /// <remarks/>
        public void GetAvailablePromotionIdAsync(long loginId, object userState) {
            if ((this.GetAvailablePromotionIdOperationCompleted == null)) {
                this.GetAvailablePromotionIdOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetAvailablePromotionIdOperationCompleted);
            }
            this.InvokeAsync("GetAvailablePromotionId", new object[] {
                        loginId}, this.GetAvailablePromotionIdOperationCompleted, userState);
        }
        
        private void OnGetAvailablePromotionIdOperationCompleted(object arg) {
        ...
        public bool LockAdvertStatus(long loginId, long promotionId) {
            object[] results = this.Invoke("LockAdvertStatus", new object[] {
                        loginId,
                        promotionId});
            return ((bool)(results[0]));
        }
        ...
        /// <remarks/>
        public void LockAdvertStatusAsync(long loginId, long promotionId) {
            this.LockAdvertStatusAsync(loginId, promotionId, null);
        }
        
        /// <remarks/>
        public void LockAdvertStatusAsync(long loginId, long promotionId, object userState) {
            ...
            this.InvokeAsync("LockAdvertStatus", new object[] {
                        loginId,
                        promotionId}, this.LockAdvertStatusOperationCompleted, userState);
        }
        
        private void OnLockAdvertStatusOperationCompleted(object arg) {
            if ((this.LockAdvertStatusCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.LockAdvertStatusCompleted(this, new LockAdvertStatusCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        public void ReleaseOneAdvertStatusAsync(long loginId, long promotionId) {
            this.ReleaseOneAdvertStatusAsync(loginId, promotionId, null);
        }
        
        /// <remarks/>
        public void ReleaseOneAdvertStatusAsync(long loginId, long promotionId, object userState) {
            ...
            this.InvokeAsync("ReleaseOneAdvertStatus", new object[] {
                        loginId,
                        promotionId}, this.ReleaseOneAdvertStatusOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void GetOneAdvertStatusAsync(long loginId, long promotionId) {
            this.GetOneAdvertStatusAsync(loginId, promotionId, null);
        }
        
        /// <remarks/>
        public void GetOneAdvertStatusAsync(long loginId, long promotionId, object userState) {
            ...
            this.InvokeAsync("GetOneAdvertStatus", new object[] {
                        loginId,
                        promotionId}, this.GetOneAdvertStatusOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void ChangeAdvertStatusAsync(long promotionId, long activationCode) {
            this.ChangeAdvertStatusAsync(promotionId, activationCode, null);
        }
        
        /// <remarks/>
        public void ChangeAdvertStatusAsync(long promotionId, long activationCode, object userState) {
        ...
        public bool ValidateMonth(long loadDate) {
            object[] results = this.Invoke("ValidateMonth", new object[] {
                        loadDate});
            return ((bool)(results[0]));
        }
        ...
        private void OnValidateMonthOperationCompleted(object arg) {
            if ((this.ValidateMonthCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ValidateMonthCompleted(this, new ValidateMonthCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    public delegate void GetAvailablePromotionIdCompletedEventHandler(object sender, GetAvailablePromotionIdCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetAvailablePromotionIdCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    public delegate void LockAdvertStatusCompletedEventHandler(object sender, LockAdvertStatusCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class LockAdvertStatusCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal LockAdvertStatusCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    public delegate void ValidateMonthCompletedEventHandler(object sender, ValidateMonthCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class ValidateMonthCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal ValidateMonthCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
