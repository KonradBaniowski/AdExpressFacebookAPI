...
namespace TNS.AdExpress.Anubis.Miysis
{
	...
	/// </summary>
    public class TreatementSystemPptx : IPlugin
    {
		...
		public void Treatement(string configurationFilePath,IDataSource dataSource,Int64 navSessionId){
            ...
            try {
                ...
                try {
                    ...
                    _dataAccess = null;
                    throw new MiysisPptxException("Impossible to Create Instance Of Layer IStaticNavSessionDAL ", e);
                }
                #endregion
                ...
                try {
                    ...
                    throw new MiysisPptxException("Error for load session", err);
                }
                #endregion
        ...
        protected  virtual void InitializeConfig(string configurationFilePath)
        {
            ...
            {
                throw new MiysisPptxException("Impossible de lancer le traitement d'un job", new ArgumentNullException("configurationFilePath"));
            }
            if (configurationFilePath.Length == 0)
            {
                throw new MiysisPptxException("Impossible de lancer le traitement d'un job", new ArgumentException("Le nom du fichier de configuration est vide."));
            }
            #endregion
            ...
            {
                throw new MiysisPptxException("Impossible de lancer le traitement d'un job <== impossible de charger le fichier de configuration", err);
            }
            #endregion
        }
        ...
        protected virtual void InitializeTheme()
        {
            ...
            {
                throw new MiysisPptxException(string.Format("File of theme not found ! (in Plugin Hotep in TreatmentSystem class) - Path : '{0}'", pathFileTheme), err);
            }
            #endregion
        }
