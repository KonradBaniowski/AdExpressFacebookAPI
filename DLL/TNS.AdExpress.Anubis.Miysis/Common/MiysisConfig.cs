...
using TNS.AdExpress.Anubis.Miysis.DataAccess;
using TNS.FrameWork.DB.Common;

namespace TNS.AdExpress.Anubis.Miysis.Common
{
	/// <summary>
	/// Static class containing every cofiguration elements for the MiysisConfig Plug-in
	/// </summary>
	public class MiysisConfig{
		...
		public MiysisConfig(IDataSource dataSource){
			try{
				MiysisConfigDataAccess.Load(dataSource,this);
			}
