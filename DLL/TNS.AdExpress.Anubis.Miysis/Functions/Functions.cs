...
namespace TNS.AdExpress.Anubis.Miysis.Functions {
    /// <summary>
    ...
    public class Functions {
        ...
        public static StreamWriter GetHtmlFile(string path, WebSession webSession, string serverName) {
            ...
            try {
                ...
                throw (new MiysisPdfException("Unable to create html file.", e));
            }
        }
        ...
        public static void CloseHtmlFile(StreamWriter sw) {
            ...
            try {
                ...
                throw (new MiysisPdfException("Unable to close the html file stream.", e));
            }
        }
        #endregion
