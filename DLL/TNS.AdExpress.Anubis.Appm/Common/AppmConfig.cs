...
namespace TNS.AdExpress.Anubis.Appm.Common {
	/// <summary>
	/// Static class containing every cofiguration elements for the Appm Plug-in
	/// </summary>
	public class AppmConfig {
		...
		public AppmConfig(IDataSource dataSource){
			try{
				AppmConfigDataAccess.Load(dataSource,this);
			}
