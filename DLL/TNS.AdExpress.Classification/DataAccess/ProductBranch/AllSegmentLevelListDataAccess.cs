...
namespace TNS.AdExpress.Classification.DataAccess.ProductBranch{
	...
	public class AllSegmentLevelListDataAccess:ClassificationLevelListDataAccess{
		...
		public AllSegmentLevelListDataAccess (OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.segment,DBConstantes.Language.FRENCH,connection){
		}
		...
		/// <param name="connection">Connexion à la base de données</param>
		public AllSegmentLevelListDataAccess(int language,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.segment,language,connection){
		}
