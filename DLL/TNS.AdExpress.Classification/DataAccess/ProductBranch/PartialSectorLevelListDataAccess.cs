...
namespace TNS.AdExpress.Classification.DataAccess.ProductBranch{
	...
	public class PartialSectorLevelListDataAccess:ClassificationLevelListDataAccess{
		...
		public PartialSectorLevelListDataAccess(string codeList,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.sector,codeList,DBConstantes.Language.FRENCH,connection){
		}
		...
		public PartialSectorLevelListDataAccess(string codeList,int language,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.sector,codeList,language,connection){
		}
