...
namespace TNS.AdExpress.Classification.DataAccess.ProductBranch{
	...
	public class PartialSegmentLevelListDataAccess:ClassificationLevelListDataAccess{
		...
		public PartialSegmentLevelListDataAccess(string codeList,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.segment,codeList,DBConstantes.Language.FRENCH,connection){
		}
		...
		public PartialSegmentLevelListDataAccess(string codeList,int language,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.segment,codeList,language,connection){
		}
