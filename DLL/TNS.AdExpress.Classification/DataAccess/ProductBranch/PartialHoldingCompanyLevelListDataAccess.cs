...
namespace TNS.AdExpress.Classification.DataAccess.ProductBranch{
	...
	public class PartialHoldingCompanyLevelListDataAccess:ClassificationLevelListDataAccess{
		...
		public PartialHoldingCompanyLevelListDataAccess(string codeList,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.holding_company,codeList,DBConstantes.Language.FRENCH,connection){
		}
		...
		public PartialHoldingCompanyLevelListDataAccess(string codeList,int language,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.holding_company,codeList,language,connection){
		}
