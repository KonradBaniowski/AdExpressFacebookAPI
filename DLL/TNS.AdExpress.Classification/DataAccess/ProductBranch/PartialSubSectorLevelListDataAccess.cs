...
namespace TNS.AdExpress.Classification.DataAccess.ProductBranch{
	...
	public class PartialSubSectorLevelListDataAccess:ClassificationLevelListDataAccess{
		...
		public PartialSubSectorLevelListDataAccess(string codeList,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.subsector,codeList,DBConstantes.Language.FRENCH,connection){
		}
		...
		public PartialSubSectorLevelListDataAccess(string codeList,int language,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.subsector,codeList,language,connection){
		}
