...
namespace TNS.AdExpress.Classification.DataAccess.MediaBranch{
	...
	public class AllTitleListDataAccess:ClassificationLevelListDataAccess{
		...
		public AllTitleListDataAccess(OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.title,DBConstantes.Language.FRENCH,connection){
		}
		...
		/// <param name="connection">Connexion à la base de données</param>
		public AllTitleListDataAccess(int language,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.title,language,connection){
		}
