...
namespace TNS.AdExpress.Classification.DataAccess.MediaBranch{
	...
	public class PartialVehicleListDataAccess:ClassificationLevelListDataAccess{
		...
		public PartialVehicleListDataAccess(string codeList,IDataSource source):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.vehicle,codeList,DBConstantes.Language.FRENCH,source){
		}
		...
		public PartialVehicleListDataAccess(string codeList,int language,IDataSource source):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.vehicle,codeList,language,source){
		}
