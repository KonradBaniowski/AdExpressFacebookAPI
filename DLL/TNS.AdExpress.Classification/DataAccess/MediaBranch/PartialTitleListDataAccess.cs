...
namespace TNS.AdExpress.Classification.DataAccess.MediaBranch{
	...
	public class PartialTitleListDataAccess:ClassificationLevelListDataAccess{
		...
		public PartialTitleListDataAccess(string codeList,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.title,codeList,DBConstantes.Language.FRENCH,connection){
		}
		...
		public PartialTitleListDataAccess(string codeList,int language,OracleConnection connection):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.title,codeList,language,connection){
		}
