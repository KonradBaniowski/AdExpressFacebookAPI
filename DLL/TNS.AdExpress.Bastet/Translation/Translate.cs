...
namespace TNS.AdExpress.Bastet.Translation {
	...
	public class Translate {
		...
		public static void SetTextLanguage(System.Web.UI.ControlCollection list, int language){
			foreach(Control current in list){
                if(current is TNS.AdExpress.Domain.Translation.ITranslation) ((TNS.AdExpress.Domain.Translation.ITranslation)current).Language=language;
			}
		}
