...
namespace TNS.AdExpress.Bastet.WebControls {
    ...
    public class LanguageSelectionWebControl : ImageDropDownListWebControl {
        ...
        protected override void Render(HtmlTextWriter writer) {
            ...
            string themeName = TNS.AdExpress.Bastet.Web.WebApplicationParameters.Themes[_language].Name;
            ...
            if (index > -1) {
                ...
                if (_showText) {
                    ...
                    writer.Write("<img class=\"" + OutCssClass + "\" src=\"/App_Themes/" + themeName + "/Images/Common/pixel.gif\" width=\"5\" align=\"absmiddle\">");
                }
                else
