...
namespace TNS.AdExpress.Web.Controls.Headers
{
    ...
    public class ResultsOptionsWebControl : System.Web.UI.WebControls.WebControl
    {
        ...
        /// <summary>
        /// Show group level flag
        /// </summary>
        private bool _showGrouLevel = false;
        /// <summary>
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (WebApplicationParameters.UsePurchaseMode && customerWebSession.CustomerLogin.CustormerFlagAccess(CstDB.Flags.ID_PURCHASE_MODE_DISPLAY_FLAG)
                && customerWebSession.CurrentModule != TNS.AdExpress.Constantes.Web.Module.Name.INDICATEUR
                && customerWebSession.CurrentModule != TNS.AdExpress.Constantes.Web.Module.Name.TABLEAU_DYNAMIQUE) {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            _showGrouLevel = customerWebSession.CustomerLogin.CustormerFlagAccess(CstDB.Flags.ID_GROUP_LEVEL_ACCESS_FLAG);
        ...
        private void Custom_PreRender(object sender, System.EventArgs e)
        {
            ...
            if (mediaDetailOption)
            {
                ...
                else if (customerWebSession.CurrentModule == WebConstantes.Module.Name.ANALYSE_MANDATAIRES)
                {
                    ...
                    if (HasMediaClassifLevel(DetailLevelItemInformation.Levels.media)) mediaDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(18, customerWebSession.SiteLanguage),
                        SessionCst.PreformatedDetails.PreformatedMediaDetails.Media.GetHashCode().ToString()));
                    ...
                    mediaDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(1142, customerWebSession.SiteLanguage), SessionCst.PreformatedDetails.PreformatedMediaDetails.vehicleCategory.GetHashCode().ToString()));
                    if (HasMediaClassifLevel(DetailLevelItemInformation.Levels.media)) mediaDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(1544, customerWebSession.SiteLanguage), 
                        SessionCst.PreformatedDetails.PreformatedMediaDetails.vehicleMedia.GetHashCode().ToString()));
                    if (HasMediaClassifLevel(DetailLevelItemInformation.Levels.mediaSeller)) mediaDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(1860, customerWebSession.SiteLanguage),
                        SessionCst.PreformatedDetails.PreformatedMediaDetails.vehicleMediaSeller.GetHashCode().ToString()));
                    ...
                    if (HasMediaClassifLevel(DetailLevelItemInformation.Levels.mediaSeller)) mediaDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(1383, customerWebSession.SiteLanguage),
                        SessionCst.PreformatedDetails.PreformatedMediaDetails.mediaSeller.GetHashCode().ToString()));
                    ...
                    mediaDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(1862, customerWebSession.SiteLanguage),
                        SessionCst.PreformatedDetails.PreformatedMediaDetails.mediaSellerMedia.GetHashCode().ToString()));
                    if (HasMediaClassifLevel(DetailLevelItemInformation.Levels.mediaSeller)) mediaDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(2813, customerWebSession.SiteLanguage), 
            ...
            if (ProductDetailOption)
            {
                ...
                else
                {
                    ...
                    * */
                    ...
                    if (_showSegment && _showGrouLevel)
                    ...
                    if (customerWebSession.CustomerLogin.CustormerFlagAccess(CstDB.Flags.ID_MARQUE) && _showGrouLevel)
                    {
                        productDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(1111, customerWebSession.SiteLanguage), SessionCst.PreformatedDetails.PreformatedProductDetails.groupBrand.GetHashCode().ToString()));
                    }
                    if (customerWebSession.CustomerLogin.CustormerFlagAccess(CstDB.Flags.ID_PRODUCT_LEVEL_ACCESS_FLAG) && _showGrouLevel)
                        productDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(1112, customerWebSession.SiteLanguage), SessionCst.PreformatedDetails.PreformatedProductDetails.groupProduct.GetHashCode().ToString()));
                    if (_showGrouLevel)
                    productDetail.Items.Add(new ListItem(GestionWeb.GetWebWord(1145, customerWebSession.SiteLanguage), SessionCst.PreformatedDetails.PreformatedProductDetails.groupAdvertiser.GetHashCode().ToString()));
        ...
        {
            string listStr = customerWebSession.GetSelection(customerWebSession.SelectionUniversMedia,TNS.AdExpress.Constantes.Customer.Right.type.vehicleAccess);
