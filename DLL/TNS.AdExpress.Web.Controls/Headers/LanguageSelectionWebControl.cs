        ...
        protected override void Render(HtmlTextWriter writer) {
            ...
            if (index > -1) {
                ...
                if (_showText) {
                    ...
                    writer.Write("<img class=\"" + OutCssClass + "\" src=\"images/spacer.gif\" width=\"5\" align=\"absmiddle\">");
                }
                else
            ...
            for (i = 0; i <= textList.GetUpperBound(0); i++) {
                try {
                    ...
                    writer.WriteLine("<tr id=\"scroller_item_" + this.ID + "_" + i + "\" class=\"" + OutCssClass + "\" onMouseOver=\"ChangeItemClassLS(this, '" + OverCssClass + "')\" onMouseOut=\"ChangeItemClassLS(this, '" + OutCssClass + "')\" onClick=\"ItemClickLS('" + this.ID + "',this, " + i + ", '" + textList[i].Replace("'", "\'") + "', 'images/spacer.gif','" + (link + idList[i]) + "')\">");
                    if (pictShow) {
