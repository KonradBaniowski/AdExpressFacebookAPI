	...
	public class DetailInsertionPeriodNavigationWebControl : System.Web.UI.WebControls.WebControl {
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            switch (VehiclesInformation.DatabaseIdToEnum(_idVehicle))
            {
                ...
                case DBClassificationConstantes.Vehicles.names.radioGeneral: vehicle = GestionWeb.GetWebWord(2630, _customerWebSession.SiteLanguage).ToUpper(); break;
                ...
                case DBClassificationConstantes.Vehicles.names.tvNonTerrestrials: vehicle = GestionWeb.GetWebWord(2636, _customerWebSession.SiteLanguage).ToUpper(); break;
                ...
                case DBClassificationConstantes.Vehicles.names.indoor: vehicle = GestionWeb.GetWebWord(2644, _customerWebSession.SiteLanguage).ToUpper(); break;
                ...
                case DBClassificationConstantes.Vehicles.names.czinternet: vehicle = GestionWeb.GetWebWord(1301, _customerWebSession.SiteLanguage); break;
                ...
                case DBClassificationConstantes.Vehicles.names.directMarketing: vehicle = GestionWeb.GetWebWord(2989, _customerWebSession.SiteLanguage); break;
                case DBClassificationConstantes.Vehicles.names.cinema: vehicle = GestionWeb.GetWebWord(2475,_customerWebSession.SiteLanguage); break;
            }
            #endregion
