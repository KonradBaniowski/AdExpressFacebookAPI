...
namespace TNS.AdExpress.Web.Controls.Headers
{
	...
	public class MediaSellerWebControl : System.Web.UI.WebControls.WebControl{
		...
		protected override void Render(HtmlTextWriter output) {
			...
			output.Write("\n<td class=\"txtNoir11Bold\" style=\"PADDING-RIGHT: 5px; PADDING-LEFT: 5px; TEXT-TRANSFORM: uppercase; HEIGHT: 14px\" width=\"100%\">"+GestionWeb.GetWebWord(1605,customerWebSession.SiteLanguage)+"</td>");
