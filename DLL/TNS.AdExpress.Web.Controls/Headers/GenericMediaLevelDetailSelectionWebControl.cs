...
//					TODO					
		...
		protected override void Render(HtmlTextWriter output){
			...
			output.Write("<tr>");
			output.Write("<td>");
			output.Write("<table style=\"background-color:#FFFFFF;BORDER-RIGHT: #644883 1px solid; BORDER-TOP: #644883 1px solid; BORDER-LEFT: #644883 1px solid; BORDER-BOTTOM: #644883 1px solid\" cellSpacing=\"0\" cellPadding=\"0\" width=\""+this.Width+"\" border=\"0\">");
			output.Write("<tr onclick=\"DivDisplayer('detailledLevelContent');\" style=\"CURSOR: hand\">");
			//Titre de la section
			...
			output.Write("<td align=\"right\"><IMG src=\"/Images/Common/button/bt_arrow_down.gif\" align=\"absMiddle\"></td>");
			output.Write("</tr>");
			output.Write("</table>");
			// Section
			output.Write("\r\n<div id=\"detailledLevelContent\" style=\"BORDER-RIGHT: #644883 1px solid;DISPLAY: none; BORDER-LEFT: #644883 1px solid; WIDTH: "+this.Width+"px; BORDER-BOTTOM: #644883 1px solid;background-color:#D0C8DA;padding-left:2px;vertical-align:top;\">");
			...
			// Bouton supprimer
			output.Write("\r\n<tr>");
			output.Write("\r\n<td align=\"right\"><a class=\"roll03\" href=\"javascript: remove();\"  onmouseover=\"deleteButton.src='/Images/Common/button/bt_delete_down.gif';\" onmouseout=\"deleteButton.src ='/Images/Common/button/bt_delete_up.gif';\"><img name=deleteButton border=0 src=\"/Images/Common/button/bt_delete_up.gif\" alt=\""+ GestionWeb.GetWebWord(1951,_customerWebSession.SiteLanguage) +"\"></a></td>");	
			output.Write("\r\n</tr>");
			output.Write("\r\n<tr>");
			output.Write("\r\n<td>");
			...
			if(_saveASPXFilePath!=null && _saveASPXFilePath.Length>1)
				output.Write("<a class=\"roll03\" href=\"javascript: save();\"  onmouseover=\"saveLevelDetailButton.src='/Images/Common/button/save_down.gif';\" onmouseout=\"saveLevelDetailButton.src ='/Images/Common/button/save_up.gif';\"><img name=saveLevelDetailButton border=0 src=\"/Images/Common/button/save_up.gif\" alt=\""+ GestionWeb.GetWebWord(1952,_customerWebSession.SiteLanguage) +"\"></a>");
			else
				output.Write("&nbsp;");
			output.Write("</td>");	
			...
			switch(module){
						...
						switch(currentDetailLevelItem.Id){
							...
							case DetailLevelItemInformation.Levels.agency:
								if(
									...
									_customerWebSession.CustomerLogin.FlagsList[(long)TNS.AdExpress.Constantes.DB.Flags.ID_MEDIA_AGENCY]!=null
									)return(true);
								return(false);
								#endregion
							...
							case DetailLevelItemInformation.Levels.slogan:
								if(
									currentDetailLevelItem.Id==DetailLevelItemInformation.Levels.slogan &&_customerWebSession.CustomerLogin.FlagsList[(long)TNS.AdExpress.Constantes.DB.Flags.ID_SLOGAN_ACCESS_FLAG]!=null &&
					...
					case WebConstantes.GenericDetailLevel.ComponentProfile.product:
						switch(currentDetailLevelItem.Id){
							...
							#region Marques
								// Droit des Marques
							case DetailLevelItemInformation.Levels.brand:
							if(	_customerWebSession.CustomerLogin.FlagsList[(long)TNS.AdExpress.Constantes.DB.Flags.ID_MARQUE]!=null )return true;
								return(false);
								#endregion

							#region Groupe de société
							case DetailLevelItemInformation.Levels.holdingCompany:
								if(_customerWebSession.CustomerLogin.FlagsList[(long)TNS.AdExpress.Constantes.DB.Flags.ID_HOLDING_COMPANY]!=null)return(true);
								return(false);
								#endregion
							...
							case DetailLevelItemInformation.Levels.groupMediaAgency:
							case DetailLevelItemInformation.Levels.agency:
								if(_customerWebSession.CustomerLogin.FlagsList[(long)TNS.AdExpress.Constantes.DB.Flags.ID_MEDIA_AGENCY]!=null)return(true);
								return(false);
								#endregion
				...
				switch(currentDetailLevelItem.Id){
					...
					case DetailLevelItemInformation.Levels.holdingCompany:
						...
						//if (							
						//    // Droit sur les groupe de société
						//    _customerWebSession.CustomerLogin.FlagsList[(long)TNS.AdExpress.Constantes.DB.Flags.ID_HOLDING_COMPANY]!=null &&
						//    // Accès si sélection en groupe de société, annonceur, marque, produit, groupe et variété
						//    (_customerWebSession.GetSelection(_customerWebSession.SelectionUniversAdvertiser,TNS.AdExpress.Constantes.Customer.Right.type.productAccess).Length>0 ||
						//    _customerWebSession.GetSelection(_customerWebSession.SelectionUniversAdvertiser,TNS.AdExpress.Constantes.Customer.Right.type.brandAccess).Length>0 ||
						//    _customerWebSession.GetSelection(_customerWebSession.SelectionUniversAdvertiser,TNS.AdExpress.Constantes.Customer.Right.type.advertiserAccess).Length>0||
				...
				switch(currentDetailLevelItem.Id){
					...
					case DetailLevelItemInformation.Levels.brand:
						// Droit des Marques
						if(_customerWebSession.CustomerLogin.FlagsList[(long)TNS.AdExpress.Constantes.DB.Flags.ID_MARQUE]!=null)
							return(true);
						return(false);
						#endregion
...
//		/// <summary>
//		/// Vérifie que le niveua de détail version peut être montré
//		/// </summary>
//		/// <returns></returns>
//		private bool CanAddSloganDetailLevelItem(){
//			string idVehicleList =  _customerWebSession.GetSelection(_customerWebSession.SelectionUniversMedia,TNS.AdExpress.Constantes.Customer.Right.type.vehicleAccess);						
