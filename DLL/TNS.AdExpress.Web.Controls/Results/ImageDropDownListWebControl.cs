...
namespace TNS.AdExpress.Web.Controls.Results{
	...
	public class ImageDropDownListWebControl : System.Web.UI.WebControls.WebControl {
		...
		protected override void Render(HtmlTextWriter writer) {
			...
			writer.WriteLine("\t\t\t <tr> ");
			writer.WriteLine("\t\t\t <td><div id=\"scroller_" + this.ID + "\" style=\"display: none; overflow: visible; background-color: " + bgColor + "; layer-background-color: " + bgColor + "; border: 1px none #000000;\">");
