...
namespace TNS.AdExpress.Web.Controls.Results.Creatives {
    ...
    public class InsertionsWebControl : ResultWebControl {
        ...
        protected virtual void BuildCustomFilter(ref ResultTable data, List<GenericColumnItemInformation> columnFilters)
        {
            ...
            str.AppendFormat("&nbsp;&nbsp;&nbsp;<a href=\"#\" onclick=\"{{InitFilters();ApplyFilters();}}\" onmouseover=\"filterInitButton_{0}.src='/App_Themes/{1}/Images/Common/Button/initialize_all_down.gif';\" onmouseout=\"filterInitButton_{0}.src = '/App_Themes/{1}/Images/Common/Button/initialize_all_up.gif';\"><img src=\"/App_Themes/{1}/Images/Common/Button/initialize_all_up.gif\" border=0 name=filterInitButton_{0}></a></td></tr>", this.ID, themeName);
        ...
        protected ListDictionary GetFilters(string[] filters)
        {
            ...
            if (filters != null && filters.Length > 0)
            {
                ...
                for (int i = 0; i < detailLevels.GetNbLevels; i++)
                {
                    ...
                    if (filters[i] != "-1" || (((VehiclesInformation.Contains(CstDBClassif.Vehicles.names.adnettrack) && _idVehicle == VehiclesInformation.EnumToDatabaseId(CstDBClassif.Vehicles.names.adnettrack)) || (VehiclesInformation.Contains(CstDBClassif.Vehicles.names.evaliantMobile) && _idVehicle == VehiclesInformation.EnumToDatabaseId(CstDBClassif.Vehicles.names.evaliantMobile))) && cLevel.Id == DetailLevelItemInformation.Levels.slogan && filters[i] != "-1"))
                    {
