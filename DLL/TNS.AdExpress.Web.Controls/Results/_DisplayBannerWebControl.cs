...
//                output.Write("\n </OBJECT>");
//            }
//            else if (_formatId == (int)FormatType.flv) {
//                output.Write("<object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" codebase=\"http://active.macromedia.com/flash5/cabs/swflash.cab#version=5,0,0,0\" width=\"400\" height=\"315\">");
//                output.Write("<param name=\"movie\" value=\"./Player/playerflv.swf\" />");
//                output.Write("<param name=\"allowfullscreen\" value=\"true\" />");
//                output.Write("<param name=\"allowscriptaccess\" value=\"always\" />");
//                output.Write("<param name=\"flashvars\" value=\"file=" + pathFile + "\" />");
//                output.Write("<embed type=\"application/x-shockwave-flash\"");
//                output.Write("src=\"./Player/playerflv.swf\" ");
//                output.Write("width=\"400\" ");
//                output.Write("height=\"315\"");
//                output.Write("allowscriptaccess=\"always\" ");
//                output.Write("allowfullscreen=\"false\"");
//                output.Write("flashvars=\"file=" + pathFile + "\" ");
//                output.Write("/>");
//                output.Write("</object>");
//            }
//            else {
