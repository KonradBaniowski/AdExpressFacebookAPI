...
namespace TNS.AdExpress.Anubis.Hotep.Functions
{
    /// <summary>
    ...
    public class Functions {
        ...
        public static StreamWriter GetHtmlFile(string path, WebSession webSession, string serverName) {
            ...
            try {
                ...
                throw (new HotepPdfException("Unable to create html file.", e));
            }
        }
        ...
        public static void CloseHtmlFile(StreamWriter sw) {
            try {
                ...
                throw (new HotepPdfException("Unable to close the html file stream.", e));
            }
        }
        #endregion
