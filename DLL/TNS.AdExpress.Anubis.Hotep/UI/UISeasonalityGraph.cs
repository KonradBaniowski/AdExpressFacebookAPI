...
namespace TNS.AdExpress.Anubis.Hotep.UI
{
	...
	public class UISeasonalityGraph : Chart
	{
		...
		/// </summary>
		public virtual void BuildSeasonality(){
        ...
        protected virtual void SetAdvertisSeries(Dictionary<long, double> advertiserTotal, Dictionary<long, Series> advertiserSerie, ref int nbMonth)
        {
            Int64 idElement = 0;
            int cMonth = 0;
            int oldMonth = -1;
        ...
        protected virtual void SetSeriesData(Series serieUnivers, Series serieSectorMarket, Series serieMediumMonth, Dictionary<long, double> advertiserTotal, Dictionary<long, Series> advertiserSerie, DateTime periodBegin, ref  double mediumMonth, ref int nbMonth)
        {
            int compteur = -1;
            int oldMonth = -1;
            int cMonth = -1;
