...
namespace TNS.AdExpress.Anubis.Shou.DataAccess
{
	/// <summary>
	/// Description résumée de ShouConfigDataAccess.
	/// </summary>
	public class ShouConfigDataAccess
	{
		/// <summary>
		/// Load Anubis configuration
		/// </summary>
		/// <param name="dataSource">Data Source</param>
		internal static void Load(IDataSource dataSrc, ShouConfig cfg) {
			...
			try {
				...
				throw (new ShouConfigDataAccessException("Unable to load Shou configuration",err));
			}
		}
	}
}
