...
namespace TNS.AdExpress.Anubis.Shou.Common
{
	/// <summary>
	/// Description résumée de ShouConfig.
	/// </summary>
	public class ShouConfig
	{
		...
		public ShouConfig(IDataSource dataSource) {
			try {
				ShouConfigDataAccess.Load(dataSource,this);
			}
