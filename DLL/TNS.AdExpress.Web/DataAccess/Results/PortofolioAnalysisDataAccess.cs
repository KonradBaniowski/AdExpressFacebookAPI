...
//                unitFields = WebFunctions.SQLGenerator.GetUnitFieldsName(webSession, Constantes.DB.TableType.Type.webPlan, DATA_TABLE_PREFIXE);
...
//                detailProductFields=webSession.GenericProductDetailLevel.GetSqlFields();
//                detailProductJoints=webSession.GenericProductDetailLevel.GetSqlJoins(webSession.SiteLanguage,DATA_TABLE_PREFIXE);
//                unitFields = WebFunctions.SQLGenerator.GetUnitFieldsName(webSession, type, DATA_TABLE_PREFIXE);
//                productsRights=WebFunctions.SQLGenerator.getAnalyseCustomerProductRight(webSession,DATA_TABLE_PREFIXE,true);
//                detailProductOrderBy=webSession.GenericProductDetailLevel.GetSqlOrderFields();
//                switch (type) {
//                    case DBConstantes.TableType.Type.dataVehicle4M:
...
//                        sql = "";
//                        sql += " select id_media, " + productFieldNameWithoutTablePrefix + dataFieldsForGadWithoutTablePrefix + ", " + WebFunctions.SQLGenerator.GetUnitFieldsNameForPortofolio(webSession, Constantes.DB.TableType.Type.webPlan);
//                        sql += " from (";
//                        sql += sqlDataVehicle;
//                        sql += " UNION ";
//                        sql += sqlWebPlan;
...
//                case DBConstantes.TableType.Type.dataVehicle4M:
//                case DBConstantes.TableType.Type.dataVehicle:
//                    sql += "select " + WebFunctions.SQLGenerator.GetUnitFieldsNameForPortofolio(webSession, DBConstantes.TableType.Type.dataVehicle);
//                    break;
//                case DBConstantes.TableType.Type.webPlan:
//                    sql += "select " + WebFunctions.SQLGenerator.GetUnitFieldsNameForPortofolio(webSession, DBConstantes.TableType.Type.webPlan);
//                    break;
//            }
//            if (customerPeriod.IsDataVehicle && customerPeriod.IsWebPlan) {
...
//                    if (customerPeriod.IsDataVehicle && customerPeriod.IsWebPlan) {
//                        sql = "";
//                        sql += " select " + WebFunctions.SQLGenerator.getunit((DBClassificationConstantes.Vehicles.names)idVehicle, Portofolio.SYNTHESIS);
//                        sql += " from (";
//                        sql += sqlDataVehicle;
//                        sql += " UNION ";
//                        sql += sqlWebPlan;
