...
//	19/12/2005	D. V. Mussuma	Modification totale de la requête pour intégration des détails régies et accroches.
#endregion
...
//			string currentIdMedia="";
        ...
        public static StringBuilder GetRequest(WebSession webSession, ListDictionary mediaList, int dateBegin, int dateEnd, Int64 idVehicle, bool export) {
            ...
            try{
				...
				//}
				//// segment
				//list = webSession.GetSelection(webSession.CurrentUniversAdvertiser, CustomerRightConstante.type.segmentAccess);
				//if (list.Length > 0) {
				//    if (!premier) sql.Append(" or");
				//    else sql.Append(" and ((");
				//    sql.Append(" wp.id_segment in (" + list + ") ");
				//    premier = false;
				//}
				...
				//// segment
				//list = webSession.GetSelection(webSession.CurrentUniversAdvertiser, CustomerRightConstante.type.segmentException);
				//if (list.Length > 0) {
				//    if (premier) sql.Append(" and (");
				//    else sql.Append(" and");
				//    sql.Append(" wp.id_segment not in (" + list + ") ");
				//    premier = false;
				//}
