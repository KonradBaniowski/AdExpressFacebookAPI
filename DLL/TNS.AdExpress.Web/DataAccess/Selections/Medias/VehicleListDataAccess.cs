...
namespace TNS.AdExpress.Web.DataAccess.Selections.Medias{
	...
	public class VehicleListDataAccess{
		...
		public VehicleListDataAccess(WebSession webSession){
			...
			sql+=" and "+DBConstantes.Tables.BASIC_MEDIA_PREFIXE+".id_language="+webSession.DataLanguage.ToString();
...
//			else 
        ...
        public static DataSet DetailMediaListDataAccess(WebSession webSession, DetailLevelItemInformation detailLevel) {
            ...
            sql.Append(" from " + DBConstantes.Schema.ADEXPRESS_SCHEMA + ".vehicle " + DBConstantes.Tables.VEHICLE_PREFIXE + "," + DBConstantes.Schema.ADEXPRESS_SCHEMA + "." + detailLevel.DataBaseTableName + " " + detailLevel.DataBaseTableNamePrefix + "," + DBConstantes.Schema.ADEXPRESS_SCHEMA + ".media " + DBConstantes.Tables.MEDIA_PREFIXE + " , " + DBConstantes.Schema.ADEXPRESS_SCHEMA + ".category " + DBConstantes.Tables.CATEGORY_PREFIXE + ", " + DBConstantes.Schema.ADEXPRESS_SCHEMA + ".basic_media " + DBConstantes.Tables.BASIC_MEDIA_PREFIXE + " ");
            sql.Append(" where");
            // Langue
            ...
            sql.Append(" and " + detailLevel.DataBaseTableNamePrefix + "." + detailLevel.DataBaseIdField + "=" + DBConstantes.Tables.MEDIA_PREFIXE + "." + detailLevel.DataBaseIdField);
            ...
            sql.Append(" order by " + detailLevel.DataBaseTableNamePrefix + "." + detailLevel.DataBaseField + " , " + DBConstantes.Tables.MEDIA_PREFIXE + ".media ");
