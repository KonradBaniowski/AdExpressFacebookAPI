...
namespace TNS.AdExpress.Web.DataAccess.Selections.Medias
{
	...
	public class CountryListDataAccess
	{
		...
		public static DataSet DetailCountryListDataAccess(WebSession webSession){
			...
			sql.Append(" and "+DBConstantes.Tables.COUNTRY_PREFIXE+".id_language="+webSession.SiteLanguage.ToString());
			...
			try{
				...
				throw (new TNS.AdExpress.Web.Exceptions.CountryListDataAccessException("Impossible de charger la liste des pays avec les supports associés",err));
			}
			#endregion
