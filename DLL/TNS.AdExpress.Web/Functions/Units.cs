...
namespace TNS.AdExpress.Web.Functions{
	...
	public class Units{
		...
		public static ArrayList getUnitsFromVehicleSelection(string vehicleSelection){
            ...
            String[] vehicles = vehicleSelection.Split(',');
            if (vehicles != null && vehicles.Length > 0)
            {
                if (Array.IndexOf(vehicles, "7") > -1 || Array.IndexOf(vehicles, "9") > -1)
                {
                ...
                {
                    if (vehicles.Length == 2 && Array.IndexOf(vehicles, "2") > -1 && Array.IndexOf(vehicles, "3") > -1)
                    {
                    ...
                    else if (vehicles.Length >= 2)
                    {
                        ...
                        units.Add(WebConstantes.CustomerSessions.Unit.kEuro);
                        units.Add(WebConstantes.CustomerSessions.Unit.euro);
                        if (!(Array.IndexOf(vehicles, "10") > -1))
