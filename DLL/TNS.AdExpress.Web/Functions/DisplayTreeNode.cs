			...
			foreach(TreeNode currentNode in root.Nodes){
				if(start==0){
					if(displayBorderTable){
						t.Append("<table style=\"border-bottom :#644883 1px solid; border-top :#644883 1px solid; border-left :#644883 1px solid; border-right :#644883 1px solid; \" class=\"txtViolet11Bold\"  cellpadding=0 cellspacing=0 width="+witdhTable+percentageSymbol+"  >");
						start=1;
					}
					else{
						t.Append("<table bordercolor=#ffffff class=\"txtViolet11Bold\"  cellpadding=0 cellspacing=0 width="+witdhTable+percentageSymbol+">");
					}

				}
				else{
					if(displayBorderTable){
						t.Append("<table style=\"border-bottom :#644883 1px solid; border-left :#644883 1px solid; border-right :#644883 1px solid; \" class=\"txtViolet11Bold\"  cellpadding=0 cellspacing=0 width="+witdhTable+percentageSymbol+">");
					}
					else{
						t.Append("<table bordercolor=#ffffff class=\"txtViolet11Bold\"  cellpadding=0 cellspacing=0 width="+witdhTable+percentageSymbol+">");
					}
				...
				if(currentNode.Nodes.Count>0){
					if(displayBorderTable){
						...
						t.Append("<table style=\"border-bottom :#644883 1px solid; border-left :#644883 1px solid; border-right :#644883 1px solid; \" bgcolor=#DED8E5 width="+witdhTable+percentageSymbol+">");
					}
					else{
						if(div){
						...
						t.Append("<table bordercolor=#ffffff bgcolor=#DED8E5 width="+witdhTable+percentageSymbol+">");
					}
				}
