			...
			if(webSession==null){
				...
				if (webSession.isReferenceAdvertisersSelected()) {
					...
					if (webSession.SecondaryProductUniverses.Count == 1) {						
						...
						body += "<u>" + GestionWeb.GetWebWord(universeCodeTitle, webSession.SiteLanguage) + "</u><br>";
						body += TNS.AdExpress.Web.Functions.DisplayUniverse.ToHtml(adExpressUniverse, webSession.SiteLanguage, new OracleConnection(webSession.CustomerLogin.OracleConnectionString), 600);
					}
