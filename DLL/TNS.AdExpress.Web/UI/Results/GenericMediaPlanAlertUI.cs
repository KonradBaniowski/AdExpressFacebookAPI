                        ...
                        switch (j)
                        {
                            ...
                            default:
                                ...
                                if (tab[i, j].GetType() == typeof(MediaPlanItem))
                                {
                                    ...
                                    {
                                        case FrameWorkResultConstantes.DetailledMediaPlan.graphicItemType.present:
                                            if (showValue) t.Append("<td class=\"" + presentClass + "\">" + Functions.Units.ConvertUnitValueToString(((MediaPlanItem)tab[i, j]).Unit, webSession.Unit, fp) + "</td>");
                        ...
                        switch (j)
                        {
                            ...
                            case MediaPlanAlert.VEHICLE_COLUMN_INDEX:
                                if (tab[i, j] != null)
                                {
                                    ...
                                    // On traite les unités
                                    totalUnit = WebFunctions.Units.ConvertUnitValueToString(tab[i, FrameWorkResultConstantes.MediaPlanAlert.TOTAL_COLUMN_INDEX], webSession.Unit, fp);
                        ...
                        switch (j)
                        {
                            ...
                            case DetailledMediaPlan.L1_COLUMN_INDEX:
                                if (tab[i, j] != null)
                                {
                                    ...
                                    for (k = 1; k <= nbColYear; k++)
                                    {
                                        t.Append("<td class=\"" + classe + "nbexport\" nowrap>" + WebFunctions.Units.ConvertUnitValueToString(tab[i, j + 10 + k], webSession.Unit, fp) + "</td>");
                                    }
                                    j = j + 10 + nbColYear;
                                    //fin MAJ
                                }
                            ...
                            case DetailledMediaPlan.L2_COLUMN_INDEX:
                                if (tab[i, j] != null)
                                {
                                    ...
                                    for (k = 1; k <= nbColYear; k++)
                                    {
                                        t.Append("<td class=\"L2nbexport\">" + WebFunctions.Units.ConvertUnitValueToString(tab[i, j + 9 + k], webSession.Unit, fp) + "</td>");
                                    }
                                    j = j + 9 + nbColYear;
                                    //fin MAJ
                                }
                            ...
                            case DetailledMediaPlan.L3_COLUMN_INDEX:
                                if (tab[i, j] != null)
                                {
                                    ...
                                    for (k = 1; k <= nbColYear; k++)
                                    {
                                        t.Append("<td class=\"L3nbexport\">" + WebFunctions.Units.ConvertUnitValueToString(tab[i, j + 8 + k], webSession.Unit, fp) + "</td>");
                                    }
                                    j = j + 8 + nbColYear;
                                    //fin MAJ
                                }
                            ...
                            case DetailledMediaPlan.L4_COLUMN_INDEX:
                                ...
                                for (k = 1; k <= nbColYear; k++)
                                {
                                    t.Append("<td class=\"L4nbexport\">" + WebFunctions.Units.ConvertUnitValueToString(tab[i, j + 7 + k], webSession.Unit, fp) + "</td>");
                                }
                                //fin MAJ
                                j = j + 7 + nbColYear;//nbColYear ajouter GF
                                break;
