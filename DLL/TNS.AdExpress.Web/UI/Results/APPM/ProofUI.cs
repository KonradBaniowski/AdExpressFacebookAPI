		...
		public static string GetHtml(Page page, TNS.FrameWork.DB.Common.IDataSource dataSource, WebSession webSession, Int64 idMedia, Int64 idProduct, int date, int dateCover, string pageNumber)
        {
			...
			if (dtResult.Rows.Count > 0){
				foreach(DataRow row in dtResult.Rows){
					...
					string pathCouv2 = CstWeb.CreationServerPathes.LOCAL_PATH_IMAGE + idMedia + @"\" + dateCover + @"\" + CstWeb.CreationServerPathes.COUVERTURE;
					...
					html.Append("\n<td class=\"txtViolet11\">"+ row["media_paging"] +"</td>");
					html.Append("\n</tr>");
					html.Append("\n<tr valign=\"top\">");
					...
					if(fileList!=null){
						...
						html.Append("\n<tr><td colspan=\"2\" bgcolor=\"#FFFFFF\" style=\"HEIGHT: 1px;\"></td></tr>");
						html.Append("\n<tr><td colspan=\"2\" align=\"center\">");
						html.Append("<a href=\"javascript:portofolioCreationWithAnchor('" + webSession.IdSession + "','" + idMedia + "','" + dateCover + "','" + row["Media"] + "','" + row["number_page_media"].ToString() + "','" + pageNumber + "');\" class=\"roll04\">" + GestionWeb.GetWebWord(1397, webSession.SiteLanguage) + "</a>");
