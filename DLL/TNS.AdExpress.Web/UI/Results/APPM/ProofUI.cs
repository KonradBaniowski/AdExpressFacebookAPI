	...
	public class ProofUI{
		...
		public static string GetHtml(Page page, TNS.FrameWork.DB.Common.IDataSource dataSource, WebSession webSession, Int64 idMedia, Int64 idProduct, int date, int dateCover, string pageNumber)
        {
			...
			if (dtResult.Rows.Count > 0){
                ...
                bool hasCopyRight = HasPressCopyright(idMedia);
                ...
                {
                    #region Début tableau général
                    html.Append("<TABLE  class=\"whiteBackGround\" style=\"MARGIN-TOP: 5px; MARGIN-LEFT: 0px; MARGIN-RIGHT: 25px;\"");
                    html.Append("cellPadding=\"0\" cellSpacing=\"3\" align=\"center\" border=\"0\" width=\"900\" >");
                    html.Append("<tr align=\"center\"><td>");
                    #endregion

                    html.Append("<div align=\"center\" class=\"txtBlanc11Bold\">" + GestionWeb.GetWebWord(3015, webSession.SiteLanguage) + "</div>");
