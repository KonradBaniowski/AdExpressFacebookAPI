...
namespace TNS.AdExpress.Web.UI.Results.MediaPlanVersions
{
	...
	public class VersionRadioUI  : VersionDetailUI {
		...
		public VersionRadioUI(WebSession webSession, VersionItem version):base(webSession, version){
		} 
		/// <summary>
		...
		public VersionRadioUI(WebSession webSession, ExportVersionItem exportVersion):base(webSession, exportVersion){
		}
		#endregion
