							...
							case CompetitorMediaPlan.VEHICLE_COLUMN_INDEX:
								if(tab[i,j]!=null){
									...
									if(premierTotal){
										...
										//	t.Append("\r\n\t<tr id=\""+tab[i,j]+"Content4\" style=\"DISPLAY:inline\">\r\n\t\t<td>"+tab[i,j]+"</td><td>"+totalUnit+"</td><td>??</td>");
									j=j+6+nbColYear;
								}
								break;
								// Category
						...
						switch(j){
							...
							case CompetitorMediaPlan.VEHICLE_COLUMN_INDEX:
								if(tab[i,j]!=null){
									...
									if(premierTotal){
										t.Append("\r\n\t\t<td class=\""+classe+"\">&nbsp;"+tab[i,j]+"</td><td class=\""+classe+"\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+5].ToString(),webSession.Unit)+"</td><td class=\""+classe+"\">"+((double)tab[i,j+6]).ToString("0.00")+"</td>");
										//MAJ GR : totaux par années si nécessaire
										for(k=1; k<=nbColYear; k++)
										{
											//t.Append("<td class=\""+classe+"\">"+((double)tab[i,j+6+k]).ToString("0.##")+"</td>");
											t.Append("<td class=\""+classe+"\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+6+k].ToString(),webSession.Unit)+"</td>");
										}
										//fin MAJ
									}
									else{
							...
							case CompetitorMediaPlan.CATEGORY_COLUMN_INDEX:
								if(tab[i,j]!=null){
									premierVehicle=true;
									if(premierCategory){
										t.Append("\r\n\t\t<td class=\"pmcategory\">&nbsp;"+tab[i,j]+"</td><td class=\"pmcategory\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+4].ToString(),webSession.Unit)+"</td><td class=\"pmcategory\">"+((double)tab[i,j+5]).ToString("0.00")+"</td>");
										//MAJ GR : totaux par années si nécessaire
										for(k=1; k<=nbColYear; k++)
										{
											//t.Append("<td class=\"pmcategorynb\">"+((double)tab[i,j+5+k]).ToString("0.##")+"</td>");
											t.Append("<td class=\"pmcategorynb\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+5+k].ToString(),webSession.Unit)+"</td>");
										}
										//fin MAJ
										premierCategory=false;
									}else{
										t.Append("\r\n\t\t<td class=\"pmcategoryadvertiser\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+tab[i,j]+"</td><td class=\"pmcategoryadvertiser\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+4].ToString(),webSession.Unit)+"</td><td class=\"pmcategoryadvertiser\">"+((double)tab[i,j+5]).ToString("0.00")+"</td>");
										//MAJ GR : totaux par années si nécessaire
										for(k=1; k<=nbColYear; k++)
										{
											//t.Append("<td class=\"pmcategoryadvertisernb\">"+((double)tab[i,j+5+k]).ToString("0.##")+"</td>");
											t.Append("<td class=\"pmcategoryadvertisernb\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+5+k].ToString(),webSession.Unit)+"</td>");
										}
										//fin MAJ
									}
							...
							case CompetitorMediaPlan.MEDIA_COLUMN_INDEX:
								if(tab[i,j]!=null){
									premierCategory=true;
									t.Append("\r\n\t\t<td class=\""+PLAN_MEDIA_XLS_1_CLASSE+"\">&nbsp;"+tab[i,j]+"</td><td class=\""+PLAN_MEDIA_XLS_1_CLASSE+"\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+3].ToString(),webSession.Unit)+"</td><td class=\""+PLAN_MEDIA_XLS_1_CLASSE+"\">"+((double)tab[i,j+4]).ToString("0.00")+"</td>");
									//MAJ GR : totaux par années si nécessaire
									for(k=1; k<=nbColYear; k++)
									{
										//t.Append("<td class=\""+PLAN_MEDIA_XLS_1_CLASSE+"\">"+((double)tab[i,j+4+k]).ToString("0.##")+"</td>");
										t.Append("<td class=\""+PLAN_MEDIA_XLS_1_CLASSE+"\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+4+k].ToString(),webSession.Unit)+"</td>");
									}
									j=j+4+nbColYear;
									//fin MAJ
								}
							...
							case CompetitorMediaPlan.ADVERTISER_COLUMN_INDEX:
								if(premierAdvertiser){
									t.Append("\r\n\t\t<td class=\""+PLAN_MEDIA_XLS_2_CLASSE+"\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+tab[i,j]+"</td><td class=\""+PLAN_MEDIA_XLS_2_CLASSE+"\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+2].ToString(),webSession.Unit)+"</td><td class=\""+PLAN_MEDIA_XLS_2_CLASSE+"\">"+((double)tab[i,j+3]).ToString("0.00")+"</td>");
									premierAdvertiser=false;
								}
								else{
									t.Append("\r\n\t\t<td class=\""+PLAN_MEDIA_XLS_2_CLASSE+"\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+tab[i,j]+"</td><td class=\""+PLAN_MEDIA_XLS_2_CLASSE+"\">"+WebFunctions.Units.ConvertUnitValueToString(tab[i,j+2].ToString(),webSession.Unit)+"</td><td class=\""+PLAN_MEDIA_XLS_2_CLASSE+"\">"+((double)tab[i,j+3]).ToString("0.00")+"</td>");
