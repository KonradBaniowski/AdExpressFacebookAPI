						...
						for(int i=0;i<dtVisuel.Rows.Count;i++) {
							...
							if(htValue.Count>0){
                                if (htValue.ContainsKey(dtVisuel.Rows[i]["date_media_num"])) {
                                    t.Append("<tr><td class=\"" + portofolioValue2 + "\" align=\"center\" style=\"BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none\">" + GestionWeb.GetWebWord(1398, webSession.SiteLanguage) + " : " + ((string[])htValue[dtVisuel.Rows[i]["date_media_num"]])[1] + "</td><tr>");
                                    t.Append("<tr><td class=\"" + portofolioValue2 + "\" align=\"center\" style=\"BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none\">" + GestionWeb.GetWebWord(1399, webSession.SiteLanguage) + " :" + int.Parse(((string[])htValue[dtVisuel.Rows[i]["date_media_num"]])[0]).ToString("### ### ### ###") + "</td><tr>");
                                }
                                else {
