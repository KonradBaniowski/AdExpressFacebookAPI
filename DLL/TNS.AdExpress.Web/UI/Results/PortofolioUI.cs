...
namespace TNS.AdExpress.Web.UI.Results {
    ...
    public class PortofolioUI {
        ...
        /// </summary>
        /// <param name="dateKiosque">Date de kiosque</param>
        /// <param name="dateCover">Date de couverture</param>
        /// <param name="idMedia">Identifiant du support</param>
        /// <param name="nameMedia">Nom du support</param>
        /// <param name="languageId">Identifiant de la langue</param>
        /// <returns>Code Html</returns>
        public static string GetPortofolioCreationMedia(string dateKiosque, string dateCover, string idMedia, string nameMedia, int languageId) {

            #region Variables
            string pathWeb = CstWeb.CreationServerPathes.IMAGES + "/" + idMedia + "/" + dateCover + "/imagette/";
            string path = CstWeb.CreationServerPathes.LOCAL_PATH_IMAGE + idMedia + @"\" + dateCover + @"\imagette";
