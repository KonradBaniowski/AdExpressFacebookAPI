	...
	public class ExcelWebPage: ResultWebPage{
        ...
        public static string GetExcelHeaderForCreativeMediaPlan(WebSession webSession) {
            ...
            try {
                ...
                t.Append("td.p3 {	border-left-width:0px; border-top-width:0px; border-bottom-color:#C0C0C0; border-bottom-width:1px; border-bottom-style:dotted; border-right-color:#C0C0C0; border-right-width: 1px; border-right-style:dotted; background-color: #FFFFFF; color:#FFFFFF; width:17px;}");
                t.Append("td.p4 {	border-left-width:0px; border-top-width:0px; border-bottom-color:#C0C0C0; border-bottom-width:1px; border-bottom-style:dotted; border-right-color:#C0C0C0; border-right-width: 1px; border-right-style:dotted; background-color: #808080; color:#FFFFFF; width:17px;}");
                t.Append("td.p5 { border-left-width:0px; border-top-width:0px; border-bottom-color:#C0C0C0; border-bottom-width:1px; border-bottom-style:dotted; border-right-color:#C0C0C0; border-right-width: 1px; border-right-style:dotted; background-color: #C0C0C0; color:#C0C0C0; width:17px;}");
                ...
                if (groups != null && groups.Count > 0) {
                    for (int i = 0; i < groups.Count; i++) {
                        ...
                        productLabels = new ProductClassification.PartialProductLevelListDataAccess(productLevelIdsList, webSession.SiteLanguage, webSession.CustomerLogin.Connection);
