...
{
    public class AdSloganLevelListDAL : ClassificationLevelListDAL
    {
        ...
        public AdSloganLevelListDAL(int language, IDataSource source)
        ...
        public AdSloganLevelListDAL(int language, IDataSource source, string dbSchema)
        ...
        /// <param name="language">Data language</param>
        /// <param name="source">Data source</param>
        public AdSloganLevelListDAL(string idList, int language, IDataSource source)
        ...
        /// <param name="source">Data source</param>
        /// <param name="dbSchema">Schema</param>
        public AdSloganLevelListDAL(string idList, int language, IDataSource source, string dbSchema)
