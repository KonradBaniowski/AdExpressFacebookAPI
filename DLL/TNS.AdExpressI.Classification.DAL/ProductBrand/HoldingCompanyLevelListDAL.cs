...
namespace TNS.AdExpressI.Classification.DAL.ProductBrand {
	...
	public class HoldingCompanyLevelListDAL : ClassificationLevelListDAL {
        ...
        /// <param name="language">Data language</param>
        /// <param name="source">Data source</param>
        public HoldingCompanyLevelListDAL(int language, IDataSource source, string dbSchema)
            : base(DetailLevelItemsInformation.Get(DetailLevelItemInformation.Levels.holdingCompany), language, source, dbSchema)
        {
        }
        ...
        /// <param name="language">Data language</param>
        /// <param name="source">Data source</param>
        public HoldingCompanyLevelListDAL(string idList, int language, IDataSource source, string dbSchema)
            : base(DetailLevelItemsInformation.Get(DetailLevelItemInformation.Levels.holdingCompany), idList, language, source, dbSchema)
        {
        }
		#endregion
	}
