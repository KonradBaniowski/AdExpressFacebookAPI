...
using TNS.AdExpress.Anubis.HermesRadioTv.Exceptions;

namespace TNS.AdExpress.Anubis.HermesRadioTv.DataAccess{
	/// <summary>
	/// Classe du chargement de la configuration du fichier de config du plugin Hermes Radio TV
	/// </summary>
