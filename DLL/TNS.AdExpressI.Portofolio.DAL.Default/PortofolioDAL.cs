...
namespace TNS.AdExpressI.Portofolio.DAL.Default {
    ...
    public class PortofolioDAL:AbsctractDAL.PortofolioDAL {
        ...
        public PortofolioDAL(WebSession webSession,DBClassificationConstantes.Vehicles.names vehicleName,string beginingDate,string endDate):base(webSession,vehicleName,beginingDate,endDate) {
