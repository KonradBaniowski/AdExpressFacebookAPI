...
namespace TNS.AdExpressI.Insertions.Turkey.CreativeResult
{
    public class CreativePopUp : Insertions.CreativeResult.CreativePopUp
    {
        ...
        {
            SetDAL();
            _associated_file = _idSlogan;
                //_vehicleInformation == null ? _dal.GetVersionMinParutionDate(_idSlogan, VehiclesInformation.Get(_vehicle)) : _dal.GetVersionMinParutionDate(_idSlogan, _vehicleInformation);
