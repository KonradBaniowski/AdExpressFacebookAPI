...
namespace TNS.AdExpressI.MediaSchedule.Style
{
    #region Base Class
    /// <summary>
    /// Define styles used in MediaSchedule
    /// </summary>
    public abstract class MediaScheduleStyle
    {
        #region Properties
    ...
    #region Default Media Schedule
    /// <summary>
    /// Defines Defautl Media Schedule Styles
    /// </summary>
    public class DefaultMediaScheduleStyle:MediaScheduleStyle
    {
        ...
        /// Default Constructor
        /// </summary>
        public DefaultMediaScheduleStyle():base()
        {
    ...
    #region PDF Media Schedule
    /// <summary>
    /// Defines Media Schedule Styles for PDF export
    /// </summary>
    public class PDFMediaScheduleStyle : MediaScheduleStyle
    {
        ...
        /// Default Constructor
        /// </summary>
        public PDFMediaScheduleStyle():base()
        {
    ...
    #region Excel Media Schedule
    /// <summary>
    /// Defines Media Schedule Styles for Excel export
    /// </summary>
    public class ExcelMediaScheduleStyle : MediaScheduleStyle
    {
        ...
        /// Default Constructor
        /// </summary>
        public ExcelMediaScheduleStyle()
        {
            NoDataDiv = "txtViolet11Bold";
            VersionCell0 = "pc0;";
            CellNotPresent = "p3X";
