...
namespace TNS.AdExpress.Anubis.Thoueris.DataAccess
{
	/// <summary>
    /// Selket Config DataAccess provide access to the configuration data
	/// </summary>
    public class ThouerisConfigDataAccess
    {
		/// <summary>
		/// Load Anubis configuration
		/// </summary>
		/// <param name="dataSource">Data Source</param>
        internal static void Load(IDataSource dataSrc, ThouerisConfig cfg)
        {
			...
			try{
                ...
                throw (new ThouerisConfigDataAccessException("Unable to load Thoueris configuration", err));
			}
		}
	}
}
