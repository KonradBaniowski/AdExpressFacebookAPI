...
{
    public class CellCreativesOutdoorInformation : TNS.AdExpressI.Insertions.Russia.Cells.CellCreativesInformation
    {
        #region Constructor
        /// <summary>
        /// Constructeur
        ...
        public CellCreativesOutdoorInformation(WebSession session, VehicleInformation vehicle, List<GenericColumnItemInformation> columns, List<string> columnNames, List<Cell> cells, TNS.AdExpress.Domain.Web.Navigation.Module module)
        ...
        /// </summary>
        /// <param name="label">Texte</param>
        public CellCreativesOutdoorInformation(WebSession session, VehicleInformation vehicle, List<GenericColumnItemInformation> columns, List<string> columnNames, List<Cell> cells, TNS.AdExpress.Domain.Web.Navigation.Module module, Int64 idColumnsSet)
