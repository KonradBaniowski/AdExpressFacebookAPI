...
namespace TNS.AdExpress.Web.Helper.DataAccess
{
    ...
    public class SynthesisDataAccess
    {
        ...
        public static DataSet GetData(WebSession webSession, IDataSource dataSource, int dateBegin, int dateEnd, Int64 baseTarget, Int64 additionalTarget, Int64 idProduct, bool mediaAgencyAccess)
        {
            ...
            sql.Append(Core.Utilities.SQLGenerator.GetClassificationCustomerProductRight(webSession, DBTables.WEB_PLAN_PREFIXE, true, module.ProductRightBranches));
            ...
            {
                throw (new SynthesisDataAccessException("GetData:: Error while executing the query for the Synthesis APPM ", err));
            }
            #endregion
        ...
        public static DataSet GetData(WebSession webSession, IDataSource dataSource, int dateBegin, int dateEnd, Int64 baseTarget, Int64 additionalTarget, bool mediaAgencyAccess, string idVersion)
        {
            ...
            //Media Universe
            sql.Append(Core.Utilities.SQLGenerator.GetResultMediaUniverse(webSession, DBTables.DATA_PRESS_APPM_PREFIXE));

            //all results without inset
            sql.Append(" and " + DBTables.DATA_PRESS_APPM_PREFIXE + ".id_inset is null ");

            //media rights
            sql.Append(Core.Utilities.SQLGenerator.getAnalyseCustomerMediaRight(webSession, DBTables.DATA_PRESS_APPM_PREFIXE, true));
            //product rights
            TNS.AdExpress.Domain.Web.Navigation.Module module = TNS.AdExpress.Domain.Web.Navigation.ModulesList.GetModule(webSession.CurrentModule);
            sql.Append(Core.Utilities.SQLGenerator.GetClassificationCustomerProductRight(webSession, DBTables.DATA_PRESS_APPM_PREFIXE, true, module.ProductRightBranches));
            ...
            {
                throw (new SynthesisDataAccessException("GetData:: Error while executing the query for the Synthesis by Version for APPM ", err));
            }
            #endregion
        }
        ...
        public static DataSet UniversGroupInvestment(WebSession webSession, IDataSource dataSource, int dateBegin, int dateEnd, Int64 baseTarget, Int64 additionalTarget, string idGroup)
        {
            ...
            {
                throw (new SynthesisDataAccessException("UniversGroupInvestment:: Error while executing the query for the Synthesis APPM ", err));
            }
        ...
        public static DataSet GetProductInvestment(WebSession webSession, IDataSource dataSource, int dateBegin, int dateEnd, Int64 baseTarget, string idProduct)
        {
            ...
            //Media Universe
            sql.Append(Core.Utilities.SQLGenerator.GetResultMediaUniverse(webSession, DBConstantes.Tables.DATA_PRESS_APPM_PREFIXE));
            ...
            {
                throw (new SynthesisDataAccessException("GetInvestment:: Error while executing the query for the Version Synthesis APPM ", err));
            }
