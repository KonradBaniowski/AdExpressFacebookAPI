    ...
    public class Functions
    {
        ...
        public static string GetRadioInsertionsOrder(int indexColumnToSort)
        {
            switch (indexColumnToSort)
            {
                ...
                default: throw new FunctionsDataAccessException(" GetRadioInsertionsOrder : Impossible de déterminer la colonne à trier.");
            }
        ...
        public static string GetTvInsertionsOrder(int indexColumnToSort)
        {
            switch (indexColumnToSort)
            {
                ...
                default: throw new FunctionsDataAccessException(" GetTvInsertionsOrder : Impossible de déterminer la colonne à trier.");
            }
        ...
        public static bool IsBelongToTvNatThematiques(WebSession webSession, string idMedia)
        {
            ...
            {
                throw (new FunctionsDataAccessException("Impossible de déterminer si le média appartient aux thématiques TV: " + t, err));
            }
            #endregion
        ...
        public static string SumMonthlyExpenditureEuroToString(WebSession webSession, bool comparativeStudy, bool onlyComparativeMonthString)
        {
            ...
            DateTime PeriodBeginningDate = Core.Utilities.Dates.GetPeriodBeginningDate(webSession.PeriodBeginningDate, webSession.PeriodType);
            DateTime PeriodEndDate = Core.Utilities.Dates.GetPeriodEndDate(absolutEndPeriod, webSession.PeriodType);
            #endregion

            #region dates (mensuels) des investissements 
            int StartMonth = PeriodBeginningDate.Month;
            int EndMonth = PeriodEndDate.Month;
            Core.Utilities.Dates.GetYearSelected(webSession, ref YearSelected, ref year, PeriodBeginningDate);
        ...
        public class RecapUniversSelection
        {
            ...
            public RecapUniversSelection(WebSession webSession)
            {
                ...
                if (Core.Utilities.CheckedText.IsNotEmpty(_competitorAdvertiserAccessList))
                {
                    if (Core.Utilities.CheckedText.IsNotEmpty(AdvertiserAccessList)) _advertiserAccessList += "," + CompetitorAdvertiserAccessList;
