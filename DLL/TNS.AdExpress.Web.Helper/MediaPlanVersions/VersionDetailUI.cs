...
namespace TNS.AdExpress.Web.Helper.MediaPlanVersions
{
    ...
    public class VersionDetailUI
    {
        ...
        public virtual void GetHtml(StringBuilder output)
        {
            ...
            TNS.AdExpress.Web.Core.Utilities.Creatives creativesUtilities = (TNS.AdExpress.Web.Core.Utilities.Creatives)AppDomain.CurrentDomain.CreateInstanceFromAndUnwrap(AppDomain.CurrentDomain.BaseDirectory + @"Bin\" + cl.AssemblyName, cl.Class, false, BindingFlags.CreateInstance | BindingFlags.Instance | BindingFlags.Public, null, null, null, null);
        ...
        public virtual void GetHtmlPressExport(StringBuilder output, Int64 index, bool withDetail)
        {
            ...
            if (withDetail)
            {
                ...
                if (_showProduct) output.Append("<tr valign=\"top\"><td>&nbsp;" + GestionWeb.GetWebWord(468, _webSession.SiteLanguage) + "</td><td>: " + Convertion.ToHtmlString(this._exportVersion.Product) + "</td></tr>");
        ...
        public virtual void GetHtmlAPPMExport(StringBuilder output, Int64 index, bool withDetail)
        {
            ...
            if (_showProduct)
            {
                ...
                if (TNS.AdExpress.Web.Core.Utilities.CheckedText.IsNotEmpty(idProductString))
                {
            ...
            if (withDetail)
            {
                ...
                //Nom du Produit
                if (_showProduct) output.Append("<tr valign=\"top\"><td nowrap>&nbsp;&nbsp;" + Convertion.ToHtmlString(GestionWeb.GetWebWord(1418, _webSession.SiteLanguage)) + "</td><td nowrap> : &nbsp;&nbsp;&nbsp;" + Convertion.ToHtmlString(this._exportAPPMVersion.Product) + "</td></tr>");
                //Nom de la marque
        ...
        public virtual void GetHtmlOutdoorExport(StringBuilder output, Int64 index, bool withDetail)
        {
            ...
            if (withDetail)
            {
                ...
                if (_showProduct) output.Append("<tr valign=\"top\"><td>&nbsp;" + GestionWeb.GetWebWord(468, _webSession.SiteLanguage) + "</td><td>: " + Convertion.ToHtmlString(this._exportOutdoorVersion.Product) + "</td></tr>");
