    ...
    public class WebLanguagesXL {
        ...
        internal static Dictionary<Int64, WebLanguage> LoadLanguages(IDataSource dataSource) {
                    ...
                    if (reader.NodeType == XmlNodeType.Element) {
                        ...
                        switch (reader.LocalName) {
                            case "language":
                                ...
                                languages.Add(id, new WebLanguage(id, name, imageSourceText, localization, classificationLanguageId, charset, contentEncoding, cInfo));
                                break;
                            case "unitformat":
            ...
            #region Error Management
                ...
                if (dataSource.GetSource() != null) dataSource.Close();
                #endregion
                throw (new WebLanguagesXLException(" Impossible to load configuration file : ", err));
            }
            #endregion
