...
namespace TNS.AdExpress.Anubis.Satet.UI
{
	...
	public class AnalyseFamilyInterestPlan
	{
		...
		private static void GRPTreatment(Excel excel, WebSession webSession, DataTable analyseFamilyInterestPlanData){
			int s=1;
		...
		/// <param name="excel">excel</param>
		/// <param name="periodicityPlanData">source de données</param>
		private static void SimpleTreatment(Excel excel, WebSession webSession, DataTable analyseFamilyInterestPlanData){
			int s=1;
			int nbMaxRowByPage=42;		
			int upperLeftColumn=8;
			string vPageBreaks="";
