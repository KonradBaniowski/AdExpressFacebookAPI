			...
			try {
				...
				switch (type) {
					...
					case DBConstantes.TableType.Type.dataVehicle:
						dataTableName = SQLGenerator.GetVehicleTableSQLForDetailResult(_vehicleInformation.Id, WebConstantes.Module.Type.analysis, _webSession.IsSelectRetailerDisplay);
						break;
