...
namespace TNS.AdExpress.Constantes.Web{
	...
	#region Constantes des fichiers de configuration
	/// <summary>
	/// Classe définnissant le chemin d'accès au fichier xml
	/// </summary>
	public class ConfigurationFile{
		/// <summary>
		/// Fichier ModulesConfiguration.xml
		/// </summary>
		//public const string MODULE_CONFIGURATION_PATH="C:\\arnaud\\Module\\Module\\ModulesConfiguration.xml";
		public const string MODULE_CONFIGURATION_PATH="ModulesConfiguration.xml";
		/// <summary>
		/// Fichier ModuleCategory.xml
		/// </summary>
		public const string MODULE_CATEGORY_CONFIGURATION_PATH="ModuleCategory.xml";
		/// <summary>
		/// Fichier de configuration des entêtes HeaderConfiguration.xml
		/// </summary>
		public const string HEADER_CONFIGURATION_PATH="HeaderConfiguration.xml";
		/// <summary>
		/// Generic detail levels file path
		/// </summary>
		public const string GENERIC_DETAIL_LEVEL_ITEMS_CONFIGURATION_PATH=@"config\GenericDetailLevel.xml";
		/// <summary>
		/// Generic levels file path
		/// </summary>
		public const string GENERIC_DETAIL_LEVEL_CONFIGURATION_PATH=@"config\GenericDetailLevel.xml";
		/// <summary>
		/// AdNetTrack levels file path
		/// </summary>
		public const string ADNETTRACK_DETAIL_LEVEL_CONFIGURATION_PATH=@"config\AdNetTrackDetailLevel.xml";
		/// <summary>
		/// Fichier de configuration des colonnes GenericColumn.xml
		/// </summary>
		public const string GENERIC_COLUMNS_ITEMS_CONFIGURATION_PATH=@"config\GenericColumn.xml";
		/// <summary>
		/// Fichier de configuration des colonnes MediaPlanInsertionConfiguration.xml
		/// </summary>
		public const string MEDIA_PLANS_INSERTION_CONFIGURATION_COLUMNS_ITEMS_CONFIGURATION_PATH=@"config\MediaPlanInsertionConfiguration.xml";

		/// <summary>
		/// Fichier de configuration de Link server LinkClient.xml
		/// </summary>
		public const string LINK_CLIENT_CONFIGURATION_PATH=@"config/LinkClient.xml";

		/// <summary>
		/// Fichier de configuration des Css
		/// </summary>
		public const string CSS_CONFIGURATION_PATH=@"config/CssConfiguration.xml";
        /// <summary>
        /// Fichier de configuration des colonnes PortofolioDetailMediaConfiguration.xml
        /// </summary>
        public const string PORTOFOLIO_DETAIL_MEDIA_CONFIGURATION = @"config\PortofolioDetailMediaConfiguration.xml";
		/// <summary>
		/// Fichier de configuration des niveaux d'univers 
		/// </summary>
		public const string UNIVERSE_LEVELS_CONFIGURATION_PATH = @"config\UniverseLevels.xml";
		/// <summary>
		...
		/// </summary>
		public const string UNIVERSE_LEVELS_CUSTOM_STYLES_CONFIGURATION_PATH = @"config\UniverseLevelsCustomStyles.xml";
		/// <summary>
