...
namespace TNS.AdExpress.Web.Core.Utilities
{
	...
	public class HtmlFunctions
    {
        ...
        public static string GetPeriodDetail(WebSession webSession)
        {
            ...
            {
                throw (new FunctionsException("Unable to generate the html code for period detail", e));
            }
        }
        ...
        public static string GetZoomPeriodDetail(WebSession webSession, string zoomDate)
        {
            ...
            try
            {
                ...
                switch (webSession.DetailPeriod)
                {
                    case CustomerSessions.Period.DisplayLevel.weekly:
                        ...
                        str += Dates.DateToString(begin.Date, webSession.SiteLanguage);// begin.Date.ToString("dd/MM/yyyy");
                        str += " " + GestionWeb.GetWebWord(897, webSession.SiteLanguage) + "";
                        str += " " + Dates.DateToString(end.Date, webSession.SiteLanguage) + "";//end.Date.ToString("dd/MM/yyyy")
                        return str;
                    case CustomerSessions.Period.DisplayLevel.monthly:
                        ...
                        return Convertion.ToHtmlString(GestionWeb.GetWebWord(896, webSession.SiteLanguage) + " " + Dates.DateToString(begin, webSession.SiteLanguage) + " " + GestionWeb.GetWebWord(897, webSession.SiteLanguage) + " " + FctUtilities.Dates.DateToString(end, webSession.SiteLanguage));
                    default:
                        return "";
                }
            }
            ...
            {
                throw (new FunctionsException("Unable to generate the html code for zoom period detail", e));
            }
        ...
        public static string GetStudyPeriodDetail(WebSession webSession, long moduleId)
        {
            try
            {
                ...
                {
                    dateBegin = FctUtilities.Dates.YYYYMMDDToDD_MM_YYYY2(webSession.CustomerPeriodSelected.StartDate.ToString(), webSession.SiteLanguage);
                    dateEnd = FctUtilities.Dates.YYYYMMDDToDD_MM_YYYY2(webSession.CustomerPeriodSelected.EndDate.ToString(), webSession.SiteLanguage);
                }
            ...
            {
                throw (new FunctionsException("Unable to generate the html code for study period detail", e));
            }
        }
        ...
        public static string GetComparativePeriodDetail(WebSession webSession, long moduleId)
        {
            ...
            {
                throw (new FunctionsException("Unable to generate the html code for comparative period type detail", e));
            }
        }
        ...
        public static string GetPeriodDisponibilityTypeDetail(WebSession webSession)
        {
            ...
            {
                throw (new FunctionsException("Unable to generate the html code for period disponibility type detail", e));
            }
        }
        ...
        public static string GetPeriodDetailForExcel(WebSession webSession)
        {
            ...
            {
                throw (new FunctionsException("Unable to generate the excel code for period detail", e));
            }
        }
