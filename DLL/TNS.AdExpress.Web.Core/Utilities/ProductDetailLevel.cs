...
namespace TNS.AdExpress.Web.Core.Utilities
{
	...
	public class ProductDetailLevel{
        ...
        public virtual WebConstantes.CustomerSessions.PreformatedDetails.PreformatedProductDetails GetDefaultPreformatedProductDetails(WebSession webSession)
        {
		...
		public static int GetLevelNumber(WebSession webSession){
			return((ProductDetailLevel.LevelProductToHtmlString(webSession)).Split('/').Length);
		}
		...
		public static string LevelProductToHtmlString(WebSession webSession){
			try{
				switch(webSession.PreformatedProductDetail){
                    ...
                    case WebConstantes.CustomerSessions.PreformatedDetails.PreformatedProductDetails.brandProduct:
                        return (GestionWeb.GetWebWord(2736, webSession.SiteLanguage));
		...
		public static bool CanCustomizeUniverseSlogan(WebSession webSession) {
			...
			if (webSession.PrincipalProductUniverses != null && webSession.PrincipalProductUniverses.Count>0 && 
                ...
                webSession.PrincipalProductUniverses[0].ContainsLevel(TNSClassificationLevels.SUB_BRAND, AccessType.includes) ||
