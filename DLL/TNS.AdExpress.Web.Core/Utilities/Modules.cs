    ...
    public class Modules
    {
        ...
        public static void LoadModuleStudyPeriodDates(WebSession webSession, WebSession webSessionSave)
        {
            ...
            if (selectedVehicle == VehiclesInformation.EnumToDatabaseId(DBClassificationConstantes.Vehicles.names.internet))
                lastCompleteMonth = TNS.AdExpress.Web.Core.DataAccess.Selections.Medias.MediaPublicationDatesDataAccess.GetLatestPublication(webSessionSave, WebConstantes.CustomerSessions.Period.DisplayLevel.monthly, WebConstantes.Module.Type.analysis, selectedVehicle);
            ...
            switch (webSessionSave.PeriodType)
            {
                ...
                case CstCustomerSession.Period.Type.nLastMonth:
                    ...
                    if (selectedVehicle == VehiclesInformation.EnumToDatabaseId(DBClassificationConstantes.Vehicles.names.internet))
                    {
                        ...
                        Dates.LastLoadedMonth(ref downloadBeginningDate, ref downloadEndDate, CstPeriodType.nLastMonth);
                ...
                case CstCustomerSession.Period.Type.currentYear:
                    ...
                    if (selectedVehicle == VehiclesInformation.EnumToDatabaseId(DBClassificationConstantes.Vehicles.names.internet))
                    {
                        ...
                        if (DateTime.Now.Month == 1)
                        {
                            ...
                            Dates.DownloadDates(webSessionSave, ref downloadBeginningDate, ref downloadEndDate, CstPeriodType.currentYear);
                ...
                case CstCustomerSession.Period.Type.nLastWeek:
                    ...
                    Dates.LastLoadedWeek(ref downloadBeginningDate, ref downloadEndDate);
                ...
                case CstCustomerSession.Period.Type.previousYear:
                    ...
                    if (selectedVehicle == VehiclesInformation.EnumToDatabaseId(DBClassificationConstantes.Vehicles.names.internet))
                    {
                        ...
                        //Dates de chargement des données pour les autres médias										
                        Dates.DownloadDates(webSessionSave, ref downloadBeginningDate, ref downloadEndDate, CstPeriodType.previousYear);
                        webSession.PeriodBeginningDate = downloadBeginningDate;
                        webSession.PeriodEndDate = downloadEndDate;
                    }
                    webSession.DetailPeriod = CstPeriodDetail.monthly;
