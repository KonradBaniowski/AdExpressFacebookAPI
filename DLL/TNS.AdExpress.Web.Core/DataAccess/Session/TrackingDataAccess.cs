...
namespace TNS.AdExpress.Web.Core.DataAccess.Session{
	...
	public class TrackingDataAccess {
		...
		public static void NewConnection(IDataSource source,Int64 sessionId,Int64 loginId,string IP){
			...
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_event,value_string,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId.ToString()+","+loginId.ToString()+","+TrackingConstantes.Event.Type.newConnection.GetHashCode().ToString()+",'"+IP+"',sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
		...
		public static void SetModule(IDataSource source,Int64 sessionId,Int64 loginId,Int64 ModuleId){
			...
			#region Request construction
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_event,value,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId.ToString()+","+loginId.ToString()+","+TrackingConstantes.Event.Type.setModule.GetHashCode().ToString()+","+ModuleId+",sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
		...
		public static void SetPeriodType(IDataSource source,Int64 sessionId,Int64 loginId,Int64 ModuleId,int periodTypeId){
			...
			#region Request construction
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_module,id_event,value,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId+","+loginId+","+ModuleId+","+TrackingConstantes.Event.Type.setPeriodType.GetHashCode()+","+periodTypeId+",sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
		...
		public static void SetUnit(IDataSource source,Int64 sessionId,Int64 loginId,Int64 ModuleId,int unitTypeId){
			...
			#region Request construction
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_module,id_event,value,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId+","+loginId+","+ModuleId+","+TrackingConstantes.Event.Type.setUnit.GetHashCode()+","+unitTypeId+",sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
		...
		public static void SetResult(IDataSource source,Int64 sessionId,Int64 loginId,Int64 ModuleId,Int64 resultId){
			...
			//Int64 currentResultId=((ResultPageInformation) moduleSelected.ResultsPages[int.Parse(currentTab.ToString())]).ResultID;
			#region Request construction
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_module,id_event,value,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId+","+loginId+","+ModuleId+","+TrackingConstantes.Event.Type.setResult.GetHashCode()+","+resultId+",sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
		...
		public static void UseGad(IDataSource source,Int64 sessionId,Int64 loginId,Int64 ModuleId,Int64 resultId){
			...
			#region Request construction
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_module,id_result,id_event,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId+","+loginId+","+ModuleId+","+resultId+","+TrackingConstantes.Event.Type.useGad.GetHashCode()+",sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
		...
		public static void UseMyAdExpressSave(IDataSource source,Int64 sessionId,Int64 loginId,Int64 ModuleId,Int64 resultId){
			...
			#region Request construction
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_module,id_result,id_event,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId+","+loginId+","+ModuleId+","+resultId+","+TrackingConstantes.Event.Type.useMyAdExpressSave.GetHashCode()+",sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
		...
		public static void UseFileExport(IDataSource source,Int64 sessionId,Int64 loginId,Int64 ModuleId,Int64 resultId){
			...
			#region Request construction
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_module,id_result,id_event,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId+","+loginId+","+ModuleId+","+resultId+","+TrackingConstantes.Event.Type.useFileExport.GetHashCode()+",sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
		...
		public static void SetMediaAgency(IDataSource source,Int64 sessionId,Int64 loginId,Int64 ModuleId,Int64 resultId){
			...
			#region Request construction
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_module,id_result,id_event,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId+","+loginId+","+ModuleId+","+resultId+","+TrackingConstantes.Event.Type.setMediaAgency.GetHashCode()+",sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
		...
		public static void SetVehicle(IDataSource source,Int64 sessionId,Int64 loginId,Int64 ModuleId,Int64 vehicleId){
			...
			#region Request construction
			string sql="insert into "+DBSchemas.UNIVERS_SCHEMA+"."+DBTables.TRACKING+" (id_tracking,id_nav_session,id_login,id_module,id_event,value,date_creation,date_modification,activation) values ";
			sql+="("+DBSchemas.UNIVERS_SCHEMA+".seq_"+DBTables.TRACKING+".nextval,"+sessionId+","+loginId+","+ModuleId+","+TrackingConstantes.Event.Type.setVehicle.GetHashCode()+","+vehicleId+",sysdate,sysdate,"+DBActivation.ACTIVATED+")";
			#endregion
