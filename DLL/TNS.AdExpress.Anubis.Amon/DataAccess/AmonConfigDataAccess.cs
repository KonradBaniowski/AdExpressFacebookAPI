...
namespace TNS.AdExpress.Anubis.Amon.DataAccess
{
	/// <summary>
    /// Amon Config DataAccess provide access to the configuration data
	/// </summary>
    public class AmonConfigDataAccess
    {
		/// <summary>
		/// Load Anubis configuration
		/// </summary>
		/// <param name="dataSource">Data Source</param>
        internal static void Load(IDataSource dataSrc, AmonConfig cfg)
        {
			...
			try{
                ...
                throw (new AmonConfigDataAccessException("Unable to load Amon configuration", err));
			}
		}
	}
}
