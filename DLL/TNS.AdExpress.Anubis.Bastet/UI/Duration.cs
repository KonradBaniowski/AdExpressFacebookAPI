...
{
	/// <summary>
	/// Description résumée de Duration.
	/// </summary>
	public class Duration
	{
		...
		internal static Workbook ConnexionAverage(Workbook excel,BastetCommon.Parameters parameters,int language) {
			try{
				...
				throw (new BastetExceptions.DurationUIException(" ConnexionAverage : Impossible d'afficher Durée moyenne des connections par clients ", err));
			}
			return excel;
