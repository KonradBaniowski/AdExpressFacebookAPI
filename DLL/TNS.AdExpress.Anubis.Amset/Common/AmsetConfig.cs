...
namespace TNS.AdExpress.Anubis.Amset.Common{
	/// <summary>
	/// Static class containing every cofiguration elements for the Amset Plug-in
	/// </summary>
	public class AmsetConfig{
		...
		public AmsetConfig(IDataSource source){
			try{
				DataAccess.AmsetConfigDataAccess.Load(source,this);
			}
