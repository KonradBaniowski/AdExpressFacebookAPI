...
namespace TNS.AdExpress.DataAccess.Classification.MediaBranch {
	...
	public class PartialCategoryListDataAccess:ClassificationLevelListDataAccess{
		...
		public PartialCategoryListDataAccess(string codeList,IDataSource source):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.category,codeList,DBConstantes.Language.FRENCH,source){
		}
		...
		public PartialCategoryListDataAccess(string codeList,int language,IDataSource source):base(TNS.AdExpress.Constantes.Classification.DB.Table.name.category,codeList,language,source){
		}
