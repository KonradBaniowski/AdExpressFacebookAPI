...
namespace TNS.AdExpress.Anubis.Selket.DataAccess
{
	/// <summary>
    /// Selket Config DataAccess provide access to the configuration data
	/// </summary>
    public class SelketConfigDataAccess
    {
		/// <summary>
		/// Load Anubis configuration
		/// </summary>
		/// <param name="dataSource">Data Source</param>
		internal static void Load(IDataSource dataSrc, SelketConfig cfg){
			...
			try{
                ...
                throw (new SelketConfigDataAccessException("Unable to load Selket configuration", err));
			}
		}
	}
}
