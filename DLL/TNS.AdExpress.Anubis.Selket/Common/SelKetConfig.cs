...
using TNS.AdExpress.Anubis.Selket.DataAccess;
using TNS.FrameWork.DB.Common;

namespace TNS.AdExpress.Anubis.Selket.Common
{
	/// <summary>
    /// Static class containing every cofiguration elements for the SelketConfig Plug-in
	/// </summary>
	public class SelketConfig{
        ...
        public SelketConfig(IDataSource dataSource)
        {
			try{
				SelketConfigDataAccess.Load(dataSource,this);
			}
