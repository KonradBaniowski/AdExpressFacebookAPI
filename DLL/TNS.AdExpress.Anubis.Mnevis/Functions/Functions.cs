...
namespace TNS.AdExpress.Anubis.Mnevis.Functions {
    ...
    class Functions {
        ...
        public static StreamWriter GetHtmlFile(string path, WebSession webSession, string serverName) {
            ...
            try {
                ...
                throw (new MnevisPdfException("Unable to create html file.", e));
            }
        }
        ...
        public static void CloseHtmlFile(StreamWriter sw) {
            ...
            try {
                ...
                throw (new MnevisPdfException("Unable to close the html file stream.", e));
            }
        }
        #endregion
