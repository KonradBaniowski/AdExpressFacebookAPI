...
using TNS.AdExpress.Anubis.Mnevis.DataAccess;
using TNS.FrameWork.DB.Common;

namespace TNS.AdExpress.Anubis.Mnevis.Common
{
	/// <summary>
	/// Static class containing every cofiguration elements for the Mnevis Plug-in
	/// </summary>
	public class MnevisConfig {
		...
		public MnevisConfig(IDataSource dataSource) {
			try {
				MnevisConfigDataAccess.Load(dataSource,this);
			}
