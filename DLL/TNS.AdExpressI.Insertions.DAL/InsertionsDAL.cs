...
/* Get the table name for a specific vehicle and depending on the module type
        ...
        #region CountInsertionsData

        public long CountInsertionsData(VehicleInformation vehicle, int fromDate, int toDate, int universId, string filters)
        {
            /* (False if we're using InsertionDAL to get informations about insertions)
             * */
            _creaConfig = false;
            return CountData(vehicle, fromDate, toDate, universId, filters);
        }

        #endregion

        /// <summary>
        /// Count insertions details 
        /// </summary>
        /// <param name="vehicle">Vehicle Information</param>
        /// <param name="fromDate">Beginning of the period</param>
        /// <param name="toDate">End of the period</param>
        ...
        /// </param>
        /// <returns>Advertising detail Data</returns>		
        protected virtual long CountData(VehicleInformation vehicle, int fromDate, int toDate, int universId, string filters)
        {
            ...
            try
            {
                ...
                // Select
                sql.Append(" select count(*) as NbROWS ");
                // Append data fields
            ...
            {
                throw new InsertionsDALException($"Unable to load data for insertions details: {sql.ToString()}", err);
            }
