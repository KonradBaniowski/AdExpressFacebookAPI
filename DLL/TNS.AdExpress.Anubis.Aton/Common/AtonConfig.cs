...
using TNS.AdExpress.Anubis.Aton.DataAccess;
using TNS.FrameWork.DB.Common;

namespace TNS.AdExpress.Anubis.Aton.Common{
	/// <summary>
	/// Static class containing every cofiguration elements for the Aton Plug-in
	/// </summary>
	public class AtonConfig{
		...
		public AtonConfig(IDataSource dataSource){
			try{
				AtonConfigDataAccess.Load(dataSource,this);
			}
