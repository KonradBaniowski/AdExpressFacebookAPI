...
namespace TNS.AdExpress.Anubis.Aton.Functions{
	...
	public class Functions{
		...
		public static StreamWriter GetHtmlFile(string path){
			try{
				if (!File.Exists(path)){
					...
					sw.WriteLine("<LINK href=\"http://"+TNS.AdExpress.Anubis.Constantes.Result.CSS_LINK+"/Css/AdExpress.css\" type=\"text/css\" rel=\"stylesheet\">");
					sw.WriteLine("<LINK href=\"http://"+TNS.AdExpress.Anubis.Constantes.Result.CSS_LINK+"/Css/GenericUI.css\" type=\"text/css\" rel=\"stylesheet\">");
