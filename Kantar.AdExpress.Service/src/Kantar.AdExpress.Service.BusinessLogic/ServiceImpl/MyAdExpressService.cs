    ...
    public class MyAdExpressService : IMyAdExpressService
    {
        ...
        private AdExpressResponse LoadSessionInfo(string idSession, WebSession webSession)
        {
            ...
            try
            {
                ...
                bool enableTracking = webSession.EnableTracking;
                bool enableTroubleshooting = webSession.EnableTroubleshooting;
                    ...
                    switch (webSessionSave.CurrentModule)
                    {
                        ...
                        case ModuleName.ANALYSE_DES_DISPOSITIFS:
                            ...
                            else if (validModule)
                            {
                                if (validResultPage)
                                {
                                    webSession.EnableTracking = enableTracking;
                                    webSession.EnableTroubleshooting = enableTroubleshooting;
                                    webSession.Save();
