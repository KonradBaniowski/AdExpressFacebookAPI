...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    liveSearch: false,
    actionsBox: false,
    iconBase: 'icobeemusic',
    tickIcon: 'icon-checkbox-checked',
    tickIconunchecked: 'icon-checkbox-unchecked',
    maxOptions: false,
    mobile: false,
    selectOnTab: false,
  ...
  Selectpicker.prototype = {
    ...
    createLi: function () {
      ...
      var generateA = function (text, classes, inline, optgroup) {
        var normText = normalizeToBase(htmlEscape(text));
          ...
          if (that.multiple)
              html = html + '<span class="' + that.options.iconBase + ' ' + that.options.tickIconunchecked + ' uncheck-mark"></span>';
          html = html + '</a>';
      ...
      this.$menu.on('click', 'li a', function (e) {
        ...
        if (!that.isDisabled() && !$this.parent().hasClass('disabled')) {
          ...
          if ((prevValue != that.$element.val() && that.multiple) || (prevIndex != that.$element.prop('selectedIndex') && !that.multiple)) {
              ...
              if (typeof that.options.callbackclick != "undefined")
                that.options.callbackclick();
          }
        }
      });
    ...
    deselectAll: function () {
      this.findLis();
      this.$lis.not('.divider').not('.disabled').filter('.selected')//.filter(':visible')
          .find('a').click();
    },
