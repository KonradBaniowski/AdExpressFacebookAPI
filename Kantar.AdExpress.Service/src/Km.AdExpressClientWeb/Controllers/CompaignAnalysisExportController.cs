...
{
    public class CompaignAnalysisExportController : Controller
    {
        ...
        public CompaignAnalysisExportController(ICampaignAnalysisService campaignAnalysisService, IMediaService mediaService, IWebSessionService webSessionService, IDetailSelectionService detailSelectionService)
        {
        ...
        public ActionResult Index(ResultTable.SortOrder sortOrder, int columnIndex)
        {
            ...
            ResultTable data = _campaignAnalysisService.GetResultTable(idWebSession);
