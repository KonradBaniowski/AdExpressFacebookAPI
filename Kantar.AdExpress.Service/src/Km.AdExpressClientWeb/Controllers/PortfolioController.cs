...
namespace Km.AdExpressClientWeb.Controllers
{
    ...
    public class PortfolioController : Controller
    {
        ...
        public JsonResult PortfolioResult()
        {
            ...
            var gridResult = _portofolioService.GetGridResult(idWebSession, this.HttpContext);
            ...
            try
            {
                ...
                var obj = new { datagrid = jsonData, columns = gridResult.Columns, schema = gridResult.Schema, columnsfixed = gridResult.ColumnsFixed, columnsNotAllowedSorting = gridResult.ColumnsNotAllowedSorting, needfixedcolumns = gridResult.NeedFixedColumns, isonecolumnline = gridResult.isOneColumnLine };
        ...
        public ActionResult PortfolioGraphResult()
        {
            ...
            var claim = new ClaimsPrincipal(User.Identity);
            string idWebSession = claim.Claims.Where(e => e.Type == ClaimTypes.UserData).Select(c => c.Value).SingleOrDefault();
            var gridResult = _portofolioService.GetGraphGridResult(idWebSession, this.HttpContext);
        ...
        public JsonResult VehicleCovers(int resultType)
        {
            ...
            var coversResult = _portofolioService.GetVehicleCovers(idWebSession, resultType, this.HttpContext);
        ...
        public JsonResult VehiclePages(string mediaId,string dateMediaNum, string dateCoverNum,string nbPage,string media)
        {
            ...
            var pagesResult = _portofolioService.GetVehiclePages(idWebSession,mediaId, dateMediaNum, dateCoverNum,nbPage, media, this.HttpContext);
