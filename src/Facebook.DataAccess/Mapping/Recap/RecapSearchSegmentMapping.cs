...
{
    class RecapSearchSegmentMapping : EntityTypeConfiguration<RecapSearchSegment>
    {

        public RecapSearchSegmentMapping(string schema)
        {
            //TODO : demander
            HasKey(e => new { e.IdLanguageData });


            ToTable("RECAP_SEARCH_SEGMENT", schema);
