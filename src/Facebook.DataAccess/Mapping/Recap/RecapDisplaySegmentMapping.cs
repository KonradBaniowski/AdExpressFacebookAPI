...
{
    class RecapDisplaySegmentMapping : EntityTypeConfiguration<RecapDisplaySegment>
    {

        public RecapDisplaySegmentMapping(string schema)
        {
            //TODO : demander
            HasKey(e => new { e.IdLanguageData });


            ToTable("RECAP_MMS_SEGMENT", schema);
