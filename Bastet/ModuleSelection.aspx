<%@ Page language="c#" Inherits="BastetWeb.ModuleSelection" CodeFile="ModuleSelection.aspx.cs" EnableEventValidation="true" EnableSessionState="True"%>
			...
			<table class="txtViolet11" cellSpacing="0" cellPadding="0" width="100%" border="0" height="50%">
				...
				<tr>
					<td colspan="2" valign="top">
					    <p class="txtViolet12BoldTitle">&nbsp;<cc1:BastetText language="33" id="AdExpressText1" runat="server" Code="48"></cc1:BastetText></p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
					</td>
