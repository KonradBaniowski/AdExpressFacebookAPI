	...
	public partial class IndicatorsResult : PrivateWebPage{
		...
		protected void Page_Load(object sender, System.EventArgs e){
			try{
                ...
                _result = IndicatorsBusinessFacade.GetIndicators(((IsisCommon.Login)Session[TNS.AdExpress.Bastet.WebSession.LOGIN]).Source, Session[TNS.AdExpress.Bastet.WebSession.VEHICLE_LIST].ToString(), (DateTime)Session[TNS.AdExpress.Bastet.WebSession.DATE_BEGIN], (DateTime)Session[TNS.AdExpress.Bastet.WebSession.DATE_END], _siteLanguage, WebApplicationParameters.AllowedLanguages[_siteLanguage].ClassificationLanguageId);
				#endregion
